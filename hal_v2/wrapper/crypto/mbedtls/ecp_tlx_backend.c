...
LOG_MODULE_REGISTER(ecc_tlx, CONFIG_MBEDTLS_LOG_LEVEL);
...
#if CONFIG_SOC_RISCV_TELINK_TL321X  || CONFIG_SOC_RISCV_TELINK_TL322X || CONFIG_SOC_RISCV_TELINK_TL323X || CONFIG_SOC_RISCV_TELINK_TL521X
...
#endif /*CONFIG_SOC_RISCV_TELINK_TL321X || CONFIG_SOC_RISCV_TELINK_TL721X || CONFIG_SOC_RISCV_TELINK_TL322X || CONFIG_SOC_RISCV_TELINK_TL323X || CONFIG_SOC_RISCV_TELINK_TL521X*/
...
extern void telink_soc_ecp_lock(void);
extern void telink_soc_ecp_unlock(void);

int telink_tlx_ecp_check_pubkey(const mbedtls_ecp_group *grp,
...
int telink_tlx_ecp_mul_restartable(mbedtls_ecp_group *grp,
...
int telink_tlx_ecp_muladd_restartable(mbedtls_ecp_group *grp,
	mbedtls_ecp_point *R,
