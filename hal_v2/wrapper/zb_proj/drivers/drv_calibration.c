...
#elif defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X)|| defined(MCU_CORE_TL3228)
// static void drv_calib_freq_offset(void)
// {
//     u8 freq_offset_value = 0xff;
...
{
#if defined(MCU_CORE_TL721X) || defined(MCU_CORE_TL321X)|| defined(MCU_CORE_TL3228)
...
#elif defined(MCU_CORE_TL3228)
    /* xx xx xx C7 A3 C0 xx xx */
    efuse_get_mac_address(buf);
