...
#define LL_FEATURE_MASK_HIGHER_DATA_THROUGHPUT                         BIT(27) //bit(59)   CORE_6.X   higher data throughput

#define LL_FEATURE_MASK_FRAME_SPACE_UPDATE                             BIT(1)  //bit(65)   core_6.0   frame space update
/////////////////////////////////////////////////////////////////////////////
...
#define BLUETOOTH_VER_6_0 14
#define BLUETOOTH_VER_6_X 15


#ifndef BLUETOOTH_VER
    #define BLUETOOTH_VER BLUETOOTH_VER_6_0
#endif
    ...
    #define LL_FEATURE_ENABLE_PAST                                   (LL_FEATURE_SUPPORT_LE_PAST_SENDER | LL_FEATURE_SUPPORT_LE_PAST_RECIPIENT)
#endif
    ...
    #define LL_FEATURE_ENABLE_POWER_CONTROL                       (LL_FEATURE_SUPPORT_POWER_CONTROL_REQUEST | LL_FEATURE_SUPPORT_POWER_LOSS_MONITORING)

    #define LL_FEATURE_ENABLE_CONNECTED_ISO                       (LL_FEATURE_ENABLE_CONNECTED_ISOCHRONOUS_STREAM_MASTER | LL_FEATURE_ENABLE_CONNECTED_ISOCHRONOUS_STREAM_SLAVE)

    #define LL_FEATURE_ENABLE_CONNECTIONLESS_ISO                  (LL_FEATURE_ENABLE_ISOCHRONOUS_BROADCASTER | LL_FEATURE_ENABLE_SYNCHRONIZED_RECEIVER)

    #define LL_FEATURE_ENABLE_ISO                                 (LL_FEATURE_ENABLE_CONNECTED_ISOCHRONOUS_STREAM_MASTER | LL_FEATURE_ENABLE_CONNECTED_ISOCHRONOUS_STREAM_SLAVE | LL_FEATURE_ENABLE_ISOCHRONOUS_BROADCASTER | LL_FEATURE_ENABLE_SYNCHRONIZED_RECEIVER)
...
#if (BLUETOOTH_VER >= BLUETOOTH_VER_6_0)
    ...
    #define LL_FEATURE_ENABLE_FRAME_SPACE_UPDATE                             LL_FEATURE_SUPPORT_FRAME_SPACE_UPDATE
    #define LL_FEATURE_ENABLE_DECISION_BASED_ADVERTISING_FILTER              LL_FEATURE_SUPPORT_LE_DECISION_BASED_ADVERTISING_FILTERING
#endif

#if (BLUETOOTH_VER >= BLUETOOTH_VER_6_X)
    #define LL_FEATURE_ENABLE_HIGHER_DATA_THROUGHPUT LL_FEATURE_SUPPORT_HIGHER_DATA_THROUGHPUT
#endif

#ifndef LL_FEATURE_ENABLE_HIGHER_DATA_THROUGHPUT
    #define LL_FEATURE_ENABLE_HIGHER_DATA_THROUGHPUT 0
#endif
...
#ifndef LL_FEATURE_ENABLE_DECISION_BASED_ADVERTISING_FILTER
    #define LL_FEATURE_ENABLE_DECISION_BASED_ADVERTISING_FILTER 0
#endif
...
#ifndef LL_FEATURE_ENABLE_MONITORING_ADVERTISERS
    #define LL_FEATURE_ENABLE_MONITORING_ADVERTISERS    0
#endif

#ifndef LL_FEATURE_ENABLE_FRAME_SPACE_UPDATE
    #define LL_FEATURE_ENABLE_FRAME_SPACE_UPDATE    0
#endif
//core 6.0 end
...
// <36> :   LL_FEATURE_ENABLE_PERIODIC_ADV_ADI_SUPPORT
// <37> :   LL_FEATURE_ENABLE_CONNECTION_SUBRATING
// <39> :   LL_FEATURE_ENABLE_CHANNEL_CLASSIFICATION
// <40> :   LL_FEATURE_ENABLE_ADVERTISING_CODING_SELECTION
// <41> :   LL_FEATURE_ENABLE_ADVERTISING_CODING_SELECT_HOST_SUPPORT
// <43> :   LL_FEATURE_ENABLE_PERIODIC_ADVERTISING_WITH_RESPONSES_ADVERTISER
// <44> :   LL_FEATURE_ENABLE_PERIODIC_ADVERTISING_WITH_RESPONSES_SCANNER
// <59> :   LL_FEATURE_ENABLE_HIGHER_DATA_THROUGHPUT
#define LL_FEATURE_MASK_BASE1 (0 << 0 |                                                                 \
                               ...
                               LL_FEATURE_ENABLE_HIGHER_DATA_THROUGHPUT <<27)
...
#define                 LL_FEATURE_EXT_REQ          0x2B    //core_5.4
#define                 LL_FEATURE_EXT_RSP          0x2C    //core_5.4
...
#define LL_CS_TERMINATE_REQ    0x35 //core_6.0
...
#define LL_CS_TERMINATE_RSP    0x3A //core_6.0
#define LL_FRAME_SPACE_REQ     0x3B //core_6.0
#define LL_FRAME_SPACE_RSP     0x3C //core_6.0

//Core 6.0+  opcode todo
#define LL_CIS_REQ_V3          0xFA  //higher data throughput
#define LL_CIS_RSP_V2          0xF9  //higher data throughput
#define LL_HDT_CONFIG_REQ      0xF8  //higher data throughput
#define LL_HDT_CONFIG_RSP      0xF7  //higher data throughput
#define LL_PHY_UPDATE_IND_V2   0xF6  //higher data throughput
#define LL_CIS_IND_V2          0xE9  //higher data throughput

#define LL_ENC_ECDH_REQ        0xEA
#define LL_ENC_ECDH_RSP        0xEB
#define LL_REFRESH_ENC_REQ     0xEC
#define LL_REFRESH_ENC_RSQ     0xED
#define LL_REFRESH_ENC_IND     0xEF
...
typedef enum
{
    ...
    ISO_LLID_UNFRAMED_PDU_START_CONTI_FRAGMENT_SDU = 0x01,
    ISO_LLID_UNFRAMED_PDU_PADDING_SDU              = 0x01, //Unframed CIS Data PDU; start or continuation fragment of an SDU
...
typedef struct __attribute__((packed))
{
    ...
    u8  rfu2     : 4;
    u8  mic_length              : 1;
    u8  max_payload_window_m2s  : 2;
    u8  max_payload_window_s2m  : 2;
    u8  rfu                     : 3;

    u8  div_m[8];

} rf_packet_ll_cis_req_v3_t;
