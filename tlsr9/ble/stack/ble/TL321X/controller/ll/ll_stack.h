...
#ifndef         OPTIMIZE_RAM_FOR_MATTER
#define         OPTIMIZE_RAM_FOR_MATTER                            0
#endif
...
typedef void (*ll_cs_test_mode_irq_callback_t)(void);
extern ll_cs_test_mode_irq_callback_t blt_cs_test_mode_irq_handler_cb;
extern ll_cs_test_mode_irq_callback_t blt_cs_test_mode_irq_stimer_cb;
