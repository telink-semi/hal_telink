...
#include "stack/ble/TL321X/controller/ll/acl_conn/acl_stack.h"
    ...
    #define SNIFFER_SYNC_RX_WINDOW_MAX_US    3496 //unit: uS
    #define SNIFFER_SYNC_RX_WINDOW_MAX_SSLOT 179  //unit: sSlot
