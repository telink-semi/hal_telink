...
#define CS_PARAM_LENGTH               9580 //user can't modify this value !!!
#define CS_SUBEVENT_PER_PROCEDURE_MAX 32

#ifndef AUTO_CALIB_CHIP_INTERNAL_DELAY_EN
    #define AUTO_CALIB_CHIP_INTERNAL_DELAY_EN 0
#endif
...
typedef struct __attribute__((packed))
{
    ...
    u8  Optional_TX_SNR_Capability;     //todo new cap param , just add now, function add later -yuexin
 ...
 * @param[out] pbuf - Pointer of buffer to receive lib version.
 * @param[in]  number - len of buffer.
 * @return     status, 0x00:  succeed
 *                     other: failed
 */
unsigned char blc_get_cs_lib_version(unsigned char *pbuf, unsigned char number);
