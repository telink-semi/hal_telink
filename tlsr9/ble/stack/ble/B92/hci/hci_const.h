 ...
 */
#define HCI_SUB_EVT_LE_CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE	 0x2B	//channel sounding	7.7.Y+0 LE CS Read Remote Supported Capabilities Complete event
#define HCI_SUB_EVT_LE_CS_READ_REMOTE_FAE_TABLE_COMPLETE				 0x2C	//channel sounding	7.7.Y+1 LE CS Read Remote FAE Table Complete event
#define HCI_SUB_EVT_LE_CS_SECURITY_ENABLE_COMPLETE	 					 0x2D	//channel sounding	7.7.Y+2 LE CS Security Enable Complete event
#define HCI_SUB_EVT_LE_CS_CONFIG_COMPLETE								 0x2E	//channel sounding	7.7.Y+3 LE CS Config Complete event
#define HCI_SUB_EVT_LE_CS_PROCEDURE_ENABLE_COMPLETE						 0x2F	//channel sounding	7.7.Y+4 LE CS Procedure Enable Complete event
#define HCI_SUB_EVT_LE_CS_SUBEVENT_RESULT								 0x30	//channel sounding	7.7.Y+5 LE CS Subevent Result event
#define HCI_SUB_EVT_LE_CS_SUBEVENT_RESULT_CONTINUE						 0x31	//channel sounding	7.7.Y+6 LE CS Subevent Result Continue event
#define HCI_SUB_EVT_LE_CS_TEST_END_COMPLETE							 	 0x32	//channel sounding	7.7.Y+4 LE CS Test End Complete event
...
#define HCI_LE_EVT_MASK_2_CS_READ_REMOTE_SUPPORTED_CAPABILITIES_COMPLETE	 0x00000200	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_READ_REMOTE_FAE_TABLE_COMPLETE				 	 0x00000400	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_SECURITY_ENABLE_COMPLETE	 					 0x00000800	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_CONFIG_COMPLETE								 0x00001000	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_PROCEDURE_ENABLE_COMPLETE						 0x00002000	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_SUBEVENT_RESULT								 0x00004000	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_SUBEVENT_RESULT_CONTINUE						 0x00008000	//channel sounding
#define HCI_LE_EVT_MASK_2_CS_TEST_END_COMPLETE							 	 0x00010000	//channel sounding
...
//core_5.4 begin
#define	HCI_CMD_LE_SET_EXTENDED_ADVERTISING_SUBEVENT_DATA			 0X82 //7.8.125 LE Set Periodic Advertising Subevent Data command
#define	HCI_CMD_LE_SET_EXTENDED_ADVERTISING_RESPONSE_DATA			 0x83 //7.8.126 LE Set Periodic Advertising Response Data command
#define HCI_CMD_LE_SET_EXTENDED_SYNC_SUBEVENT						 0x84 //7.8.127 LE Set Periodic Sync Subevent command
//core_5.4 end


//channel sounding begin
#define	HCI_CMD_LE_CS_READ_LOCAL_SUPPORTED_CAPABILITIES				 0x88 //7.8.X+0 LE CS Read Local Supported Capabilities command
#define	HCI_CMD_LE_CS_Read_Remote_Supported_Capabilities			 0x89 //7.8.X+1 LE CS Read Remote Supported Capabilities command
#define	HCI_CMD_LE_CS_Write_Remote_Supported_Capabilities			 0x8A //7.8.X+2 LE CS Write Remote Supported Capabilities command
#define	HCI_CMD_LE_CS_Security_Enable			 					 0x8B //7.8.X+3 LE CS Security Enable command
#define	HCI_CMD_LE_CS_Set_Default_Settings			 				 0x8C //7.8.X+4 LE CS Set Default Settings command
#define	HCI_CMD_LE_CS_Read_Remote_FAE_Table			 				 0X8D //7.8.X+6 LE CS Read Remote FAE Table command
#define	HCI_CMD_LE_CS_Write_Remote_FAE_Table			 			 0X90 //7.8.X+7 LE CS Write Remote FAE Table command
#define	HCI_CMD_LE_CS_Create_Config			 						 0X91 //7.8.X+8 LE CS Create Config command
#define	HCI_CMD_LE_CS_Remove_Config			 						 0X92 //7.8.X+9 LE CS Remove Config command
#define	HCI_CMD_LE_CS_Set_Channel_Classification			 		 0X93 //7.8.X+10 LE CS Set Channel Classification command
#define	HCI_CMD_LE_CS_Set_Procedure_Parameters			 			 0X94 //7.8.X+11 LE CS Set Procedure Parameters command
#define	HCI_CMD_LE_CS_Procedure_Enable			 					 0X95 //7.8.X+12 LE CS Procedure Enable command
#define	HCI_CMD_LE_CS_Test			 								 0X96 //7.8.X+13 LE CS Test command
#define	HCI_CMD_LE_CS_Test_End			 							 0X97 //7.8.X+14 LE CS Test End command
