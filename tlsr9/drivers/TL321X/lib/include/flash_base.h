 ...
 * @return 		none.
 */
_attribute_ram_code_com_sec_noinline_ void flash_mspi_read_ram(flash_command_e cmd,unsigned long addr, unsigned char *data,unsigned long data_len);
 ...
 * @return 		none.
 */
_attribute_ram_code_com_sec_noinline_ unsigned char flash_mspi_read_decrypt_check_ram(flash_command_e cmd,unsigned long addr, unsigned char *data,unsigned long data_len);
/**
 ...
 * @return 		none.
 */
_attribute_ram_code_com_sec_noinline_ void flash_mspi_write_encrypt_ram(flash_command_e cmd,unsigned long addr, unsigned char *data, unsigned long data_len);
