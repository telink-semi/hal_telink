 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_optimize_o2_noinline_ void flash_mspi_write_ram(unsigned int cmd,unsigned long addr, unsigned char *data, unsigned long data_len,unsigned int w_en_cmd,unsigned int busy_cmd);
 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_optimize_o2_noinline_ void flash_send_cmd(unsigned int cmd);
 ...
 * @return none
 */
_attribute_ram_code_com_sec_noinline_ void flash_set_rd_xip_config_sram(unsigned int config);
 ...
 * @return none
 */
_attribute_ram_code_com_sec_noinline_ void flash_set_wr_xip_config_sram(flash_wr_xip_config_t config);
