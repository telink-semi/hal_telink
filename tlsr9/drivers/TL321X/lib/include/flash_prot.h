...
typedef enum{
    ...
    /* User can set 1920KB flash protect. */
    FLASH_LOCK_FW_LOW_1920K     =   0x09,
}flash_app_lock_e;
 ...
 */
unsigned short flash_change_app_lock_block_to_flash_lock_block(flash_app_lock_e app_lock_block);
