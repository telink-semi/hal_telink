 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_noinline_ void clock_mspi_clk_config(sys_clock_src_e src, sys_clock_div_e div);
 ...
 * @return      none
 */
_attribute_ram_code_com_sec_noinline_ void clock_cclk_hclk_pclk_config(sys_clock_src_e src, sys_clock_div_e cclk_div, sys_cclk_div_to_hclk_pclk_e hclk_pclk_div);
 ...
 *              -----------------------------------------------------------------------
 */
_attribute_ram_code_com_sec_noinline_ void clock_set_all_clock_to_default(void);
 ...
 */
_attribute_ram_code_com_sec_noinline_ void clock_save_clock_config(void);
 ...
 */
_attribute_ram_code_com_sec_noinline_ void clock_restore_clock_config(void);
 ...
 */
_attribute_ram_code_com_sec_noinline_ void clock_bbpll_config(sys_pll_clk_e pll_clk);
