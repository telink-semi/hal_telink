...
static inline u8 rf_ble_get_tx_pwr_idx(s8 rfTxPower)
{
    ...
    else if (rfTxPower >=   2)  {  rfPwrLvlIdx = RF_POWER_INDEX_P1p90dBm;  }
    else if (rfTxPower >=   1)  {  rfPwrLvlIdx = RF_POWER_INDEX_P1p00dBm;  }
    else if (rfTxPower >=   0)  {  rfPwrLvlIdx = RF_POWER_INDEX_P0p03dBm;  }
    else if (rfTxPower >=  -4)  {  rfPwrLvlIdx = RF_POWER_INDEX_N4p06dBm;  }
    else if (rfTxPower >=  -6)  {  rfPwrLvlIdx = RF_POWER_INDEX_N5p59dBm;  }
    else if (rfTxPower >= -10)  {  rfPwrLvlIdx = RF_POWER_INDEX_N10p28dBm; }
    else if (rfTxPower >= -14)  {  rfPwrLvlIdx = RF_POWER_INDEX_N14p37dBm; }
    else                        {  rfPwrLvlIdx = RF_POWER_INDEX_N20p25dBm; }
...
static inline s8 rf_ble_get_tx_pwr_level(rf_power_level_index_e rfPwrLvlIdx)
{
    ...
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P1p90dBm)  {  rfTxPower =   2;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P1p00dBm)  {  rfTxPower =   1;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P0p03dBm)  {  rfTxPower =   0;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N4p06dBm)  {  rfTxPower =  -4;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N5p59dBm)  {  rfTxPower =  -6;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N10p28dBm)  {  rfTxPower = -10;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N14p37dBm) {  rfTxPower = -14;  }
    else                                              {  rfTxPower = -23;  }
