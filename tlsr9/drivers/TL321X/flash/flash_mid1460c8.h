 ...
 */
typedef enum{
	FLASH_OTP_0x001000_512B_MID1460C8	=	0x001000,	//001000h-0011FFh
	FLASH_OTP_0x002000_512B_MID1460C8	=	0x002000,	//002000h-0021FFh
	FLASH_OTP_0x003000_512B_MID1460C8	=	0x003000,	//003000h-0031FFh
 ...
 */
typedef enum{
	FLASH_LOCK_OTP_0x001000_512B_MID1460C8	=	0x0800,	//001000h-0011FFh
	FLASH_LOCK_OTP_0x002000_512B_MID1460C8	=	0x1000,	//002000h-0021FFh
	FLASH_LOCK_OTP_0x003000_512B_MID1460C8	=	0x2000,	//003000h-0031FFh
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid1460c8(unsigned short data, mid1460c8_write_status_mask_e bit);
