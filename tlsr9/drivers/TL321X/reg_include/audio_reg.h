...
/**
 * BIT[0:2] rxfifo1 input selsect: 3'd0:sdm;3'd1:i2s1;3'd2:i2s2;3'd3:codec;3'd4:usb.
 * BIT[0:2] rxfifo2 input selsect: 3'd0:sdm;3'd1:i2s1;3'd2:i2s2;3'd3:codec;3'd4:usb.
 */
...
/**
 * BIT[0:1] sdm out mode select:2'd0:16bit mono;2'd1:20bit/24bit mono;2'd2:16bit stereo;2'd3:20bit/24bit stereo.
 ...
 * BIT[0] txfifo0_th_irq.
 * BIT[1] txfifo1_th_irq.
 * BIT[2] txfifo2_th_irq.
 */
 ...
 */
#define reg_i2s_cfg1(i) REG_ADDR8((I2S2_TDM_BASE + 0x00) + (i * 0x00))
 ...
 */
#define reg_i2s_cfg2(i) REG_ADDR8((I2S2_TDM_BASE + 0x01) + (i * 0x00))
 ...
 */
#define reg_i2s_cfg3(i) REG_ADDR8((I2S2_TDM_BASE + 0x02) + (i * 0x00))
 ...
 */
#define reg_i2s_route(i) REG_ADDR8((I2S2_TDM_BASE + 0x03) + (i * 0x00))
 ...
 */
#define reg_i2s_int_pcm_num(i) REG_ADDR16((I2S2_TDM_BASE + 0x04) + (i * 0x00))

/**
 * BIT[0:15] reg_i2s_int_pcm_num[0:15] dac i2s LRCLK counter high byte.
 */
#define reg_i2s_dec_pcm_num(i) REG_ADDR16((I2S2_TDM_BASE + 0x06) + (i * 0x00))

/**
 * BIT[0:7] reg_i2s_pcm_clk_num[0:7] bclk division factor, i2s_clk/(n*2).
 */
#define reg_i2s_pcm_clk_num(i) REG_ADDR8((I2S2_TDM_BASE + 0x08) + (i * 0x00))

/**
 * BIT[0:31] reg_i2s_stimer_target[0:31] i2s stimer for schedule.
 */
#define reg_i2s_stimer_target(i) REG_ADDR32((I2S2_TDM_BASE + 0x0c) + (i * 0x20))
...
/**
 * BIT[0:7] reg_step_m_1[7:0] middle byte of rate matching block step_i,change sample rate.
 */
#define reg_step_m_1(i) REG_ADDR8((ASCL1_BASE + 0x06) + (i * 0x08))
