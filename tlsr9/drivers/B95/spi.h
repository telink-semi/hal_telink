 ...
 *	Introduction
 *	===============
 *	B95 supports two spi:gspi lspi
 *
 *	API Reference
 *	===============
 *	Header File: spi.h
 ...
 * @param[in] 	rgb_mode 	- set lspi lcd RGB mod.
 * @return  	none.
 */
 ...
 * @return    none.
 */
static inline void spi_set_llp_sof_mode(dma_chn_e chn,unsigned char soft_mode)
{
	if(soft_mode){
...
/**
  ...
  * @return   	none.
  * @note	  	- lspi and gpsi tx dma only support burst4/burst2/burst1.
 ...
 * @param[in]  	burst_size   - dma burst size
 * @return   	none.
 * @note	  	- lspi and gpsi rx dma  only support burst2/burst1.
