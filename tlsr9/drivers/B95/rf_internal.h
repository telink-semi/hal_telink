...
extern rf_crc_config_t rf_crc_config[];
#if(1)
/******************************************************FOR HADM************************************************************/
 ...
 * @return 		none.
 */
static inline void rf_pn_enable(void)
{
 ...
 * @note        Attention:In ble mode, this interface is not required to configure PN
 */
static inline void rf_set_pn_config(const rf_pn_config_t *config)
{
    rf_set_pn_init_value(config->pn_value);
    rf_set_pn_poly(config->pn_poly);
    rf_set_pn_length(config->rf_pn_length);
...
/**
 * @brief     This function serves to set ble_500K_new  mode of RF.
 * @return	  none.
 * @note      TODO:This function interface is not available at this time, and will be updated in subsequent releases.(unverified)
 */
void rf_set_ble_500K_new_mode(void);

/**
 * @brief     This function serves to  set ble_125K_new  mode of RF.
 * @return	  none.
 * @note      TODO:This function interface is not available at this time, and will be updated in subsequent releases.(unverified)
 */
void rf_set_ble_125K_new_mode(void);
 ...
 *            That is, PAYLOAD octets plus CRC octets.
 * TODO:This function interface is not available at this time, and will be updated in subsequent releases.(unverified)
 */
...
/**********************************************************************************************************************
 *                                         RF : packet filter related functions                          		  *
 *********************************************************************************************************************/
/**
