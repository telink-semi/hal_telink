 ...
 */
typedef enum{
	RX_SETTLE_TIME_11US		 = 0,/**<  disable Bandgap, rx_ldo_trim, PD_settle, rx_fcal,rx_rccal, rx_dcoc calibration,reduce 74us of rx settle time.
	                                    Receive for a period of time and then do a normal calibration.*/

	RX_SETTLE_TIME_37US		 = 1, /**<  disable rx_ldo_trim and rx_dcoc calibration,reduce 44.5us of rx settle time.
	                                    Receive for a period of time and then do a normal calibration.*/

	RX_SETTLE_TIME_77US		 = 2  /**<  disable rx_ldo_trim calibration,reduce 8.5us of rx settle time.
 ...
 */
typedef enum{
	TX_SETTLE_TIME_25US	 	= 0,/**<  disable Bandgap,tx_ldo_trim,PD_settle,tx_fcal,tx_hpmc,reduce 87.5us of tx settle time.
	...
	TX_SETTLE_TIME_104US    = 2  /**<  disable tx_ldo_trim function,reduce 8.5us of tx settle time.
	                                   Do a normal calibration at the beginning.*/
...
typedef struct
{
	...
	unsigned char  fcal_tx[8];
	unsigned char  fcal_rx[8];
...
typedef enum {
	...
	RF_MODE_PRI_GENERIC_1M =    BIT(17),	/**< private generic 1M mode */
	RF_MODE_PRI_GENERIC_2M =    BIT(18),	/**< private generic 2M mode */
...
{
    write_reg8(0x17044d, pipe); //rx_access_code_chn_en
}
 ...
 * @param[in]  	len - The CRC length to be set for RF.
 * @return 		none.
 */
 ...
 *	@return	 	none
 *	@note		TX_SETTLE_TIME_25US  - disable Bandgap,tx_ldo_trim,PD_settle,tx_fcal,tx_hpmc,reduce 87.5us of tx settle time.
	                                   After frequency hopping, a normal calibration must be done.
...
*/
_attribute_ram_code_sec_noinline_  unsigned char rf_get_fcal_cal_val(void);

/**
 *  @brief		This function is mainly used to set fcal Calibration-related values.
 ...
 *	@return	 	none
*/
void rf_set_fcal_cal_val(unsigned char *fcal_tx_group,unsigned char *fcal_rx_group);
 ...
 *	@param[in]	*fcal_chn_range  - chn group range pointer(fcal_chn_range_low<=chn_num <= fcal_chn_range_high)
 *	@return	 	none
