 ...
 */
typedef enum {
	NTV_LDO_TRIM_1P785V_0P908 = 0x00,
	NTV_LDO_TRIM_1P812V_0P934 = 0x08,
	NTV_LDO_TRIM_1P825V_0P847 = 0x10,
	NTV_LDO_TRIM_1P734V_0P855 = 0x18,
} pm_ntv_ldo_trim_e;
 ...
 * @return		none.
 */
_attribute_ram_code_sec_ void pm_wait_bbpll_done(void);
 ...
 */
void pm_power_supply_config(pm_power_cfg_e power_cfg);
