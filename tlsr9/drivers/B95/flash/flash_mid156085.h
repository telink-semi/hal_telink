 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid156085_with_device_num(mspi_slave_device_num_e device_num, unsigned short data, mid156085_write_status_mask_e mask);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_lock_mid156085_with_device_num(mspi_slave_device_num_e device_num, mid156085_lock_block_e data);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
mid156085_lock_block_e flash_get_lock_block_mid156085_with_device_num(mspi_slave_device_num_e device_num);
