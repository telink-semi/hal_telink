 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_write_status_mid146085_with_device_num(mspi_slave_device_num_e device_num, unsigned short data, mid146085_write_status_mask_e mask);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_lock_mid146085_with_device_num(mspi_slave_device_num_e device_num, mid146085_lock_block_e data);
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
mid146085_lock_block_e flash_get_lock_block_mid146085_with_device_num(mspi_slave_device_num_e device_num);
