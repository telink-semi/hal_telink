 ...
 * @return  	none.
 */
static inline void stimer_clr_irq_status(stimer_irq_status_e status)
{
 ...
 */
static inline unsigned char stimer_get_irq_status(stimer_irq_status_e status)
{
 ...
 * @return    none.
 */
static inline void stimer_set_input_capt_enable(void)
{
 ...
 * @return    none.
 */
static inline void stimer_set_input_capt_disable(void)
{
	 reg_system_timer_ctrl &= ~(FLD_SYSTEM_CAPT_EN) ;
}
 ...
 * @return    none.
 */
static inline void stimer_set_input_capt_mode(stimer_capt_mode_e capt_mode)
{
 ...
 */
static inline unsigned int stimer_get_input_capt_value(void)
{
 ...
 * @return	none.
 */
static inline void stimer_enable_in_manual_mode(void)
{
 ...
 */
static inline unsigned char stimer_get_enable_mode(void)
{
 ...
 * @return	none.
 */
static inline void stimer_set_auto_enable_mode(void)
{
 ...
 * @return	none.
 */
static inline void stimer_set_manual_enable_mode(void)
{
	reg_system_ctrl &= ~(FLD_SYSTEM_TIMER_AUTO);
}
 ...
 * @return	none.
 */
static inline void stimer_set_run_upon_nxt_32k_enable(void)
{
 ...
 * @return	none.
 */
static inline void stimer_set_run_upon_nxt_32k_disable(void)
{
	reg_system_up_32k &= ~(FLD_SYSTEM_RUN_UPON_NXT_32K);
}
 ...
 * @return	none.
 */
static inline void stimer_set_update_upon_nxt_32k_enable(void)
{
 ...
 * @return	none.
 */
static inline void stimer_set_update_upon_nxt_32k_disable(void)
{
	reg_system_up_32k &= ~(FLD_SYSTEM_UPDATE_UPON_32K);
}
 ...
 * @return	none.
 */
static inline void stimer_wait_write_done(void)
{
 ...
 * @return	none.
 */
static inline void stimer_32k_tracking_enable(void)
{
 ...
 * @return	none.
 */
static inline void stimer_32k_tracking_disable(void)
{
	reg_system_ctrl &= ~(FLD_SYSTEM_32K_TRACK_EN);
}
 ...
 * @return    none.
 */
static inline void stimer_set_32k_write_mode(void)
{
 ...
 * @return    none.
 */
static inline void stimer_set_32k_read_mode(void)
{
	reg_system_ctrl &= ~FLD_SYSTEM_32K_WR_EN;
}
 ...
 * @return    none.
 */
static inline void stimer_wait_read_32k_done(void)
{
 ...
 * @return    none.
 */
static inline void stimer_set_32k_tick(unsigned int tick)
{
 ...
 * @return    none.
 */
static inline void stimer_set_32k_tick_write_trig(void)
{
 ...
 * @return    none.
 */
static inline void stimer_wait_write_32k_done (void)
{
 ...
 * @return		none.
 */
void stimer_enable(stimer_enable_mode_e mode, unsigned int tick);

/**
 * @brief		This function is used to stop the system timer.
 * @return		none.
 */
void stimer_disable(void);
