...
/* CS Ranging Counter is lower 12-bits of CS Procedure_Counter */
#define CS_COUNTER_CONVERT_SUB_NODE_INDEX_MASK      0xFFF // procedure counter compatibility ranging counter, uniform use of 12bit
