...
/**
 *  @brief      This function serves to set clock of sdm
 ...
 *  @return     none.
 */
static inline void audio_set_sdm_clk(unsigned short div_numerator, unsigned short div_denominator)
{
...
static inline void audio_set_ascl_gain(audio_ascl_select_e ascl_select, ascl_out_path_digital_gain_e gain)
{
    if (ascl_select != ASCL0) {
        reg_ascl_vol(ascl_select) = ((reg_ascl_vol(ascl_select) & (~FLD_VOL_1)) | MASK_VAL(FLD_VOL_1, gain));
    } else {
...
{
    if (ascl_select != ASCL0) {
        BM_SET(reg_line(ascl_select), FLD_LINE_1);
    } else {
 ...
 *  @return     none.
 */
static inline void audio_ascl_lerp_dis(void)
{
...
/**
 *  @brief      This function serves to enable source sdm clk.
 *  @return     none.
 */
static inline void audio_sdm_src_clk_en(void)
{
    reg_sdm_step |= FLD_SDM_CLK_EN_0;
}
 ...
 *  @return     none
 */
static inline void audio_set_i2s_src_clk_en(void)
{
    reg_i2s_step |= FLD_I2S_CLK_EN_0;
}

/**
 *  @brief      This function serves to disable all clk related sdm.
 *  @return     none.
 */
static inline void audio_sdm_src_clk_dis(void)
{
    reg_sdm_step &= ~FLD_SDM_CLK_EN_0;
}

/**
 *  @brief      This function serves to disable all clk related i2s.
 *  @return     none
 */
static inline void audio_set_i2s_src_clk_dis(void)
{
    reg_i2s_step &= ~FLD_I2S_CLK_EN_0;
}
 ...
 *  @return     none.
 */
static inline void audio_set_i2s_clk(unsigned short div_numerator, unsigned short div_denominator)
{
 ...
 * @param[in]  mode - power mode. [3]for PGA,[0:2]for ADC,The default value is 0(0x0~0x0f) for optimal performance and high power consumption.
 * @return     none.
 */
...
/**
 * @brief     This function configures the internal codec clk to the external codec mclk via the debug pin,mclk=192M*(div_numerator/div_denominator):192M*(1/16)=12M.
...
/**
 * @brief     This function configures the sdm clk to the external codec mclk via the debug pin,mclk=192M*(div_numerator/div_denominator):192*(1/16)=12M.
...
/**
 * @brief     This function configures audio module debug clk as codec mclk,mclk=192M*(div_numerator/div_denominator):192M*(1/16)=12M,192M*(8/125)=12.288M.
