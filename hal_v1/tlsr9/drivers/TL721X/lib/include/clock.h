 ...
 */
_attribute_ram_code_com_sec_noinline_ void clock_init(sys_clock_src_e 		  src,
 ...
 * @return      none
 */
_attribute_ram_code_com_sec_optimize_o2_noinline_ void clock_cclk_hclk_pclk_config(sys_clock_src_e src, sys_clock_div_e cclk_div, sys_cclk_div_to_hclk_pclk_e hclk_pclk_div);
