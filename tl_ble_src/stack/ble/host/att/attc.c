...
ble_sts_t blc_attc_sendFindByTypeValueRequest(u16 connHandle, u16 start_attHandle, u16 end_attHandle,
                                                u16 uuid, u8 *attr_value, u16 attr_value_len)
{
...
ble_sts_t blc_attc_sendReadByTypeRequest(u16 connHandle, u16 start_attHandle, u16 end_attHandle,
                                            u8 *uuid, u8 uuid_len)
{
...
ble_sts_t blc_attc_sendReadByGroupTypeRequest(u16 connHandle, u16 start_attHandle, u16 end_attHandle,
                                                u8 *uuid, u8 uuid_len)
{
    if(uuid == NULL || (uuid_len != 2 && uuid_len != 16))
        return GATT_ERR_INVALID_PARAMETER;
