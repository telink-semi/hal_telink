...
_attribute_ble_data_retention_ static SPLIST_DEF(softTimer, softTimer_getTimerValue);

_attribute_ble_data_retention_ static unsigned int lastTimer;
...
{
    if (pTimer == NULL) {
        return APP_SOFT_TIMER_RET_STATUS_PARAM_CHECK_FAILED;
    }
