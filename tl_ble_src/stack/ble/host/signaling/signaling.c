...
int blt_signal_l2capSignalRxHandler(u16 connHandle, l2cap_pkt_t *ptrSignal)
{
    ...
    if (pduLen) {
        ...
        blt_l2cap_pushData_2_controller(connHandle, L2CAP_CID_SIG_CHANNEL, &signalConnCb.signalTxBuff->code, sizeof(signal_pkt_t), signalConnCb.signalTxBuff->data, signalConnCb.signalTxBuff->dataLen);
    }
