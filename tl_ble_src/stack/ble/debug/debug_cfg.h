...
#define SL_STACK_CS_TIME_EN                 1
#endif

#ifndef SL_STACK_CS_REFL_TIME_EN
#define SL_STACK_CS_REFL_TIME_EN            1
#endif
...
#define DBG_CS_LOG_PRF_MASK_EN              (stkLog_mask & STK_LOG_PRF_CS)
...
#define CS_PRF_LOG(fmt, ...)                BLC_CS_DBG(DBG_CS_LOG_PRF_MASK_EN, "[PRF]"fmt, ##__VA_ARGS__)


#else
#define CS_HCI_LOG(fmt, ...)
#define CS_PRF_LOG(fmt, ...)
#endif
