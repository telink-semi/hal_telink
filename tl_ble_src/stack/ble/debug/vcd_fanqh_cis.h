 ...
 *
 *******************************************************************************************************/
#ifndef VCD_FANQH_DEF_CIS_CEN_H_
#define VCD_FANQH_DEF_CIS_CEN_H_


#include "debug_cfg.h"

#if (VCD_DEFINE_SELECT == VCD_FANQH_DEFINE_CIS)
    ...
    #define SL01_aclc_0    10
    #define SL01_aclc_1    11
