...
#endif
    static u8
    aes_ccmAuthTran(u8 micLen, u8 *key, u8 *iv, u8 *mStr, u16 mStrLen, u8 *aStr, u16 aStrLen, u8 *result)
{
    u16         msgLen;
    u8          mStrIndex = 0;
    ccm_flags_t flags;
...
#endif
    static u8
    aes_ccmBaseTran(u8 micLen, u8 *key, u8 *iv, u8 *mStr, u16 mStrLen, u8 *aStr, u8 aStrLen, u8 *mic)
{
...
#endif
    void
    aes_ll_ccm_encryption(llPhysChnPdu_t *pllPhysChnPdu, u8 role, u8 ll_type, ble_crypt_para_t *pd)
{
...
#endif
    int
    aes_ll_ccm_decryption(llPhysChnPdu_t *pllPhysChnPdu, u8 role, u8 ll_type, ble_crypt_para_t *pd)
{
    u8 *pPduLen  = &pllPhysChnPdu->llPduHdr.pduHdr.rf_len;
    u8  enEncFlg = pd->enable;
