...
ble_sts_t blc_ll_setupBisDataPath(u16 handle, dat_path_dir_t dir, dat_path_id_t id, u8 cid_assignNum, u16 cidcompId, u16 cid_vendorDef, u32 control_dly, u8 codec_cfg_len, u8 codec_cfg1, u8 codec_cfg2, u8 codec_cfg3, u8 codec_cfg4)
{
...
ble_sts_t blc_hci_le_setupBisDataPath(hci_le_setupIsoDataPath_cmdParam_t *pCmdPara, hci_le_setupIsoDataPath_retParam_t *pRetParam)
{
    ...
    pRetParam->status    = blc_ll_setupBisDataPath(pCmdPara->conn_handle, pCmdPara->data_path_dir, pCmdPara->data_path_id, pCmdPara->codec_id_assignNum, pCmdPara->codec_id_compId, pCmdPara->codec_id_vendorDef, controller_delay, pCmdPara->codec_config_len, pCmdPara->codec_config[0], pCmdPara->codec_config[1], pCmdPara->codec_config[2], pCmdPara->codec_config[3]);
...
_attribute_noinline_ int blt_bis_cmd_process_task(int opcode, void *pCmd, void *pRet)
{
