...
_attribute_ram_code_ int blt_cig_slv_interrupt_task(int flag, void *p)
{
...
_attribute_no_inline_
    #endif
    int
    blt_cig_slv_mainloop_task(int flag)
{
...
_attribute_noinline_ void blt_ll_reset_cig_slv(void)
{
...
int blt_ll_cis_slave_cis_establish(ll_cis_conn_t *pCisConn, ll_cis_slv_t *pCigSlave, ble_sts_t status)
{
    ...
    if (hci_le_eventMask_2 & HCI_LE_EVT_MASK_2_HDT_LE_CIS_ESTABLISHED_V4) {
        hci_le_cisEstablishedV4_evt(status, pCisConn->cis_connHandle, (u8 *)&pCisConn->cig_sync_delay, (u8 *)&pCisConn->cis_sync_delay,
                                  (u8 *)&pCisConn->transLaty_m2s, (u8 *)&pCisConn->transLaty_s2m, pCisConn->curCisPhy, pCisConn->curCisPhy,
                                  pCisConn->nse, pCisConn->bn_peer, pCisConn->bn_loca, pCisConn->ft_peer, pCisConn->ft_loca,
                                  pCisConn->max_pdu_peer, pCisConn->max_pdu_loca, pCigSlave->ciss_isoIntvl,(u8 *)&pCisConn->sub_intvl_us,
                                  pCisConn->max_sdu_peer, pCisConn->max_sdu_loca, (u8 *)&pCisConn->sdu_int_peer_us, (u8 *)&pCisConn->sdu_int_loca_us,
                                  pCisConn->cis_frame, pCisConn->rate_s2m, pCisConn->rate_m2s, pCisConn->enc_enable, pCisConn->mic_length);
    } else
#endif
    if (hci_le_eventMask & HCI_LE_EVT_MASK_CIS_ESTABLISHED) {
        hci_le_cisEstablished_evt(status, pCisConn->cis_connHandle, (u8 *)&pCisConn->cig_sync_delay, (u8 *)&pCisConn->cis_sync_delay,
                                  (u8 *)&pCisConn->transLaty_m2s, (u8 *)&pCisConn->transLaty_s2m, pCisConn->curCisPhy, pCisConn->curCisPhy,
                                  pCisConn->nse, pCisConn->bn_peer, pCisConn->bn_loca, pCisConn->ft_peer, pCisConn->ft_loca,
                                  pCisConn->max_pdu_peer, pCisConn->max_pdu_loca, pCigSlave->ciss_isoIntvl);
    }
...
_attribute_ram_code_ int blt_ll_buildCisSlaveSchedulerLinklist(void)
{
    int           i = 0, j = 0;
    int           new_task_cnt = 0;
    ll_cis_slv_t *pCigSlave    = NULL;
...
_attribute_ram_code_ int blt_ll_calcCigSlv1stAndCis1stAnchorPoint(void)
{
...
_attribute_ram_code_ static int blt_ll_find_next_cis_slv_subevent(int start_idx)
{
...
_attribute_ram_code_ int blt_cig_slv_start(int slotTask_idx)
{
    DBG_SIHUI_CHN4_HIGH;
    DBG_FANQH_CHN4_HIGH;
...
_attribute_ram_code_ void blt_cig_slv_post(void)
{
...
_attribute_ram_code_ int blt_crx_start(void)
{
...
_attribute_ram_code_ int blt_crx_post(ll_cis_conn_t *pCisConn)
{
...
_attribute_noinline_ void blt_cis_clearCisSlaveMainloopStatus(ll_cis_conn_t *pCisConn, ll_cis_slv_t *pCigSlave)
{
