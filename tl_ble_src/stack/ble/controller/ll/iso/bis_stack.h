...
#if LL_FEATURE_SUPPORT_HIGHER_DATA_THROUGHPUT
...
typedef struct   __attribute__((packed))
{
    ...
    u32 maxPdu     : 13;          //Max_PDU is the maximum number of data octets (excluding the MIC, if any) that can be carried in each BIS Data PDU in the BIG. The value shall be
