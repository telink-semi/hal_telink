...
typedef enum
{
    ...
    BLE_PC_PHY_HDT      = 0x05,
    BLE_PC_PHY_TOTAL    = BLE_PC_PHY_HDT,
#else
...
#if LL_FEATURE_SUPPORT_HIGHER_DATA_THROUGHPUT
    BLE_PC_HDT_BIT      = (1 << 4), //LE HDT PHY bit
    BLE_PC_MAX_BIT      = BLE_PC_HDT_BIT,
    BLE_PC_ALL_BITS     = BLE_PC_1M_BIT | BLE_PC_2M_BIT | BLE_PC_CODED_S8_BIT | BLE_PC_CODED_S2_BIT | BLE_PC_HDT_BIT
#else
