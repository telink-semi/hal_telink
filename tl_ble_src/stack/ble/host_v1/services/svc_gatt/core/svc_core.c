...
#define SERVER_EATT_SUPPORTED                       1
#endif
...
static const uint16_t defaultPeriConnParameters[] = { 80, 80, 0, 500 };     //gap_periConnectParams_t
...
_attribute_data_retention_
static uint16_t gattServiceChangeVal[2] = { 0x0000, 0x0000 };
...
_attribute_data_retention_
static uint8_t databaseHashVal[16];//database hash calculation
 ...
 */
_attribute_data_retention_
static struct atts_group svcGattGroup =
{
    NULL,
    gattList,
    NULL,
