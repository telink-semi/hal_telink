...
#define ULL_HID_PROPERTIES_FORMAT_MAX_SIZE 30

_attribute_ble_data_retention_
static uint8_t ullhidProperties[ULL_HID_PROPERTIES_FORMAT_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t ullhidPropertiesLen = 0;
 ...
 */
_attribute_ble_data_retention_
static struct atts_group svcUllhidGroup =
{
    NULL,
    ullhidList,
    NULL,
