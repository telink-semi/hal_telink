...
extern const uint8_t charPropWriteWithoutIndicate;
extern const uint8_t charPropNotify;
extern const uint8_t charPropIndicate;
extern const uint8_t charPropNotifyIndicate;
...
#define ATTS_CHARACTERISTIC_DECLARATIONS(properties)            \
    {ATT_PERMISSIONS_READ, ATT_16_UUID_LEN, (uint8_t*)(size_t)declarationsCharacteristicUuid, \
            (uint16_t*)(size_t)&characteristicPropertiesLen, CHARACTERISTIC_PROPERTIES_LENGTH, (uint8_t*)(size_t)&properties, ATTS_SET_ATTR_VALUE_PROPERTIES}
...
#define ATTS_PRIMARY_SERVICE(serviceUuid)       {ATT_PERMISSIONS_READ, ATT_16_UUID_LEN, (uint8_t*)(size_t)declarationsPrimaryServiceUuid, (uint16_t*)(size_t)&attr16UuidLen, ATT_16_UUID_LEN, (uint8_t*)(size_t)serviceUuid, 0}
...
#define ATTS_SECONDARY_SERVICE(serviceUuid)     {ATT_PERMISSIONS_READ, ATT_16_UUID_LEN, (uint8_t*)(size_t)declarationsSecondaryServiceUuid, (uint16_t*)(size_t)&attr16UuidLen, ATT_16_UUID_LEN, (uint8_t*)(size_t)serviceUuid, 0}
...
#define ATTS_PRIMARY_SERVICE_128(serviceUuid)   {ATT_PERMISSIONS_READ, ATT_16_UUID_LEN, (uint8_t*)(size_t)declarationsPrimaryServiceUuid, (uint16_t*)(size_t)&attr128UuidLen, ATT_128_UUID_LEN, (uint8_t*)(size_t)serviceUuid, 0}
...
#define ATTS_SECONDARY_SERVICE_128(serviceUuid) {ATT_PERMISSIONS_READ, ATT_16_UUID_LEN, (uint8_t*)(size_t)declarationsSecondaryServiceUuid, (uint16_t*)(size_t)&attr128UuidLen, ATT_128_UUID_LEN, (uint8_t*)(size_t)serviceUuid, 0}
...
#define ATTS_COMMON_CCC_DEFINE_CB           {ATT_PERMISSIONS_RDWR, ATT_16_UUID_LEN, (uint8_t *)descriptorClientCharacteristicConfigurationUuid, (uint16_t *)NULL, 0, (uint8_t *)NULL, ATTS_SET_WRITE_CALLBACK | ATTS_SET_READ_CALLBACK}
#define ATTS_COMMON_CCC_DEFINE_WCB          {ATT_PERMISSIONS_RDWR, ATT_16_UUID_LEN, (uint8_t *)descriptorClientCharacteristicConfigurationUuid, (uint16_t *)(size_t) & clientCharacteristicConfigurationLen, sizeof(clientCharacteristicConfiguration), (uint8_t *)(size_t) & clientCharacteristicConfiguration, ATTS_SET_WRITE_CALLBACK}


#define ATTS_INCLUDE_DEFINE(value)              {ATT_PERMISSIONS_READ,ATT_16_UUID_LEN,(uint8_t*)(size_t)declarationsIncludeUuid, (uint16_t*)(size_t)&gattIncludeValueLen, 6, (uint8_t*)(size_t)value, 0}
...
#define ATTS_CHAR_UUID_DEFINE(perm, uuid, valueLen, maxValueLen, value, settings)       {perm, ATT_16_UUID_LEN, (uint8_t*)(size_t)uuid, (uint16_t*)(size_t)&valueLen, maxValueLen, (uint8_t*)(size_t)value, settings}
