...
static uint8_t gtbsBearerProviderNameValue[LE_AUDIO_GTBS_BEARER_PROVIDER_NAME_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsBearerProviderNameValueLen;
const uint16_t gtbsBearerProviderNameMaxSize = sizeof(gtbsBearerProviderNameValue);

_attribute_ble_data_retention_
static uint8_t gtbsBearerUCIValue[LE_AUDIO_GTBS_BEARER_UCI_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsBearerUCIValueLen;
const uint16_t gtbsBearerUCIMaxSize = sizeof(gtbsBearerUCIValue);

_attribute_ble_data_retention_
static uint8_t gtbsBearerTechnologyValue = 0x01;
static const uint16_t gtbsBearerTechnologyValueLen = sizeof(gtbsBearerTechnologyValue);

_attribute_ble_data_retention_
static uint8_t gtbsBearerURISchemesSupportedListValue[LE_AUDIO_GTBS_BEARER_URI_SCHEMES_SUPPORTED_LIST_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsBearerURISchemesSupportedListValueLen;
...
_attribute_ble_data_retention_
static uint8_t gtbsBearerSignalStrengthValue;
static const uint16_t gtbsBearerSignalStrengthValueLen = sizeof(gtbsBearerSignalStrengthValue);

_attribute_ble_data_retention_
static uint8_t gtbsBearerSignalStrengthReportingIntervalValue;
...
_attribute_ble_data_retention_
static uint8_t gtbsBearerListCurrentCallsValue[LE_AUDIO_GTBS_BEARER_LIST_CURRENT_CALLS_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsBearerListCurrentCallsValueLen;
const uint16_t gtbsBearerListCurrentCallsMaxSize = sizeof(gtbsBearerListCurrentCallsValue);

_attribute_ble_data_retention_
static uint8_t gtbsCCIDValue;
static const uint16_t gtbsCCIDValueLen = sizeof(gtbsCCIDValue);

_attribute_ble_data_retention_
static uint8_t gtbsStatusFlagsValue[2];
...
_attribute_ble_data_retention_
static uint8_t gtbsIncomingCallTargetBearerURIValue[LE_AUDIO_GTBS_INCOMING_CALL_TARGET_BEARER_URI_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsIncomingCallTargetBearerURIValueLen;
#endif

_attribute_ble_data_retention_
static uint8_t gtbsCallStateValue[LE_AUDIO_GTBS_CALL_STATE_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsCallStateValueLen;
const uint16_t gtbsCallStateMaxSize = sizeof(gtbsCallStateValue);

_attribute_ble_data_retention_
static uint8_t gtbsCallControlPointValue[3];
static const uint16_t gtbsCallControlPointValueLen = sizeof(gtbsCallControlPointValue);

_attribute_ble_data_retention_
static uint16_t gtbsCallControlPointOptionalOpcodesValue;
...
_attribute_ble_data_retention_
static uint8_t gtbsIncomingCallValue[LE_AUDIO_GTBS_INCOMING_CALL_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsIncomingCallValueLen;

const uint16_t gtbsFriendlyNameMaxSize = LE_AUDIO_GTBS_FRIENDLY_NAME_MAX_SIZE;
#if LE_AUDIO_GTBS_CALL_FRIENDLY_NAME
_attribute_ble_data_retention_
static uint8_t gtbsCallFriendlyNameValue[LE_AUDIO_GTBS_FRIENDLY_NAME_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t gtbsCallFriendlyNameValueLen;
#endif
 ...
 */
_attribute_ble_data_retention_
static struct atts_group svcGtbsGroup =
{
    NULL,
    gtbsList,
    NULL,
