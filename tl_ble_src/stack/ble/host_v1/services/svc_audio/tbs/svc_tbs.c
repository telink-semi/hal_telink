...
static uint8_t tbsBearerProviderNameValue[LE_AUDIO_TBS_BEARER_PROVIDER_NAME_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsBearerProviderNameValueLen;
const uint16_t tbsBearerProviderNameMaxSize = sizeof(tbsBearerProviderNameValue);

_attribute_ble_data_retention_
static uint8_t tbsBearerUCIValue[LE_AUDIO_TBS_BEARER_UCI_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsBearerUCIValueLen;
const uint16_t tbsBearerUCIMaxSize = sizeof(tbsBearerUCIValue);

_attribute_ble_data_retention_
static uint8_t tbsBearerTechnologyValue = 0x01;
static const uint16_t tbsBearerTechnologyValueLen = sizeof(tbsBearerTechnologyValue);

_attribute_ble_data_retention_
static uint8_t tbsBearerURISchemesSupportedListValue[LE_AUDIO_TBS_BEARER_URI_SCHEMES_SUPPORTED_LIST_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsBearerURISchemesSupportedListValueLen;
...
_attribute_ble_data_retention_
static uint8_t tbsBearerSignalStrengthValue;
static const uint16_t tbsBearerSignalStrengthValueLen = sizeof(tbsBearerSignalStrengthValue);

_attribute_ble_data_retention_
static uint8_t tbsBearerSignalStrengthReportingIntervalValue;
...
_attribute_ble_data_retention_
static uint8_t tbsBearerListCurrentCallsValue[LE_AUDIO_TBS_BEARER_LIST_CURRENT_CALLS_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsBearerListCurrentCallsValueLen;
const uint16_t tbsBearerListCurrentCallsMaxSize = sizeof(tbsBearerListCurrentCallsValue);

_attribute_ble_data_retention_
static uint8_t tbsCCIDValue;
static const uint16_t tbsCCIDValueLen = sizeof(tbsCCIDValue);

_attribute_ble_data_retention_
static uint8_t tbsStatusFlagsValue[2];
...
_attribute_ble_data_retention_
static uint8_t tbsIncomingCallTargetBearerURIValue[LE_AUDIO_TBS_INCOMING_CALL_TARGET_BEARER_URI_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsIncomingCallTargetBearerURIValueLen;
#endif

_attribute_ble_data_retention_
static uint8_t tbsCallStateValue[LE_AUDIO_TBS_CALL_STATE_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsCallStateValueLen;
const uint16_t tbsCallStateMaxSize = sizeof(tbsCallStateValue);

_attribute_ble_data_retention_
static uint8_t tbsCallControlPointValue[3];
static const uint16_t tbsCallControlPointValueLen = sizeof(tbsCallControlPointValue);

_attribute_ble_data_retention_
static uint16_t tbsCallControlPointOptionalOpcodesValue;
...
_attribute_ble_data_retention_
static uint8_t tbsIncomingCallValue[LE_AUDIO_TBS_INCOMING_CALL_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsIncomingCallValueLen;

const uint16_t tbsFriendlyNameMaxSize = LE_AUDIO_TBS_FRIENDLY_NAME_MAX_SIZE;
#if LE_AUDIO_TBS_CALL_FRIENDLY_NAME
_attribute_ble_data_retention_
static uint8_t tbsCallFriendlyNameValue[LE_AUDIO_TBS_FRIENDLY_NAME_MAX_SIZE];
_attribute_ble_data_retention_
static uint16_t tbsCallFriendlyNameValueLen;
#endif
 ...
 */
_attribute_ble_data_retention_
static struct atts_group svcTbsGroup =
{
    NULL,
    tbsList,
    NULL,
