 ...
 */
typedef bool (*gattc_disc_service_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
 ...
 */
typedef bool (*gattc_find_incl_service_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
 ...
 *  @return true: continue to discovery, false: discovery stop.
 */
typedef bool(*disc_characteristics_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
 ...
 *  @return true: continue to discovery, false: discovery stop.
 */
typedef bool(*disc_characteristic_desc_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
 ...
 */
typedef bool (*gattc_read_characteristic_value_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
 ...
 *   @return None.
 */
typedef void (*gattc_write_characteristic_value_callback)(uint16_t conn_handle, uint16_t cid, uint32_t err,
    void *user_data);
