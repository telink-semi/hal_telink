 ...
 */
typedef bool(*gatt_ssdp_found_include_callback)(uint16_t conn_handle, uint16_t start_handle, uint16_t end_handle);
 ...
 * @param end_handle --- found include uuid end attribute handle.
 */
typedef void(*gatt_ssdp_found_unknown_include_callback)(uint16_t conn_handle, const struct att_uuid *uuid, uint16_t start_handle, uint16_t end_handle);
