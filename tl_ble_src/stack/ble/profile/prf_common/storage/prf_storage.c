...
static u32 blt_prf_searchBondingDeviceByAclHandle(u16 connHandle, u16* valueLen)
{
...
static void blt_prf_deleteBondingInfoByFlashAddress(u32 flashAddr)
{
...
{
    if(maxBondNum >= (int)(nvEachBlockSize/AUD_NV_PARAM_UNIT))      return AUDIO_ERR_INVALID_PARAMETER;
