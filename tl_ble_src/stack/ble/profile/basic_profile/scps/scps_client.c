...
_attribute_ble_data_retention_ struct blc_scps_client_ctrl scps_client_ctrl = {
    .process = {
                .pNext       = NULL,
                .id          = SCPS_CLIENT,
                .usedAclRole = 0,
...
#else
static const struct blc_prf_process_params s_scps_client_process_params = {
    .id          = SCPS_CLIENT,
    .usedAclRole = PRF_GAP_ACL_CENTRAL,
    .init        = blt_scpsc_init,
    .connect     = blt_scpsc_connect,
    .discovery   = blt_scpsc_discovery,
    .store       = blt_scpsc_nv_store,
};
...
_attribute_ble_data_retention_ struct blc_scps_client_ctrl scps_client_ctrl = {
    .process = {
                ...
                .prf_params = &s_scps_client_process_params,
                },
};
#endif
...
#else
    blc_prf_registerServiceModule((struct blc_prf_process *)&scps_client_ctrl, param);
#endif
}
