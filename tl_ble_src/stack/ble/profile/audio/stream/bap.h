...
typedef struct
{                     //Parameters parsed from metadata
    u16 fieldExistFlg;
    u16 metadataLen;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUC_CODEC_CONFIGURED
    u16            aclHandle;
...
typedef struct
{ //Event ID: AUDIO_EVT_QOS_CONFIGURED
    u16            aclHandle;
    audio_dir_enum aseDir;
    u8             aseID;
    u8             framing;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUC_ENABLING
    u16                         aclHandle;
    audio_dir_enum              aseDir;
    u8                          aseID;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUC_DISABLING or AUDIO_EVT_BAPUC_RELEASING
    u16            aclHandle;
    audio_dir_enum aseDir;
    u8             aseID;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUC_UPDATE_METADATA
    u16                         aclHandle;
    audio_dir_enum              aseDir;
    u8                          aseID;
    blc_audio_metadata_parsed_t metaParam;
...
typedef struct
{   //Event ID: AUDIO_EVT_BAPUC_SEND_STREAMING
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUS_CODEC_CONFIGURED
    audio_dir_enum       dir;
    u8                   audioEpId;
    blc_audio_codec_id_t codecid;
    u8                   frequency;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUS_QOS_CONFIGURED
    audio_dir_enum dir;
    u8             audioEpId;
    u8             cigID;
    u8             cisID;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPUS_ENABLING or AUDIO_EVT_BAPUS_UPDATE_METADATA
    audio_dir_enum dir;
    u8             audioEpId;
    u8             metaLen;
    u8             meta[255];
...
typedef struct
{   //Event ID: AUDIO_EVT_BAPUS_RELEASING
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBS_BIS_SINK_INIT_CODEC
    u32           presentationDelay;
    u8            bisNum;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBS_BIS_SINK_SYNC_BIG
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBS_PDA_SYNC_STATE
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBA_FOUND_SINK
    u8  addrType;
    u8  address[6];
    u8  completeNameLen;
    u8 *completeName;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBA_START_SYNC_PA
    u8  sid;
    u8  addrType;
    u8  address[6];
    u8  broadcastId[3];
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBA_FOUND_SOURCE_INFO
    u8            sid;
    u8            addrType;
    u8            address[6];
    u8            bisIndex;
...
typedef struct
{ //Event ID: AUDIO_EVT_BAPBA_SOURCE_ENC_STATE
    u8 enc;
...
#define CODEC_SPEC_CFG(sampFreq, duration, octets) .codecId = INIT_CODEC_ID_LC3, .codecCfg = {                  \
                                                                                     .samplingFreq  = sampFreq, \
                                                                                     .frameDuration = duration, \
                                                                                     .perCodecFrame = octets,   \
}
