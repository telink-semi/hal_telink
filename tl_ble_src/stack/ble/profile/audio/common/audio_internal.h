...
#define BLT_AUD_CHECK_NULL_PTR1(ptr1)                       if(CHECK_PTR_NUL(ptr1))     return AUDIO_ERR_INPUT_NULL_PTR
#define BLT_AUD_CHECK_NULL_PTR2(ptr1, ptr2)                 if(CHECK_PTR_NUL(ptr1) || CHECK_PTR_NUL(ptr2))      return AUDIO_ERR_INPUT_NULL_PTR
#define BLT_AUD_CHECK_NULL_PTR3(ptr1, ptr2, ptr3)           if(CHECK_PTR_NUL(ptr1) || CHECK_PTR_NUL(ptr2) || CHECK_PTR_NUL(ptr3))       return AUDIO_ERR_INPUT_NULL_PTR
