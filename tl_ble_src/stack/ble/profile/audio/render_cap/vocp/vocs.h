...
typedef struct
{ //Event ID: AUDIO_EVT_VOCSC_CHANGED_VOLUME_OFFSET
    u8  vocsIndex;
    s16 volumeOffset;
} blc_vocsc_volumeOffsetStateChangeEvt_t;

typedef struct
{ //Event ID: AUDIO_EVT_VOCSC_CHANGED_LOCATION
    u8  vocsIndex;
    u32 location;
} blc_vocsc_locationChangeEvt_t;

typedef struct
{ //Event ID: AUDIO_EVT_VOCSC_CHANGED_OUTPUT_DESCRIPTION
    u8  vocsIndex;
    u16 descLen;
    u8 *desc;
...
typedef struct
{ //Event ID: AUDIO_EVT_VOCSS_CHANGED_VOLUME_OFFSET
    u8  vocsIndex;
    s16 volumeOffset;
} blc_vocss_volumeOffsetStateChangeEvt_t;

typedef struct
{ //Event ID: AUDIO_EVT_VOCSS_CHANGED_LOCATION
    u8  vocsIndex;
    u32 location;
} blc_vocss_locationChangeEvt_t;

typedef struct
{ //Event ID: AUDIO_EVT_VOCSS_CHANGED_OUTPUT_DESCRIPTION
    u8  vocsIndex;
    u16 descLen;
    u8 *desc;
