...
const int gAppVcsSvrInstNum = APP_AUDIO_AICS_SERVER_MAX_INSTANCE_NUM;
 ...
 * @return      aics server control buffer pointer.
 */
blc_aics_server_t *blt_aicss_getServerControlBuffer(u8 instIdx)
{
    assert(instIdx < gAppVcsSvrInstNum);
