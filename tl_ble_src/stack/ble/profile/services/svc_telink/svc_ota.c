...
static const atts_attribute_t otaList[] =
{
    ...
    {ATT_PERMISSIONS_READ,  ATT_16_UUID_LEN, (u8*)(size_t)descriptorCharacteristicUserDescriptionUuid,  (u16*)(size_t)&otaOutDescLen,   sizeof(otaOutDesc), (u8*)(size_t)otaOutDesc, 0,},
};
...
static atts_group_t svcOtaGroup =
{
    NULL,
    otaList,
    NULL,
