...
//Protocol Mode
_attribute_ble_data_retention_ static u8 hidProtocolModeValue    = HID_PROTOCOL_MODE_REPORT;
static const u16                         hidProtocolModeValueLen = sizeof(hidProtocolModeValue);
#endif

#if HID_BOOT_KEYBOARD_INTPUT_ENABLE
// Boot Keyboard Input Report
_attribute_ble_data_retention_ static hid_bootKeyboardInputValue_t hidBootKeyInReportValue;
static const u16                                                   hidBootKeyInReportValueLen = sizeof(hidBootKeyInReportValue);
#endif

#if HID_BOOT_KEYBOARD_OUTPUT_ENABLE
// Boot Keyboard Output Report
_attribute_ble_data_retention_ static u16 hidBootKeyOutReportValue    = 0x0003;
static const u16                          hidBootKeyOutReportValueLen = sizeof(hidBootKeyOutReportValue);
#endif

#if HID_BOOT_MOUSE_INTPUT_ENABLE
// Boot Mouse Input Report
_attribute_ble_data_retention_ static hid_bootMouseInputValue_t hidBootMouseInReportValue;
 ...
 */
_attribute_ble_data_retention_ static atts_group_t svcHidGroup =
    {
        NULL,
        hidList,
        NULL,
