...
#define ATTS_COMMON_CCC_DEFINE_CB           {ATT_PERMISSIONS_RDWR, ATT_16_UUID_LEN, (u8 *)descriptorClientCharacteristicConfigurationUuid, (u16 *)NULL, 0, (u8 *)NULL, ATTS_SET_WRITE_CBACK | ATTS_SET_READ_CBACK}
...
#define ATTS_CHAR_UUID_ENCR_READ_NULL(properties, uuid)                                                            \
    ATTS_CHARACTERISTIC_DECLARATIONS(properties),                                                                  \
    {                                                                                                              \
        ATT_PERMISSIONS_ENCRYPT_READ, ATT_16_UUID_LEN, (u8 *)uuid, (u16 *)NULL, 0, (u8 *)NULL, ATTS_SET_READ_CBACK \
    }
