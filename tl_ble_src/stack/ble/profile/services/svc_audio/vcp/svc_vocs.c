...
static u8 vocsVolumeOffsetStateValue[APP_AUDIO_VOCS_SERVER_MAX_INSTANCE_NUM][VOCS_VOL_OFFSET_STATE_FIX_LEN] = {
    {0x00, 0x00, 0x00},
...
_attribute_ble_data_retention_
static u32 vocsAudioLocationValue[APP_AUDIO_VOCS_SERVER_MAX_INSTANCE_NUM] = {
    0x00,
#if APP_AUDIO_VOCS_SERVER_MAX_INSTANCE_NUM > 1
    0x00,
#endif
...
_attribute_ble_data_retention_
static u8 vocsAudioOutputDescriptionValue[APP_AUDIO_VOCS_SERVER_MAX_INSTANCE_NUM][VOCS_OUTPUT_DESC_MAX_SIZE];

_attribute_ble_data_retention_
static u16 vocsAudioOutputDescriptionValueLen[APP_AUDIO_VOCS_SERVER_MAX_INSTANCE_NUM];
#endif
 ...
 */
_attribute_ble_data_retention_
static atts_group_t svcVocsGroup =
{
    NULL,
    vocsList,
    NULL,
