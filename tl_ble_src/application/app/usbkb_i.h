...
static const USB_Descriptor_HIDReport_Datatype_t audio_hogp_report_desc[] = {
    ...
    0x06,
    0x01,
    0xFF, // Usage Page (Vendor Defined 0xFF01)
    0x09,
    0x02, // Usage (tmp usage)
    0xA1,
    ...
    0x02, //   Report ID (2)
    0x09,
    0x14, //   Usage (tmp usage)
    0x75,
    0x08, //   Report Size (8)
    0x95,
    0x14, //   Report Count (20)
    0x15,
    0x80, //   Logical Minimum (128)
    0x25,
    0x7F, //   Logical Maximum (127)
    0x81,
    0x22, //   Input (Data,Var,Abs,No Wrap,Linear,No Preferred State,No Null Position)
