...
#define LC3_VERSION LC3_VERSION_INT(1, 2, 3)
...
typedef struct _LC3_CFG_Param
{
    ...
    /* defines the MDCT-PLC fadeout to zero in ms */
...
Word32       tlka_lc3dec_get_size(void);
Word32       tlka_lc3dec_get_scratch_size(void);
...
Word32       tlka_lc3enc_get_size(void);
Word32       tlka_lc3enc_get_scratch_size(void);
