 ...
 *  Introduction
 *  ===============
 *  TL721X supports six spi:gspi lspi
 *
 *  API Reference
 *  ===============
 *  Header File: spi.h
 ...
 *  ==============
  -# SPI Initialization and Configuration
     -# nodma/dma
        - Initialize the gspi*5/lspi pin by gspi_set_pin() or lspi_set_pin() API;
...
#define gspi1_reset()                                                                                 spi_hw_fsm_reset(GSPI_MODULE)
#define gspi2_reset()                                                                                 spi_hw_fsm_reset(GSPI_MODULE)
#define gspi3_reset()                                                                                 spi_hw_fsm_reset(GSPI_MODULE)
#define gspi4_reset()                                                                                 spi_hw_fsm_reset(GSPI_MODULE)
