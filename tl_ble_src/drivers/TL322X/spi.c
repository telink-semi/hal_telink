...
{
    gspi_set_pin_mux((gpio_func_pin_e)pin, GSPI_CN_IO);
}
...
void gspi_set_xip_pin(gspi_xip_pin_config_t *gspi_xip_pin_config)
{
    ...
    gspi_set_pin_mux(gspi_xip_pin_config->gspi_csn0_pin, GSPI_CN_IO);
...
{
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_clk_pin, (gpio_func_e)LSPI_CK_IO);
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_csn_pin, LSPI_CN_IO);
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_mosi_io0_pin, (gpio_func_e)LSPI_MOSI_IO);
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_miso_io1_pin, (gpio_func_e)LSPI_MISO_IO);
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_io2_pin, (gpio_func_e)LSPI_IO2_IO);
    lspi_set_pin_mux((gpio_func_pin_e)spi_pin_config->spi_io3_pin, (gpio_func_e)LSPI_IO3_IO);
}
...
void spi_slave_init(spi_sel_e spi_sel, spi_mode_type_e mode)
{
    ...
    case LSPI_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst0 |= FLD_RST0_LSPI;
        reg_clk_en0 |= FLD_CLK0_LSPI_EN;
        reg_lspi_clk_set = ((FLD_LSPI_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 4));
        break;
    case GSPI_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst1 |= FLD_RST1_GSPI;
        reg_clk_en1 |= FLD_CLK1_GSPI_EN;
        reg_gspi_clk_set = ((FLD_GSPI_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 8));
        break;
    case GSPI1_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst6 |= FLD_RST6_GSPI1;
        reg_clk_en6 |= FLD_CLK6_GSPI1_EN;
        reg_gspi1_clk_set = ((FLD_GSPI1_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 8));
        break;
    case GSPI2_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst6 |= FLD_RST6_GSPI2;
        reg_clk_en6 |= FLD_CLK6_GSPI2_EN;
        reg_gspi2_clk_set = ((FLD_GSPI2_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 8));
        break;
    case GSPI3_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst6 |= FLD_RST6_GSPI3;
        reg_clk_en6 |= FLD_CLK6_GSPI3_EN;
        reg_gspi3_clk_set = ((FLD_GSPI3_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 8));
        break;
    case GSPI4_MODULE: //set the SPI clock to 48m by splitting the frequency of the pll.
        reg_rst6 |= FLD_RST6_GSPI4;
        reg_clk_en6 |= FLD_CLK6_GSPI4_EN;
        reg_gspi4_clk_set = ((FLD_GSPI4_CLK_MOD & (unsigned char)(sys_clk.pll_clk / 96)) | (2 << 8));
        break;
    default:
        break;
    }
 ...
 * @return      none.
 */
spi_tans_mode_e spi_get_transmode(spi_sel_e spi_sel)
{
