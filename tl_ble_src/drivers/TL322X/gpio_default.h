...
/************************************************************PA*******************************************************/
...
#endif
#ifndef PA3_FAST_SLEW_RATE
    #define PA3_FAST_SLEW_RATE 1
#endif
#ifndef PA4_FAST_SLEW_RATE
    #define PA4_FAST_SLEW_RATE 1
#endif
    ...
    #define PA3_DATA_STRENGTH 1//default 1 is 8mA
#endif
#ifndef PA4_DATA_STRENGTH
    #define PA4_DATA_STRENGTH 1//default 1 is 8mA
#endif
...
_attribute_ram_code_sec_ static inline void gpio_init(int anaRes_init_en)
{
    ...
    reg_gpio_pa_setting3 =
        (PA0_FAST_SLEW_RATE ? 0 : 1) | ((PA1_FAST_SLEW_RATE ? 0 : 1) << 1) | ((PA2_FAST_SLEW_RATE ? 0 : 1) << 2) | ((PA3_FAST_SLEW_RATE ? 0 : 1) << 3) |
        ((PA4_FAST_SLEW_RATE ? 0 : 1) << 4) | ((PA5_FAST_SLEW_RATE ? 0 : 1) << 5) | ((PA6_FAST_SLEW_RATE ? 0 : 1) << 6) | ((PA7_FAST_SLEW_RATE ? 0 : 1) << 7) |
        ...
        ((PA0_DATA_STRENGTH ? 0 : 1) << 16) | ((PA1_DATA_STRENGTH ? 0 : 1) << 17) | ((PA2_DATA_STRENGTH ? 0 : 1) << 18) | ((PA3_DATA_STRENGTH ? 0 : 1) << 19) |
        ((PA4_DATA_STRENGTH ? 0 : 1) << 20) | ((PA5_DATA_STRENGTH ? 0 : 1) << 21) | ((PA6_DATA_STRENGTH ? 0 : 1) << 22) | ((PA7_DATA_STRENGTH ? 0 : 1) << 23);
