...
#ifndef DRIVERS_TL322X_EXT_DRIVER_DRIVER_DRIVER_INTERNAL_EXT_RF_H_
#define DRIVERS_TL322X_EXT_DRIVER_DRIVER_DRIVER_INTERNAL_EXT_RF_H_
...
#ifndef FAST_SETTLE
#define FAST_SETTLE         1  //20250508 enable by lijing
#endif
...
#if FAST_SETTLE
    #define TX_FAST_SETTLE_TIME  15
//    #define TX_FAST_SETTLE_TIME  51

    #define RX_FAST_SETTLE_TIME  15
//    #define RX_FAST_SETTLE_TIME  37
#else
    #define TX_FAST_SETTLE_TIME  TX_STL_AUTO_MODE_1M
    #define RX_FAST_SETTLE_TIME  RX_SETTLE_US
#endif
 ...
 *                  Condor  1M: 18uS       2M: 8uS;       500K(S2): 8uS     125K(S8):  8uS     //Aura 24M
 */
#define AD_CONVERT_DLY_1M                                           18
#define AD_CONVERT_DLY_2M                                           8
#define AD_CONVERT_DLY_CODED                                        8
...
static inline u8 rf_ble_get_tx_pwr_idx(s8 rfTxPower)
{
    ...
    else if (rfTxPower >=   4)  {  rfPwrLvlIdx = RF_POWER_INDEX_P4p47dBm;  }    /* TODO: xh */
...
#endif /* DRIVERS_TL322X_EXT_DRIVER_DRIVER_DRIVER_INTERNAL_EXT_RF_H_ */
