...
#define RRAM_AHB_BASE_ADDR           0x00400000

#define reg_rram_ahb_rd_data_byte(j) REG_ADDR8(RRAM_AHB_BASE_ADDR + j)

#define reg_rram_ahb_rd_data_word(j) REG_ADDR32(RRAM_AHB_BASE_ADDR + j)
