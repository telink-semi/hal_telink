...
#if (!defined(MCU_CORE_TL322X_N22))||(PLIC_ENABLE == 1)//todo
/**
 ...
 */
    ...
    #define IRQ_USB1_CTRL_EP_SETUP  7  /* USB1_SETUP_IRQ: USB1 setup interrupt, - usb1_ctrl_ep_setup_irq_handler */
    #define IRQ_USB1_CTRL_EP_DATA   8  /* USB1_DATA_IRQ: USB1 data interrupt, - usb1_ctrl_ep_data_irq_handler */
    #define IRQ_USB1_CTRL_EP_STATUS 9  /* USB1_STATUS_IRQ: USB1 status interrupt, - usb1_ctrl_ep_status_irq_handler */
    #define IRQ_USB1_CTRL_EP_SETINF 10 /* USB1_SETINF_IRQ: USB1 set interface interrupt, - usb1_ctrl_ep_setinf_irq_handler */
    #define IRQ_USB1_ENDPOINT       11 /* USB1_EDP_IRQ: USB1 edp (1-8) interrupt, - usb1_endpoint_irq_handler */
    #define IRQ_TIMER_N22           12 /* IRQ_TIMER_N22, - timer_n22_irq_handler */
    #define IRQ_DC                  13 /* IRQ_DC, - dc_irq_handler */
    #define IRQ_USB0                14 /* USB0_IRQ: USB0 interrupt, - usb0_irq_handler */
    ...
    #define IRQ_LSPI                22 /* IRQ_LSPI, - lspi_irq_handler */
    #define IRQ_GSPI                23 /* GSPI_IRQ, - gspi_irq_handler */
    #define IRQ_USB1_PWDN           24 /* USB1_PWDN_IRQ: USB suspend interrupt, - usb1_pwdn_irq_handler */

    #define IRQ_QDEC1               25 /* IRQ_QDEC1, - qdec1_irq_handler */
    #define IRQ_UART4               26 /* IRQ_UART4, - uart4_irq_handler */
    #define IRQ_I2C1                27 /* IRQ_I2C1, -  i2c1_irq_handler */
    #define IRQ_SOFT                28 /* SOFT_IRQ: software interrupt, - soft_irq_handler */
    #define IRQ_MSPI                29 /* MSPI_IRQ, - mspi_irq_handler */
    #define IRQ_USB1_RESET          30 /* USB1_RESET_IRQ: USB1 reset interrupt, - usb1_reset_irq_handler */
    #define IRQ_USB1_250US_OR_SOF   31 /* USB1_250US_OR_SOF_IRQ: USB1 250us or SOF interrupt, - usb1_250us_or_sof_irq_handler */
    ...
    #define IRQ_MAILBOX_N22_TO_D25  46 /* IRQ_MAILBOX_N22_TO_D25, - mailbox_n22_to_d25_irq_handler */
    ...
    #define IRQ_UART3               50 /* IRQ_UART3, - uart3_irq_handler */
    #define IRQ_SARADC_RX           51 /* SARADC_RX_IRQ: sar adc interrupt, - saradc_rx_irq_handler */
    #define IRQ_RZ                  52 /* RZ_IRQ, - rz_irq_handler */
    #define IRQ_GSPI1               53 /* IRQ_GSPI1, - gspi1_irq_handler */
    #define IRQ_GSPI2               54 /* IRQ_GSPI2, - gspi2_irq_handler */
    #define IRQ_GSPI3               55 /* IRQ_GSPI3, - gspi3_irq_handler */
    #define IRQ_GSPI4               56 /* IRQ_GSPI4, - gspi4_irq_handler */
    #define IRQ_LIN0                57 /* IRQ_LIN0,  - lin0_irq_handler */
    #define IRQ_LIN1                58 /* IRQ_LIN1,  - lin1_irq_handler */
    #define IRQ_CAN0                59 /* IRQ_CAN0,  - can0_irq_handler */
    #define IRQ_CAN1                60 /* IRQ_CAN1,  - can1_irq_handler */
