...
{
    reg_mspi_xip_rd_ctrl0(device_num) |= ((en << 5) & FLD_MSPI_XIP_PAGE_MODE_EN);
}
...
{
    reg_mspi_xip_rd_ctrl0(device_num) |= ((en << 6) & FLD_MSPI_XIP_TIMEOUT_MODE_EN);
}
...
/**
 * @brief       This function servers to enable mspi ddr.
 * @return      none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_ddr_enable(void)
{
    reg_mspi_ddr_ctrl1 = 0x0b;
}

/**
 * @brief       This function servers to disable mspi ddr.
 * @return      none
 */
_attribute_ram_code_sec_ static _always_inline void mspi_ddr_disable(void)
{
    reg_mspi_ddr_ctrl1 = 0x00;
}
