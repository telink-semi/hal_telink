...
{
    analog_write_reg8(areg_aon_0x06, analog_read_reg8(areg_aon_0x06) & (~FLD_PD_BBPLL_LDO)); //ana_reg_0x06[0]=1'0, pll ldo power on
    analog_write_reg8(areg_0x101, (analog_read_reg8(areg_0x101) & (~FLD_POWER_ON_BBPLL_SUPPLY_SWITCH)));//ana_reg_0x81[7]=1'0,power on pll
    pm_wait_bbpll_done();
}
...
{
    analog_write_reg8(areg_aon_0x06, analog_read_reg8(areg_aon_0x06) | (FLD_PD_BBPLL_LDO)); //ana_reg_0x06[0]=1'0, pll ldo power down
    analog_write_reg8(areg_0x101, (analog_read_reg8(areg_0x101) | (FLD_POWER_ON_BBPLL_SUPPLY_SWITCH)));//ana_reg_0x81[7]=1'0,power down pll
    g_bbpll_is_used =0;
}
...
{
    analog_write_reg8(areg_0x101, analog_read_reg8(areg_0x101) | FLD_ENABLE_LOCK_DET_BBPLL);
