 ...
 * @param[in]   msg_bytes        - input, byte length of the input message, it could be 0
 ...
 * @param[in]   msg_bytes   - byte length of the input message, must be a multiple of sha512
