 ...
 * @param[in]   msg_bytes      - byte length of the input message, must be a multiple of md5
 *                              block word length(64).
 * @return      0:success     other:error
 * @note
  @verbatim
  ...
  @endverbatim
 */
unsigned int md5_dma_update_blocks(MD5_DMA_CTX *ctx, unsigned int *msg, unsigned int msg_bytes)
{
