 ...
 *  Introduction
 *  ===============
 *  TL751X supports two spi:gspi lspi
 *
 *  API Reference
 *  ===============
 *  Header File: spi.h
...
typedef struct{
    ...
    unsigned char spi_cmd1_en;//enable cmd1 phase
    unsigned char spi_token_en;//enable token mode
    unsigned char spi_token_val_sel;//select token val
    unsigned char spi_ddr_mode;//enable ddr mode
    spi_io_mode_e  spi_io_mode;//set spi io mode
}spi_wr_rd_config_t;

/**
 * @brief  Define the sspi pin.
 */
typedef enum{
    SSPI_CSN_PA0_PIN        = GPIO_PA0,
    SSPI_CSN_PA4_PIN        = GPIO_PA4,
    SSPI_CSN_PB1_PIN        = GPIO_PB1,
    SSPI_CSN_PB5_PIN        = GPIO_PB5,
    SSPI_CSN_PD3_PIN        = GPIO_PD3,
    SSPI_CSN_PD7_PIN        = GPIO_PD7,
    SSPI_CSN_PF5_PIN        = GPIO_PF5,
    SSPI_CSN_PG1_PIN        = GPIO_PG1,
    SSPI_CSN_PG5_PIN        = GPIO_PG5,
    SSPI_CSN_PH5_PIN        = GPIO_PH5,
    SSPI_CSN_PJ2_PIN        = GPIO_PJ2,


    SSPI_CLK_PA1_PIN        = GPIO_PA1,
    SSPI_CLK_PA5_PIN        = GPIO_PA5,
    SSPI_CLK_PB2_PIN        = GPIO_PB2,
    SSPI_CLK_PB6_PIN        = GPIO_PB6,
    SSPI_CLK_PD4_PIN        = GPIO_PD4,
    SSPI_CLK_PF2_PIN        = GPIO_PF2,
    SSPI_CLK_PF6_PIN        = GPIO_PF6,
    SSPI_CLK_PG2_PIN        = GPIO_PG2,
    SSPI_CLK_PG6_PIN        = GPIO_PG6,
    SSPI_CLK_PH6_PIN        = GPIO_PH6,
    SSPI_CLK_PJ3_PIN        = GPIO_PJ3,


    SSPI_MOSI_PA2_PIN       = GPIO_PA2,
    SSPI_MOSI_PA6_PIN       = GPIO_PA6,
    SSPI_MOSI_PB3_PIN       = GPIO_PB3,
    SSPI_MOSI_PB7_PIN       = GPIO_PB7,
    SSPI_MOSI_PD5_PIN       = GPIO_PD5,
    SSPI_MOSI_PF3_PIN       = GPIO_PF3,
    SSPI_MOSI_PF7_PIN       = GPIO_PF7,
    SSPI_MOSI_PG3_PIN       = GPIO_PG3,
    SSPI_MOSI_PG7_PIN       = GPIO_PG7,
    SSPI_MOSI_PJ4_PIN       = GPIO_PJ4,


    SSPI_MISO_PA3_PIN      = GPIO_PA3,
    SSPI_MISO_PB0_PIN      = GPIO_PB0,
    SSPI_MISO_PB4_PIN      = GPIO_PB4,
    SSPI_MISO_PD2_PIN      = GPIO_PD2,
    SSPI_MISO_PD6_PIN      = GPIO_PD6,
    SSPI_MISO_PF4_PIN      = GPIO_PF4,
    SSPI_MISO_PG0_PIN      = GPIO_PG0,
    SSPI_MISO_PG4_PIN      = GPIO_PG4,
    SSPI_MISO_PH2_PIN      = GPIO_PH2,
    SSPI_MISO_PJ5_PIN      = GPIO_PJ5,
    SSPI_NONE_PIN          = GPIO_NONE_PIN,
}sspi_pin_def_e;
...
typedef enum{
    ...
    LSPI_CSN_PG0_PIN        = GPIO_PG0,
    LSPI_CSN_PG4_PIN        = GPIO_PG4,
    LSPI_CSN_PH4_PIN        = GPIO_PH4,
    LSPI_CSN_PJ5_PIN        = GPIO_PJ5,


    LSPI_CLK_PE0_PIN        = GPIO_PE0,
    LSPI_MOSI_IO0_PE1_PIN   = GPIO_PE1,
    LSPI_MISO_IO1_PE2_PIN   = GPIO_PE2,
    LSPI_IO2_PE3_PIN        = GPIO_PE3,
    LSPI_IO3_PE4_PIN        = GPIO_PE4,
    LSPI_IO4_PE5_PIN        = GPIO_PE5,
    LSPI_IO5_PE6_PIN        = GPIO_PE6,
    LSPI_IO6_PE7_PIN        = GPIO_PE7,
    LSPI_IO7_PF0_PIN        = GPIO_PF0,
    LSPI_DM_PF1_PIN         = GPIO_PF1,//Only OPI PSRAM
    LSPI_NONE_PIN           = GPIO_NONE_PIN,
}lspi_pin_def_e;

/**
 * @brief  Define the gspi pin.
 */
typedef enum{
    GSPI_CSN0_PA0_PIN = GPIO_PA0,
    GSPI_CSN0_PB7_PIN = GPIO_PB7,
    GSPI_CSN0_PG1_PIN = GPIO_PG1,
    GSPI_CSN0_PJ2_PIN = GPIO_PJ2,

    GSPI_CLK_PA1_PIN = GPIO_PA1,
    GSPI_CLK_PD2_PIN = GPIO_PD2,
    GSPI_CLK_PG2_PIN = GPIO_PG2,
    GSPI_CLK_PJ2_PIN = GPIO_PJ2,

    GSPI_MOSI_PA2_PIN = GPIO_PA2,
    GSPI_MOSI_PD3_PIN = GPIO_PD3,
    GSPI_MOSI_PG3_PIN = GPIO_PG3,
    GSPI_MOSI_PJ4_PIN = GPIO_PJ4,

    GSPI_MISO_PA3_PIN = GPIO_PA3,
    GSPI_MISO_PD4_PIN = GPIO_PD4,
    GSPI_MISO_PG4_PIN = GPIO_PG4,
    GSPI_MISO_PJ5_PIN = GPIO_PJ5,

    GSPI_IO2_PA4_PIN = GPIO_PA4,
    GSPI_IO2_PD5_PIN = GPIO_PD5,
    GSPI_IO2_PG5_PIN = GPIO_PG5,

    GSPI_IO3_PA5_PIN = GPIO_PA5,
    GSPI_IO3_PD6_PIN = GPIO_PD6,
    GSPI_IO3_PG6_PIN = GPIO_PG6,

    GSPI_IO4_PA6_PIN = GPIO_PA6,
    GSPI_IO4_PD7_PIN = GPIO_PD7,
    GSPI_IO4_PG7_PIN = GPIO_PG7,

    GSPI_IO5_PB0_PIN = GPIO_PB0,
    GSPI_IO5_PF2_PIN = GPIO_PF2,
    GSPI_IO5_PH4_PIN = GPIO_PH4,

    GSPI_IO6_PB1_PIN = GPIO_PB1,
    GSPI_IO6_PF3_PIN = GPIO_PF3,
    GSPI_IO6_PH5_PIN = GPIO_PH5,

    GSPI_IO7_PB2_PIN = GPIO_PB2,
    GSPI_IO7_PF4_PIN = GPIO_PF4,
    GSPI_IO7_PH6_PIN = GPIO_PH6,

    GSPI_CN1_PB3_PIN = GPIO_PB3,
    GSPI_CN1_PF5_PIN = GPIO_PF5,

    GSPI_CN2_PB4_PIN = GPIO_PB4,
    GSPI_CN2_PF6_PIN = GPIO_PF6,

    GSPI_CN3_PB6_PIN = GPIO_PB6,
    GSPI_CN3_PG0_PIN = GPIO_PG0,

    GSPI_DM_PB5_PIN = GPIO_PB5,
    GSPI_DM_PF7_PIN = GPIO_PF7,

    GSPI_NONE_PIN = GPIO_NONE_PIN,
}gspi_pin_def_e;
 ...
 */
typedef struct{
    sspi_pin_def_e          spi_clk_pin;
    sspi_pin_def_e          spi_csn_pin;
    sspi_pin_def_e     spi_mosi_io0_pin;
    sspi_pin_def_e     spi_miso_io1_pin;
}sspi_pin_config_t;
 ...
 */
typedef struct{
    gspi_pin_def_e          spi_clk_pin;
    gspi_pin_def_e          spi_csn_pin;
    gspi_pin_def_e     spi_mosi_io0_pin;
    gspi_pin_def_e     spi_miso_io1_pin;
    gspi_pin_def_e          spi_io2_pin;
    gspi_pin_def_e          spi_io3_pin;
    gspi_pin_def_e          spi_io4_pin;
    gspi_pin_def_e          spi_io5_pin;
    gspi_pin_def_e          spi_io6_pin;
    gspi_pin_def_e          spi_io7_pin;
    gspi_pin_def_e          spi_dm_pin;
}gspi_pin_config_t;

/**
 * @brief  Define the LSPI pin structure.
 */
typedef struct{
    ...
    lspi_pin_def_e          spi_io4_pin;
    lspi_pin_def_e          spi_io5_pin;
    lspi_pin_def_e          spi_io6_pin;
    lspi_pin_def_e          spi_io7_pin;
    lspi_pin_def_e          spi_dm_pin;
}lspi_pin_config_t;

/**
 * @brief  Define the GSPI  pin structure.
 */
typedef struct{
    gspi_pin_def_e        gspi_clk_pin;
    gspi_pin_def_e        gspi_csn0_pin;
    gspi_pin_def_e        gspi_csn1_pin;
    gspi_pin_def_e        gspi_csn2_pin;
    gspi_pin_def_e        gspi_csn3_pin;
    gspi_pin_def_e        gspi_mosi_io0_pin;
    gspi_pin_def_e        gspi_miso_io1_pin;
    gspi_pin_def_e        gspi_io2_pin;
    gspi_pin_def_e        gspi_io3_pin;
    gspi_pin_def_e        gspi_io4_pin;
    gspi_pin_def_e        gspi_io5_pin;
    gspi_pin_def_e        gspi_io6_pin;
    gspi_pin_def_e        gspi_io7_pin;
    gspi_pin_def_e        gspi_dm_pin;
...
typedef struct{
    ...
    unsigned char spi_xip_rd_ddr_mode:1;//enable ddr mode
    unsigned char :3;
...
/**
 * @brief   This function servers enable double data rate(ddr) mode.
 * @param[in]   spi_sel     - the spi module.
 * @return  none
 */
static inline void spi_ddr_en(spi_sel_e spi_sel)
{
    BM_SET(reg_spi_reg_ctrl0(spi_sel), FLD_SPI_DDR_MODE);
}

/**
 * @brief   This function servers disable double data rate(ddr)mode.
 * @param[in]   spi_sel     - the spi module.
 * @return  none
 */
static inline void spi_ddr_dis(spi_sel_e spi_sel)
{
    BM_CLR(reg_spi_reg_ctrl0(spi_sel), FLD_SPI_DDR_MODE);
}
 ...
 * @param[in]soft_mode  - dma llp soft mode
 * @return    none
 */
static inline void spi_set_tx_llp_sof_mode(dma_chn_e chn,unsigned char soft_mode)
{
    if(soft_mode){
...
/**
 * @brief     This function set DMA spi rx llp sof mode.
 * @param[in] chn    - dma channel
 * @return    none
 */
static inline void spi_set_rx_llp_sof_mode(dma_chn_e chn)
{
    reg_dma_ctrl_llp(chn) &= ~BIT((chn < 8 ? chn : (chn-8)));
}
 ...
 * @return      none
 */
void spi_master_write_read_dma_plus(spi_sel_e spi_sel, unsigned short cmd, unsigned char *addr, unsigned int addr_len, unsigned char *rd_data, unsigned int rd_len, spi_rd_tans_mode_e rd_mode);
