 ...
 */
unsigned short flash_read_status_mid166085_with_device_num(mspi_slave_device_num_e device_num)
{
...
unsigned char flash_write_status_mid166085_with_device_num(mspi_slave_device_num_e device_num, unsigned short data, mid166085_write_status_mask_e mask)
{
    ...
    unsigned short status = flash_read_status_mid166085_with_device_num(device_num);
    if(data != (status & mask)) //To reduce the operation of the status register.
    {
        status = data | (status & ~(mask));
        flash_write_status(device_num, FLASH_TYPE_16BIT_STATUS_TWO_CMD, status);
        status = flash_read_status_mid166085_with_device_num(device_num);
    }
    if(data == (status & mask))
    {
        return 1;
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
unsigned char flash_unlock_mid166085_with_device_num(mspi_slave_device_num_e device_num)
{
    flash_write_config_mid166085_with_device_num(device_num, 0x00, FLASH_WRITE_CONFIGURE_WPS_MID166085);
    return flash_write_status_mid166085_with_device_num(device_num, FLASH_LOCK_NONE_MID166085, FLASH_WRITE_STATUS_BP_MID166085);
}
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_read_otp_mid166085_with_device_num(mspi_slave_device_num_e device_num, unsigned long addr, unsigned long len, unsigned char* buf)
{
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_otp_mid166085_with_device_num(mspi_slave_device_num_e device_num, unsigned long addr, unsigned long len, unsigned char *buf)
{
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_erase_otp_mid166085_with_device_num(mspi_slave_device_num_e device_num, mid166085_otp_block_e addr)
{
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_lock_otp_mid166085_with_device_num(mspi_slave_device_num_e device_num, mid166085_lock_otp_e data)
{
    flash_write_status_mid166085_with_device_num(device_num, data, FLASH_WRITE_STATUS_OTP_MID166085);
}
 ...
 *              If an abnormality occurs, the firmware and user data may be rewritten, resulting in the final Product failure)
 */
void flash_write_config_mid166085_with_device_num(mspi_slave_device_num_e device_num, unsigned char data, mid166085_write_config_bit_e bit)
{
