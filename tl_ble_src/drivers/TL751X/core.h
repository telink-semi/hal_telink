...
/**
 * @brief     This function performs to get cclk_hclk tick.
 * @return    cclk_hclk timer tick value.
 */
...
{
    return ((unsigned long long)(rdmcycle() - ref) > us *  sys_clk.cclk_hclk);
}
/**
 * @brief       This function performs to set delay time by cclk_hclk tick.
 * @param[in]   core_cclk_hclk_tick - Number of ticks in cclk_hclk
 * @return      none
 */
_attribute_ram_code_sec_noinline_ void core_cclk_delay_tick(unsigned long long core_cclk_hclk_tick);
#endif
