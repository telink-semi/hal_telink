...
drv_api_status_e dma_clr_all_irq_status(void){
    ...
    {
       reg_dma_tc_isr(DMA_CHN0_IRQ)   = 0xff;
       reg_dma_err_isr(DMA_CHN0_IRQ)  = 0xff;
       reg_dma_abt_isr(DMA_CHN0_IRQ)  = 0xff;
       reg_dma_tc_isr(DMA_CHN8_IRQ)   = 0xff;
       reg_dma_err_isr(DMA_CHN8_IRQ)  = 0xff;
       reg_dma_abt_isr(DMA_CHN8_IRQ)  = 0xff;
       if(!(reg_dma_tc_isr(DMA_CHN0_IRQ)||reg_dma_err_isr(DMA_CHN0_IRQ)||reg_dma_abt_isr(DMA_CHN0_IRQ)||reg_dma_tc_isr(DMA_CHN8_IRQ)||reg_dma_err_isr(DMA_CHN8_IRQ)||reg_dma_abt_isr(DMA_CHN8_IRQ))){
           break;
        }
    }
