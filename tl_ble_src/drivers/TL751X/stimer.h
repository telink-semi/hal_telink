...
/**
 * @brief       This function servers to set tick irq capture of D25F.
 * @param[in]   tick - the value of irq tick.
 * @return      none.
 */
static inline void stimer_set_irq_capture_d25f(unsigned int tick)
{
    reg_system_irq_level_d25f = (tick);
}

/**
 * @brief       This function servers to set tick irq capture of N22.
 * @param[in]   tick - the value of irq tick.
 * @return      none.
 */
static inline void stimer_set_irq_capture_n22(unsigned int tick)
{
    reg_system_irq_level_n22 = (tick);
}

/**
 * @brief       This function servers to set tick irq capture of DSP.
 * @param[in]   tick - the value of irq tick.
 * @return      none.
 */
static inline void stimer_set_irq_capture_dsp(unsigned int tick)
{
    reg_system_irq_level_dsp = (tick);
}
