 ...
 * @return      none.
 */
_attribute_ram_code_sec_ static inline void mspi_set_ctrl(unsigned short ctrl)
{
    reg_mspi_ctrl = ctrl;
}
 ...
 * @return      none.
 */
_attribute_ram_code_sec_ static inline void mspi_set_reg_ctrl0(unsigned char ctrl)
{
...
/**
 * @brief       This function servers enable cmd format,the format of cmd phase is the same as the data phase(Dual/Quad/Octal).
 * @param[in]   none.
 * @return      none
 */
...
/**
 * @brief       This function servers to enable mspi octal mode.
 * @param[in]   none.
 * @return      none
 */
_attribute_ram_code_sec_ static inline void mspi_octal_mode_en(void)
{
    BM_SET(reg_mspi_ctrl1, FLD_MSPI_DUAL|FLD_MSPI_DUAD);
}

/**
 * @brief       This function servers to disable mspi octal mode..
 * @param[in]   none.
 * @return      none.
 */
_attribute_ram_code_sec_ static inline void mspi_octal_mode_dis(void)
{
    BM_CLR(reg_mspi_ctrl1, FLD_MSPI_DUAL|FLD_MSPI_DUAD);
}


/**
 * @brief       This function to enable address format.the format of addr phase is the same as the data phase(Dual/Quad/Octal).
 * @param[in]   none.
 * @return      none
 */
 ...
 * @return      none
 */
_attribute_ram_code_sec_ static inline void mspi_set_xip_page_mode(mspi_slave_device_num_e device_num, unsigned char en)
{
 ...
 * @return      none
 */
_attribute_ram_code_sec_ static inline void mspi_set_xip_timeout_mode(mspi_slave_device_num_e device_num, unsigned char en)
{
...
/**
 * @brief       This function servers to set octal mode.
 * @param[in]   none.
 * @return      none
 */
_attribute_ram_code_sec_ static inline void mspi_set_octal_mode(void)
{
    mspi_quad_mode_en();
    mspi_quad_mode_en();
    mspi_3line_mode_dis();
