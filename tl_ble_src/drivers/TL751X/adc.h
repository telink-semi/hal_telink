 ...
 *  Introduction
 *  ===============
 *  TL751X supports hardware ADC function.
 *
 *  API Reference
 *  ===============
 *  Header File: adc.h
 ...
 */
typedef enum{
    ADC_GPIO_PG0 = GPIO_PG0 | (0x1<<12),
    ADC_GPIO_PG1 = GPIO_PG1 | (0x2<<12),
    ADC_GPIO_PG2 = GPIO_PG2 | (0x3<<12),
    ADC_GPIO_PG3 = GPIO_PG3 | (0x4<<12),
    ADC_GPIO_PG4 = GPIO_PG4 | (0x5<<12),
    ADC_GPIO_PG5 = GPIO_PG5 | (0x6<<12),
    ADC_GPIO_PG6 = GPIO_PG6 | (0x7<<12),
    ADC_GPIO_PG7 = GPIO_PG7 | (0x8<<12),
    ADC_GPIO_ANA0 = GPIO_ANA0 | (0x9<<12),
    ADC_GPIO_ANA1 = GPIO_ANA1 | (0xa<<12),
}adc_input_pin_e;
