 ...
 */
_attribute_ram_code_sec_ unsigned char analog_read_reg8(unsigned int addr){
    unsigned int r=core_interrupt_disable();
    reg_ana_addr = addr;
    reg_ana_len=0x1;
    reg_ana_ctrl = FLD_ANA_CYC | ((addr&0x100)>>1);
    analog_wait();
 ...
 * @return     none.
 */
_attribute_ram_code_sec_ void analog_write_reg8(unsigned int addr, unsigned char data){
    unsigned int r=core_interrupt_disable();
    reg_ana_len = 1;
    reg_ana_addr = addr;
    reg_ana_data(0) = data;
    analog_wait_txbuf_no_empty();
    reg_ana_ctrl = (FLD_ANA_CYC | FLD_ANA_RW | ((addr&0x100)>>1));
    analog_wait();
    reg_ana_ctrl =0x00;
    core_restore_interrupt(r);
}
 ...
 * @return     none.
 */
_attribute_ram_code_sec_ void analog_write_reg16(unsigned int addr, unsigned short data)
{
    unsigned int r=core_interrupt_disable();
    reg_ana_len=2;
    reg_ana_addr = addr;
 ...
 * @return     the result of read.
 */
_attribute_ram_code_sec_ unsigned short analog_read_reg16(unsigned int addr)
{
    unsigned int r=core_interrupt_disable();
    reg_ana_len=2;
    reg_ana_addr = addr;
 ...
 * @return     the result of read.
 */
_attribute_ram_code_sec_ unsigned int analog_read_reg32(unsigned int addr)
{
    unsigned int r=core_interrupt_disable();
    reg_ana_len = 4;
    reg_ana_addr = addr;
 ...
 * @return     none.
 */
_attribute_ram_code_sec_ void analog_write_reg32(unsigned int addr, unsigned int data)
{
    unsigned int r=core_interrupt_disable();
    reg_ana_len = 4;
    reg_ana_addr = addr;
