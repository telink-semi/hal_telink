...
{
    BM_SET(reg_bb_dma_ctr0(chn),BIT(0));
}
...
{
    BM_CLR(reg_bb_dma_ctr0(chn),BIT(0));
}

/**
* @brief     This function configures rf DMA control register.
* @param[in] chn    - dma channel
...
/**
* @brief   this function set source address for rf DMA
* @param[in]  chn - DMA channel
...
* @brief   this function set destination address for rf DMA
* @param[in]  chn - DMA channel
