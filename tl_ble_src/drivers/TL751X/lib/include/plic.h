...
#define IRQ_TRNG                    12 /* TRNG_IRQ, - trng_irq_handler */
...
#define IRQ_CHARGE                  32 /* CHARGE_IRQ - charge_irq_handler */
...
#define IRQ_NPE_SYNC                42 /* NPE_SYNC_IRQ, - npe_sync_irq_handler */
#define IRQ_NPE_COMB                43 /* NPE_COMB_IRQ, - npe_comb_irq_handler */
...
#define IRQ_DMA1                    47 /* DMA1_IRQ, - dma1_irq_handler */
#define IRQ_SDIO                    48 /* SDIO_IRQ, - sdio_irq_handler */
#define IRQ_MAILBOX_DSP_TO_D25      49 /* DSP_TO_D25_IRQ, - mailbox_dsp_to_d25_irq_handler */
#define IRQ_MAILBOX_N22_TO_D25      50 /* N22_TO_D25_IRQ, - mailbox_n22_to_d25_irq_handler */
#define IRQ_SKE                     51 /* SKE_IRQ, - ske_irq_handler */
#define IRQ_USB1_PWDN               52 /* USB1_PWDN, - usb1_pwdn_irq_handler */
#define IRQ_USB1_250US_OR_SOF       53 /* USB1_250US_OR_SOF_IRQ: USB1 250us or SOF interrupt, - usb1_250us_or_sof_irq_handler */
#define IRQ_USB1_RESET              54 /* USB1_RESET_IRQ: USB1 reset interrupt, - usb1_reset_irq_handler */
#define IRQ_USB_CHG                 55 /* USB_CHG_IRQ, - usb_chg_irq_handler */
#define IRQ_UART3                   56 /* UART3_IRQ, - uart3_irq_handler */
#define IRQ_UART2                   57 /* UART2_IRQ, - uart2_irq_handler */
#define IRQ_HASH                    58 /* HASH_IRQ, - hash_irq_handler */
#define IRQ_USB1_CTRL_EP_SETUP      59 /* USB1_SETUP_IRQ: USB1 setup interrupt, - usb1_ctrl_ep_setup_irq_handler */
#define IRQ_USB1_CTRL_EP_DATA       60 /* USB1_DATA_IRQ: USB1 data interrupt, - usb1_ctrl_ep_data_irq_handler */
