...
#define RF_RX_WAIT_MIN_VALUE            (9)
#define RF_TX_WAIT_MIN_VALUE            (9)
...
#define TX_SETTLE_REG_MIN                   43
#define RX_SETTLE_REG_MIN                   43
...
#define TX_SETTLE_MIN_ALIGN_1MPHY           51  //43 + 8(1 preamble 1M PHY)
...
__INLINE u8 rf_ble_get_tx_pwr_idx(s8 rfTxPower)
{
    ...
    /*VBAT*/
    if      (rfTxPower >=   9)  {  rfPwrLvlIdx = RF_POWER_INDEX_P9p53dBm;  }
    else if (rfTxPower >=   8)  {  rfPwrLvlIdx = RF_POWER_INDEX_P8p51dBm;  }
    else if (rfTxPower >=   7)  {  rfPwrLvlIdx = RF_POWER_INDEX_P7p53dBm;  }
    else if (rfTxPower >=   6)  {  rfPwrLvlIdx = RF_POWER_INDEX_P6p51dBm;  }
    /*VANT*/
    else if (rfTxPower >=   5)  {  rfPwrLvlIdx = RF_POWER_INDEX_P5p42dBm;  }
    else if (rfTxPower >=   4)  {  rfPwrLvlIdx = RF_POWER_INDEX_P4p48dBm;  }
    else if (rfTxPower >=   3)  {  rfPwrLvlIdx = RF_POWER_INDEX_P3p62dBm;  }
    else if (rfTxPower >=   2)  {  rfPwrLvlIdx = RF_POWER_INDEX_P2p52dBm;  }
    else if (rfTxPower >=   1)  {  rfPwrLvlIdx = RF_POWER_INDEX_P1p51dBm;  }
    else if (rfTxPower >=   0)  {  rfPwrLvlIdx = RF_POWER_INDEX_P0p00dBm;  }
    else if (rfTxPower >=  -4)  {  rfPwrLvlIdx = RF_POWER_INDEX_N4p26dBm;  }
//    else if (rfTxPower >=  -6)  {  rfPwrLvlIdx = RF_POWER_INDEX_N5p94dBm;  }
    else if (rfTxPower >= -10)  {  rfPwrLvlIdx = RF_POWER_INDEX_N9p07dBm; }
    else if (rfTxPower >= -14)  {  rfPwrLvlIdx = RF_POWER_INDEX_N14p12dBm; }
    else                        {  rfPwrLvlIdx = RF_POWER_INDEX_N23p25dBm; }
...
__INLINE s8 rf_ble_get_tx_pwr_level(rf_power_level_index_e rfPwrLvlIdx)
{
    ...
    /*VBAT*/
    if      (rfPwrLvlIdx <= RF_POWER_INDEX_P9p53dBm)  {  rfTxPower =   9;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P8p51dBm)  {  rfTxPower =   8;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P7p53dBm)  {  rfTxPower =   7;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P6p51dBm)  {  rfTxPower =   6;  }
    /*VANT*/
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P5p42dBm)  {  rfTxPower =   5;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P4p48dBm)  {  rfTxPower =   4;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P3p62dBm)  {  rfTxPower =   3;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P2p52dBm)  {  rfTxPower =   2;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P1p51dBm)  {  rfTxPower =   1;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_P0p00dBm)  {  rfTxPower =   0;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N4p26dBm)  {  rfTxPower =  -4;  }
//    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N5p94dBm)  {  rfTxPower =  -6;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N9p07dBm)  {  rfTxPower = -10;  }
    else if (rfPwrLvlIdx <= RF_POWER_INDEX_N14p12dBm) {  rfTxPower = -14;  }
    else                                              {  rfTxPower = -23;  }
...
#define rf_ble_tx_on()
#endif /* DRIVERS_TL751X_EXT_DRIVER_DRIVER_LIB_EXT_RF_H_ */
