...
#define ext_reg_mtime_low              0xc6000000   // refer to reg_mtime_low
#define ext_reg_mtime_high             0xc6000004   // refer to reg_mtime_high

#define ext_reg_mtimecmp               0xc6000008   // refer to reg_mtimecmp
/******************************* mtime register end************************************************************/
...
#define RF_POWER_P3dBm   RF_POWER_INDEX_P3p62dBm
#define RF_POWER_P0dBm   RF_POWER_INDEX_P0p00dBm
#define RF_POWER_P9dBm   RF_POWER_INDEX_P9p53dBm
...
#endif /* DRIVERS_TL751X_EXT_MISC_H_ */
