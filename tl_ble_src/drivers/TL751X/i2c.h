...
typedef enum{
    ...
    I2C_GPIO_SDA_H4     = GPIO_PH4,
    I2C_GPIO_SDA_H6     = GPIO_PH6,
    I2C_GPIO_SDA_J3     = GPIO_PJ3,
    I2C_GPIO_SDA_J5     = GPIO_PJ5,
}i2c_sda_pin_e;
...
typedef enum{
    ...
    I2C_GPIO_SCL_F3     = GPIO_PF3,
    I2C_GPIO_SCL_F5     = GPIO_PF5,
    I2C_GPIO_SCL_F7     = GPIO_PF7,
    I2C_GPIO_SCL_G1     = GPIO_PG1,
    I2C_GPIO_SCL_G3     = GPIO_PG3,
    I2C_GPIO_SCL_G5     = GPIO_PG5,
    I2C_GPIO_SCL_G7     = GPIO_PG7,
    I2C_GPIO_SCL_H5     = GPIO_PH5,
    I2C_GPIO_SCL_J2     = GPIO_PJ2,
    I2C_GPIO_SCL_J4     = GPIO_PJ4,
}i2c_scl_pin_e;
...
typedef enum{
    ...
    I2C1_GPIO_SDA_H4        = GPIO_PH4,
    I2C1_GPIO_SDA_H6        = GPIO_PH6,
    I2C1_GPIO_SDA_J3        = GPIO_PJ3,
    I2C1_GPIO_SDA_J5        = GPIO_PJ5,
}i2c1_m_sda_pin_e;
...
typedef enum{
    ...
    I2C1_GPIO_SCL_G7        = GPIO_PG7,
    I2C1_GPIO_SCL_H5        = GPIO_PH5,
    I2C1_GPIO_SCL_J2        = GPIO_PJ2,
    I2C1_GPIO_SCL_J4        = GPIO_PJ4,
}i2c1_m_scl_pin_e;

/*
 * @brief define i2c function
 */
enum {
    I2C_FC    = 4,
    I2C1_M_FC = 5,
