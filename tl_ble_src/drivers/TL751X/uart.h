 ...
 *********************************************************************************************************************/
/**
 *  @brief  Define UART CTS pin.
 */
typedef enum{
    UART0_CTS_PA2 = GPIO_PA2,
    UART0_CTS_PA6 = GPIO_PA6,
    UART0_CTS_PB3 = GPIO_PB3,
    UART0_CTS_PB7 = GPIO_PB7,
    UART0_CTS_PD5 = GPIO_PD5,
    UART0_CTS_PF3 = GPIO_PF3,
    UART0_CTS_PF7 = GPIO_PF7,
    UART0_CTS_PG3 = GPIO_PG3,
    UART0_CTS_PG7 = GPIO_PG7,
    UART0_CTS_PJ4 = GPIO_PJ4,

    UART1_CTS_PA2 = GPIO_PA2,
    UART1_CTS_PA6 = GPIO_PA6,
    UART1_CTS_PB3 = GPIO_PB3,
    UART1_CTS_PB7 = GPIO_PB7,
    UART1_CTS_PD5 = GPIO_PD5,
    UART1_CTS_PF3 = GPIO_PF3,
    UART1_CTS_PF7 = GPIO_PF7,
    UART1_CTS_PG3 = GPIO_PG3,
    UART1_CTS_PG7 = GPIO_PG7,
    UART1_CTS_PJ4 = GPIO_PJ4,

    UART2_CTS_PA2 = GPIO_PA2,
    UART2_CTS_PA6 = GPIO_PA6,
    UART2_CTS_PB3 = GPIO_PB3,
    UART2_CTS_PB7 = GPIO_PB7,
    UART2_CTS_PD5 = GPIO_PD5,
    UART2_CTS_PF3 = GPIO_PF3,
    UART2_CTS_PF7 = GPIO_PF7,
    UART2_CTS_PG3 = GPIO_PG3,
    UART2_CTS_PG7 = GPIO_PG7,
    UART2_CTS_PJ4 = GPIO_PJ4,

    UART3_CTS_PA2 = GPIO_PA2,
    UART3_CTS_PA6 = GPIO_PA6,
    UART3_CTS_PB3 = GPIO_PB3,
    UART3_CTS_PB7 = GPIO_PB7,
    UART3_CTS_PD5 = GPIO_PD5,
    UART3_CTS_PF3 = GPIO_PF3,
    UART3_CTS_PF7 = GPIO_PF7,
    UART3_CTS_PG3 = GPIO_PG3,
    UART3_CTS_PG7 = GPIO_PG7,
    UART3_CTS_PJ4 = GPIO_PJ4,
}uart_cts_pin_e;

/**
 *  @brief  Define UART RTS pin.
 */
typedef enum{
    UART0_RTS_PA3 = GPIO_PA3,
    UART0_RTS_PB0 = GPIO_PB0,
    UART0_RTS_PB4 = GPIO_PB4,
    UART0_RTS_PD2 = GPIO_PD2,
    UART0_RTS_PD6 = GPIO_PD6,
    UART0_RTS_PF4 = GPIO_PF4,
    UART0_RTS_PG0 = GPIO_PG0,
    UART0_RTS_PG4 = GPIO_PG4,
    UART0_RTS_PH4 = GPIO_PH4,
    UART0_RTS_PJ5 = GPIO_PJ5,



    UART1_RTS_PA3 = GPIO_PA3,
    UART1_RTS_PB0 = GPIO_PB0,
    UART1_RTS_PB4 = GPIO_PB4,
    UART1_RTS_PD2 = GPIO_PD2,
    UART1_RTS_PD6 = GPIO_PD6,
    UART1_RTS_PF4 = GPIO_PF4,
    UART1_RTS_PG0 = GPIO_PG0,
    UART1_RTS_PG4 = GPIO_PG4,
    UART1_RTS_PH4 = GPIO_PH4,
    UART1_RTS_PJ5 = GPIO_PJ5,

    UART2_RTS_PA3 = GPIO_PA3,
    UART2_RTS_PB0 = GPIO_PB0,
    UART2_RTS_PB4 = GPIO_PB4,
    UART2_RTS_PD2 = GPIO_PD2,
    UART2_RTS_PD6 = GPIO_PD6,
    UART2_RTS_PF4 = GPIO_PF4,
    UART2_RTS_PG0 = GPIO_PG0,
    UART2_RTS_PG4 = GPIO_PG4,
    UART2_RTS_PH4 = GPIO_PH4,
    UART2_RTS_PJ5 = GPIO_PJ5,

    UART3_RTS_PA3 = GPIO_PA3,
    UART3_RTS_PB0 = GPIO_PB0,
    UART3_RTS_PB4 = GPIO_PB4,
    UART3_RTS_PD2 = GPIO_PD2,
    UART3_RTS_PD6 = GPIO_PD6,
    UART3_RTS_PF4 = GPIO_PF4,
    UART3_RTS_PG0 = GPIO_PG0,
    UART3_RTS_PG4 = GPIO_PG4,
    UART3_RTS_PH4 = GPIO_PH4,
    UART3_RTS_PJ5 = GPIO_PJ5,
 ...
 */
typedef enum{
    UART0_TX_PA0 = GPIO_PA0,
    UART0_TX_PA4 = GPIO_PA4,
    UART0_TX_PB1 = GPIO_PB1,
    UART0_TX_PB5 = GPIO_PB5,
    UART0_TX_PD3 = GPIO_PD3,
    UART0_TX_PD7 = GPIO_PD7,
    UART0_TX_PF5 = GPIO_PF5,
    UART0_TX_PG1 = GPIO_PG1,
    UART0_TX_PG5 = GPIO_PG5,
    UART0_TX_PH5 = GPIO_PH5,
    UART0_TX_PJ2 = GPIO_PJ2,

    UART1_TX_PA0 = GPIO_PA0,
    UART1_TX_PA4 = GPIO_PA4,
    UART1_TX_PB1 = GPIO_PB1,
    UART1_TX_PB5 = GPIO_PB5,
    UART1_TX_PD3 = GPIO_PD3,
    UART1_TX_PD7 = GPIO_PD7,
    UART1_TX_PF5 = GPIO_PF5,
    UART1_TX_PG1 = GPIO_PG1,
    UART1_TX_PG5 = GPIO_PG5,
    UART1_TX_PH5 = GPIO_PH5,
    UART1_TX_PJ2 = GPIO_PJ2,

    UART2_TX_PA0 = GPIO_PA0,
    UART2_TX_PA4 = GPIO_PA4,
    UART2_TX_PB1 = GPIO_PB1,
    UART2_TX_PB5 = GPIO_PB5,
    UART2_TX_PD3 = GPIO_PD3,
    UART2_TX_PD7 = GPIO_PD7,
    UART2_TX_PF5 = GPIO_PF5,
    UART2_TX_PG1 = GPIO_PG1,
    UART2_TX_PG5 = GPIO_PG5,
    UART2_TX_PH5 = GPIO_PH5,
    UART2_TX_PJ2 = GPIO_PJ2,

    UART3_TX_PA0 = GPIO_PA0,
    UART3_TX_PA4 = GPIO_PA4,
    UART3_TX_PB1 = GPIO_PB1,
    UART3_TX_PB5 = GPIO_PB5,
    UART3_TX_PD3 = GPIO_PD3,
    UART3_TX_PD7 = GPIO_PD7,
    UART3_TX_PF5 = GPIO_PF5,
    UART3_TX_PG1 = GPIO_PG1,
    UART3_TX_PG5 = GPIO_PG5,
    UART3_TX_PH5 = GPIO_PH5,
    UART3_TX_PJ2 = GPIO_PJ2,
 ...
 */
typedef enum{
    UART0_RX_PA1 = GPIO_PA1,
    UART0_RX_PA5 = GPIO_PA5,
    UART0_RX_PB2 = GPIO_PB2,
    UART0_RX_PB6 = GPIO_PB6,
    UART0_RX_PD4 = GPIO_PD4,
    UART0_RX_PF2 = GPIO_PF2,
    UART0_RX_PF6 = GPIO_PF6,
    UART0_RX_PG2 = GPIO_PG2,
    UART0_RX_PG6 = GPIO_PG6,
    UART0_RX_PH6 = GPIO_PH6,
    UART0_RX_PJ3 = GPIO_PJ3,
    ...
    UART1_RX_PD4 = GPIO_PD4,
    UART1_RX_PF2 = GPIO_PF2,
    UART1_RX_PF6 = GPIO_PF6,
    UART1_RX_PG2 = GPIO_PG2,
    UART1_RX_PG6 = GPIO_PG6,
    UART1_RX_PH6 = GPIO_PH6,
    UART1_RX_PJ3 = GPIO_PJ3,

    UART2_RX_PA1 = GPIO_PA1,
    UART2_RX_PA5 = GPIO_PA5,
    UART2_RX_PB2 = GPIO_PB2,
    UART2_RX_PB6 = GPIO_PB6,
    UART2_RX_PD4 = GPIO_PD4,
    UART2_RX_PF2 = GPIO_PF2,
    UART2_RX_PF6 = GPIO_PF6,
    UART2_RX_PG2 = GPIO_PG2,
    UART2_RX_PG6 = GPIO_PG6,
    UART2_RX_PH6 = GPIO_PH6,
    UART2_RX_PJ3 = GPIO_PJ3,

    UART3_RX_PA1 = GPIO_PA1,
    UART3_RX_PA5 = GPIO_PA5,
    UART3_RX_PB2 = GPIO_PB2,
    UART3_RX_PB6 = GPIO_PB6,
    UART3_RX_PD4 = GPIO_PD4,
    UART3_RX_PF2 = GPIO_PF2,
    UART3_RX_PF6 = GPIO_PF6,
    UART3_RX_PG2 = GPIO_PG2,
    UART3_RX_PG6 = GPIO_PG6,
    UART3_RX_PH6 = GPIO_PH6,
    UART3_RX_PJ3 = GPIO_PJ3,
 ...
 *  @return     none
 */
void uart_set_cts_pin(uart_num_e uart_num,uart_cts_pin_e cts_pin);
 ...
 *  @return     none
 */
void uart_set_rts_pin(uart_num_e uart_num,uart_rts_pin_e rts_pin);
...
* @return     none
*/
void uart_set_pin(uart_num_e uart_num,uart_tx_pin_e tx_pin,uart_rx_pin_e rx_pin);
...
* @return     none
*/
void uart_set_rtx_pin(uart_num_e uart_num,uart_rx_pin_e rtx_pin);
