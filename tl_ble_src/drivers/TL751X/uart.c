 ...
 *                                              global variable                                                       *
 *********************************************************************************************************************/
dma_config_t uart_tx_dma_config[4]={
...
dma_config_t uart_rx_dma_config[4]={
 ...
 *                                              local variable                                                     *
 *********************************************************************************************************************/
 static unsigned char uart_dma_tx_chn[4];
 static unsigned char uart_dma_rx_chn[4];
 static unsigned int uart_dma_rev_size[4];
...
void uart_set_rx_timeout(uart_num_e uart_num,unsigned char bwpc, unsigned char bit_cnt, uart_timeout_mul_e mul,unsigned char rxtimeout_exp)
{
 ...
 unsigned char uart_tx_byte_index[4] = {0};
/**
...
unsigned char uart_rx_byte_index[4]={0};
/**
...
void uart_set_cts_pin(uart_num_e uart_num,uart_cts_pin_e cts_pin)
{
    ...
    gpio_set_mux_function((gpio_func_pin_e)cts_pin,UART0_CTS_I+uart_num);
...
void uart_set_rts_pin(uart_num_e uart_num,uart_rts_pin_e rts_pin)
{
    ...
    gpio_set_mux_function((gpio_func_pin_e)rts_pin,UART0_RTS+uart_num);
...
void uart_set_pin(uart_num_e uart_num,uart_tx_pin_e tx_pin,uart_rx_pin_e rx_pin)
{
    ...
    if(tx_pin != UART_TX_NONE_PIN){
        ...
        gpio_set_mux_function((gpio_func_pin_e)tx_pin, (UART0_TX+uart_num));
    ...
    if(rx_pin != UART_RX_NONE_PIN){
        ...
        gpio_set_mux_function((gpio_func_pin_e)rx_pin, UART0_RTX_IO+uart_num);
...
void uart_set_rtx_pin(uart_num_e uart_num,uart_rx_pin_e rtx_pin)
{
    ...
    gpio_set_mux_function((gpio_func_pin_e)rtx_pin,UART0_RTX_IO+uart_num);
