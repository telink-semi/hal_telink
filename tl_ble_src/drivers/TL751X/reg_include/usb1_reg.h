...
/*******************************      usb1 registers: 0x101000      ******************************/
#define REG_USB1_BASE               0x101000

#define reg_usb1_ctrl_ep_ptr        REG_ADDR8(REG_USB1_BASE)
...
enum
{
    FLD_USB1_USB_CTRL_AUTO_CLK      = BIT(0),
    FLD_USB1_USB_CTRL_LOW_SPD       = BIT(1),
    FLD_USB1_USB_CTRL_LOW_JITT      = BIT(2),
    FLD_USB1_USB_CTRL_TEST_MODE     = BIT(3),
    FLD_USB1_CTRL_CLK_SEL           = BIT_RNG(4,7),
};

#define reg_usb1_cycl_cali          REG_ADDR8(REG_USB1_BASE + 0x06)
#define reg_usb1_cych_cali          REG_ADDR8(REG_USB1_BASE + 0x07)

#define reg_usb1_mdev               REG_ADDR8(REG_USB1_BASE + 0x0a)
enum
{
    FLD_USB1_USB_MDEV_SELF_PWR      = BIT(0),
    FLD_USB1_USB_MDEV_SUSP_STA      = BIT(1),
...
enum
{
    ...
    FLD_USB1_IRQ_RESET_LVL          = BIT(4),
    FLD_USB1_IRQ_250US_LVL          = BIT(5),
    /* BIT(6) reserved */
    FLD_USB1_IRQ_SOF_LVL            = BIT(7),
};
...
#define reg_usb1_ep8_hptr           REG_ADDR8(REG_USB1_BASE + 0x18)                /* bit[1:0]. */
#define reg_usb1_ep7_hptr           REG_ADDR8(REG_USB1_BASE + 0x1f)                /* bit[1:0]. */
#define reg_usb1_ep_ptrh(i)         REG_ADDR8(REG_USB1_BASE + 0x18 + ((i) & 0x07)) /* only ep7 and ep8. */

#define reg_usb1_ep8_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x20) /* default 0x80. */
#define reg_usb1_ep1_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x21) /* default 0x00. */
#define reg_usb1_ep2_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x22) /* default 0x08. */
#define reg_usb1_ep3_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x23) /* default 0x10. */
#define reg_usb1_ep4_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x24) /* default 0x00. */
#define reg_usb1_ep5_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x25) /* default 0x08. */
#define reg_usb1_ep6_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x26) /* default 0x10. */
#define reg_usb1_ep7_buf_addr       REG_ADDR8(REG_USB1_BASE + 0x27) /* default 0x00. */
#define reg_usb1_ep_buf_addr(i)     REG_ADDR8(REG_USB1_BASE + 0x20 + ((i) & 0x07))

#define reg_usb1_ep8_buf_h_addr     REG_ADDR8(REG_USB1_BASE + 0x28) /* bit[1:0]. */ 
#define reg_usb1_ep7_buf_h_addr     REG_ADDR8(REG_USB1_BASE + 0x2f) /* bit[1:0]. */
#define reg_usb1_ep_buf_h_addr(i)   REG_ADDR8(REG_USB1_BASE + 0x28 + ((i) & 0x07)) /* only ep7 and ep8. */
...
#define reg_usb1_ep8_send_max       REG_ADDR8(REG_USB1_BASE + 0x3b)

#define reg_usb1_ep8_send_thres     REG_ADDR8(REG_USB1_BASE + 0x3c)
#define reg_usb1_ep8_send_h_thres   REG_ADDR8(REG_USB1_BASE + 0x61)

#define reg_usb1_ep8_fifo_mode      REG_ADDR8(REG_USB1_BASE + 0x3d)
enum
{
    FLD_USB1_ENP8_FIFO_MODE         = BIT(0),
    FLD_USB1_ENP8_FULL_FLAG         = BIT(1),
};
...
#define reg_usb1_ep_dat_word(i)     REG_ADDR32(REG_USB1_BASE + 0x40 + (((i) & 0x07) << 2))
#define reg_usb1_ep_dat_byte(i, j)  REG_ADDR8(REG_USB1_BASE + 0x40 + (((i) & 0x07) << 2) + (j))
...
#define reg_usb1_sof_frame1         REG_ADDR8(REG_USB1_BASE + 0x63)

#define reg_usb1_edps_eptr          REG_ADDR16(REG_USB1_BASE + 0x64)
#define reg_usb1_edps_udc           REG_ADDR16(REG_USB1_BASE + 0x66)
#define reg_usb1_edps_sptr          REG_ADDR16(REG_USB1_BASE + 0x80)
#define reg_usb1_edps_maxh          REG_ADDR8(REG_USB1_BASE + 0x82)

#define reg_usb1_edps_full_thrd     REG_ADDR8(REG_USB1_BASE + 0x83)
