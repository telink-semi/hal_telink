...
#define DMA_REG_H
#include "soc.h"
/*******************************    dma registers:  dma0 0x100400 /dma1 0x101400    ******************************/
#define DMA_BASE_ADDR                  0x100400
#define reg_dma_id                  REG_ADDR32(0x100400+((i)>>3)*0x1000)
#define reg_dma_cfg                 REG_ADDR32(0x100410+((i)>>3)*0x1000)
...
#define reg_dma_err_mask(i)             REG_ADDR8(DMA_BASE_ADDR+((i)>>3)*0x1000+0x29)
enum{
...
#define reg_dma_ctrl_llp(i)         REG_ADDR8(DMA_BASE_ADDR+0x25+((i)>>3)*0x1000)

#define reg_dma_abt_mask(i)             REG_ADDR8(DMA_BASE_ADDR+((i)>>3)*0x1000+0x2a)
enum{
...
#define reg_dma_ctrl(i)             REG_ADDR32(DMA_BASE_ADDR+0x44+((i)>>3)*0x1000 +((i)%8)*0x14)
enum{
...
#define reg_dma_err_isr(i)          REG_ADDR8(DMA_BASE_ADDR+0x30+(((i)>0x80)?1:0)*0x1000)
#define reg_dma_abt_isr(i)          REG_ADDR8(DMA_BASE_ADDR+0x31+(((i)>0x80)?1:0)*0x1000)
#define reg_dma_tc_isr(i)           REG_ADDR8(DMA_BASE_ADDR+0x32+(((i)>0x80)?1:0)*0x1000)
...
#define reg_dma_ctr3(i)             REG_ADDR8(DMA_BASE_ADDR+0x47 +((i)>>3)*0x1000 +((i)%8)*0x14)
...
#define reg_dma_src_addr(i)         REG_ADDR32(DMA_BASE_ADDR+0x48 +((i)>>3)*0x1000 +((i)%8)*0x14)
#define reg_dma_dst_addr(i)         REG_ADDR32(DMA_BASE_ADDR+0x4c +((i)>>3)*0x1000 +((i)%8)*0x14)



#define reg_dma_size0(i)            REG_ADDR16(DMA_BASE_ADDR+0x50 +((i)>>3)*0x1000 +((i)%8)*0x14)
enum{
    FLD_DMA_TANS_SIZE0              = BIT_RNG(0,15),
};
#define reg_dma_size1(i)            REG_ADDR8(DMA_BASE_ADDR+0x52 +((i)>>3)*0x1000 +((i)%8)*0x14)
enum{
    FLD_DMA_TANS_SIZE1              = BIT_RNG(0,5),
    FLD_DMA_TANS_IDX                = BIT_RNG(6,7),
};
#define reg_dma_cr3(i)              REG_ADDR8(DMA_BASE_ADDR+0x53 +((i)>>3)*0x1000 +((i)%8)*0x14)
enum{
    FLD_DMA_TSR2_OFF_1K_MODE        = BIT(7)
};

#define reg_dma_llp(i)              REG_ADDR32(DMA_BASE_ADDR+0x54 +((i)>>3)*0x1000 +((i)%8)*0x14)
