...
#define    reg_rf_mdm_irq_status_clr  REG_ADDR8(CSEMDIGADDR+0x374)
...
#define    reg_rf_dig_tx_top_tx_pow     REG_ADDR8(CSEMDIGADDR+0x107)
...
#define   reg_rf_ana_trx_rf_pa_pmu                REG_ADDR8(CSEMDIGADDR+0x2c0)
#define   reg_rf_ana_trx_rf_pa_pmu_lut_0_0        REG_ADDR8(CSEMDIGADDR+0x2c2)
#define   reg_rf_ana_trx_rf_pa_pmu_lut_0_1        REG_ADDR8(CSEMDIGADDR+0x2c3)
#define   reg_rf_ana_trx_rf_pa_pmu_lut_1_0        REG_ADDR8(CSEMDIGADDR+0x2c4)
#define   reg_rf_ana_trx_rf_pa_pmu_lut_1_1        REG_ADDR8(CSEMDIGADDR+0x2c5)


#define    reg_rf_ana_trx_bb_adcs_pow_ena               REG_ADDR8(CSEMDIGADDR+0x2e7)
enum{
...
#define    reg_rf_csemdig_ana_trx_adpll_dyn       REG_ADDR8(CSEMDIGADDR+0x2f9)

#define    reg_rf_csemdig_refe_config0       REG_ADDR8(CSEMDIGADDR+0x2fc)
#define    reg_rf_csemdig_refe_config1       REG_ADDR8(CSEMDIGADDR+0x2fd)
#define    reg_rf_csemdig_refe               REG_ADDR8(CSEMDIGADDR+0x2fe)

#define    reg_rf_csemdig_refe_config        REG_ADDR16(CSEMDIGADDR+0x2fc)
enum{
...
#define    reg_rf_csemdig_refe_block_en      REG_ADDR8(CSEMDIGADDR+0x2ff)
enum{
...
#define    reg_rf_refe_xtal3      REG_ADDR8(CSEMDIGADDR+0x307)
enum{
...
#define    reg_rf_kdco_lut         REG_ADDR8(CSEMADPLLADDR+0x02b)
enum{
    FLD_RF_KDCO_LUT_E     = BIT(0),
    FLD_RF_KDCO_LUT_DBL   = BIT(1),
};

#define    reg_rf_kdtc_lut         REG_ADDR8(CSEMADPLLADDR+0x035)
enum{
    FLD_RF_KDTC_LUT_E     = BIT(0),
    FLD_RF_KDTC_LUT_DBL   = BIT(1),
};

#define    reg_rf_kdco_cal0         REG_ADDR8(CSEMADPLLADDR+0x03a)
enum{
    FLD_RF_KDCO_CAL_TX_E        =   BIT(0),
    FLD_RF_KDCO_CAL_RX_E        =   BIT(1),
    FLD_RF_KDCO_CAL_IF_E        =   BIT(2),
    FLD_RF_KDCO_CAL_EST_DEV     =   BIT_RNG(3,4),
    FLD_RF_KDCO_CAL_TC          =   BIT_RNG(5,7),
};

#define    reg_rf_kdco_cal1         REG_ADDR8(CSEMADPLLADDR+0x03b)
enum{
    FLD_RF_KDCO_CAL_POS_NEG        =   BIT(0),
    FLD_RF_KDCO_CAL_DEV_TUNE       =   BIT(1),
    FLD_RF_KDCO_CAL_DEV_DTC        =   BIT(2),
    FLD_RF_KDCO_CAL_UPDATE_IC      =   BIT(3),
};

#define    reg_rf_kdtc_cal0         REG_ADDR8(CSEMADPLLADDR+0x04c)
enum{
