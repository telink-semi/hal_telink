...
/*******************************      uart2 registers: 0x240080      ******************************/
/*******************************      uart3 registers: 0x2400c0      ******************************/
#define uart_base_addr(i)   (((i)<2) ? (0x140080+(i)*0x40):(0x240080+((i)-2)*0x40)) //uart(i)

#define reg_uart_data_buf(i,j)    REG_ADDR8(uart_base_addr(i)+(j)) //uart(i)_buf(j)
#define reg_uart_data_hword_buf(i,j)  REG_ADDR16(uart_base_addr(i)+(j)*2)

#define reg_uart_data_word_buf(i)  REG_ADDR32(uart_base_addr(i)) //uart(i)
