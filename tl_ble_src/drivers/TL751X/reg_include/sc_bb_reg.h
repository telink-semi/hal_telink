 ...
 *            |           Address         |   Size   
 * --------------------------------------------------
 * N22  | ILM |  0x82100000 ~ 0x82100000  |  96 KB 
 *      | DLM |  0x82000000 ~ 0x82000000  |  32 KB 
 * --------------------------------------------------
 */
#define N22_ILM_BASE                    (0x50068000)
...
#define reg_n22_ilm_crc_ctrl            REG_ADDR8(SC_DSP_BASE_ADDR + 0x24)
enum{
    FLD_N22_ILM_CRC_SIZE        =   BIT_RNG(0, 6),
    FLD_N22_CRC_ILM_BUSY        =   BIT(7),
};

#define reg_n22_ilm_crc_trig            REG_ADDR8(SC_DSP_BASE_ADDR + 0x25)
enum{
    FLD_N22_CRC_TRIG_ILM        =   BIT(0),
};
