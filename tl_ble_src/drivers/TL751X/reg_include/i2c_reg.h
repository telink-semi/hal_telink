 ...
 * BIT[2] Indicates the status of master send and receive,bit[2]=1,means have not ability to send or receive bit[2]=0,means have ability to send or receive.
 ...
 * BIT[4] If enable rx_done interrupted on the master, it needs to be set to 1 under no_dma,
 ...
 * BIT[6] the stretch interrupt status. Write 1 to clear zero.
 */
...
/*******************************      i2c1_m registers: 0x240040     ******************************/

#define     REG_I2C1_M_BASE         0x240040
