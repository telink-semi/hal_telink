...
#define reg_mspi_xip_core_start(i)      REG_ADDR16(MSPI_BASE_ADDR+0xc0+8*i)

#define reg_mspi_xip_core_size(i)       REG_ADDR16(MSPI_BASE_ADDR+0xc2+8*i)

#define reg_mspi_xip_core_offset(i)     REG_ADDR16(MSPI_BASE_ADDR+0xc4+8*i)
