...
#define reg_gpio_pa_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xc0)
#define reg_gpio_pa0_fs             REG_ADDR8(GPIO_BASE_ADDR+0xc0)
#define reg_gpio_pa1_fs             REG_ADDR8(GPIO_BASE_ADDR+0xc1)
#define reg_gpio_pa2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xc2)
...
#define reg_gpio_pb_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xc8)
#define reg_gpio_pb0_fs             REG_ADDR8(GPIO_BASE_ADDR+0xc8)
#define reg_gpio_pb1_fs             REG_ADDR8(GPIO_BASE_ADDR+0xc9)
#define reg_gpio_pb2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xca)
#define reg_gpio_pb3_fs             REG_ADDR8(GPIO_BASE_ADDR+0xcb)
#define reg_gpio_pb_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0xcc)
#define reg_gpio_pb4_fs             REG_ADDR8(GPIO_BASE_ADDR+0xcc)
#define reg_gpio_pb5_fs             REG_ADDR8(GPIO_BASE_ADDR+0xcd)
#define reg_gpio_pb6_fs             REG_ADDR8(GPIO_BASE_ADDR+0xce)
#define reg_gpio_pb7_fs             REG_ADDR8(GPIO_BASE_ADDR+0xcf)
...
#define reg_gpio_pc_pd              REG_ADDR8(GPIO_BASE_ADDR+0x2a)
...
#define reg_gpio_pc_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xd0)
#define reg_gpio_pc0_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd0)
#define reg_gpio_pc1_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd1)
#define reg_gpio_pc2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd2)
#define reg_gpio_pc3_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd3)
#define reg_gpio_pc_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0xd4)
#define reg_gpio_pc4_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd4)
#define reg_gpio_pc5_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd5)
#define reg_gpio_pc6_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd6)
#define reg_gpio_pc7_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd7)
...
#define reg_gpio_pd_pd              REG_ADDR8(GPIO_BASE_ADDR+0x3a)
...
#define reg_gpio_pd_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xd8)
#define reg_gpio_pd0_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd8)
#define reg_gpio_pd1_fs             REG_ADDR8(GPIO_BASE_ADDR+0xd9)
#define reg_gpio_pd2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xda)
#define reg_gpio_pd3_fs             REG_ADDR8(GPIO_BASE_ADDR+0xdb)
#define reg_gpio_pd_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0xdc)
#define reg_gpio_pd4_fs             REG_ADDR8(GPIO_BASE_ADDR+0xdc)
#define reg_gpio_pd5_fs             REG_ADDR8(GPIO_BASE_ADDR+0xdd)
#define reg_gpio_pd6_fs             REG_ADDR8(GPIO_BASE_ADDR+0xde)
#define reg_gpio_pd7_fs             REG_ADDR8(GPIO_BASE_ADDR+0xdf)
...
#define reg_gpio_pf_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xe8)
#define reg_gpio_pf2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xea)
#define reg_gpio_pf3_fs             REG_ADDR8(GPIO_BASE_ADDR+0xeb)
#define reg_gpio_pf_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0xec)
#define reg_gpio_pf4_fs             REG_ADDR8(GPIO_BASE_ADDR+0xec)
#define reg_gpio_pf5_fs             REG_ADDR8(GPIO_BASE_ADDR+0xed)
#define reg_gpio_pf6_fs             REG_ADDR8(GPIO_BASE_ADDR+0xee)
#define reg_gpio_pf7_fs             REG_ADDR8(GPIO_BASE_ADDR+0xef)
...
#define reg_gpio_ph_irq_en          REG_ADDR8(GPIO_BASE_ADDR+0x77)
#define reg_gpio_ph_setting3        REG_ADDR32(GPIO_BASE_ADDR+0x78)
#define reg_gpio_ph_irq_risc0_en    REG_ADDR8(GPIO_BASE_ADDR+0x78)
#define reg_gpio_ph_irq_risc1_en    REG_ADDR8(GPIO_BASE_ADDR+0x79)
#define reg_gpio_ph_pd              REG_ADDR8(GPIO_BASE_ADDR+0x7a)
#define reg_gpio_ph_pu              REG_ADDR8(GPIO_BASE_ADDR+0x7b)
#define reg_gpio_ph_setting4        REG_ADDR32(GPIO_BASE_ADDR+0x7c)
...
#define reg_gpio_ph_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xf8)
#define reg_gpio_ph2_fs             REG_ADDR8(GPIO_BASE_ADDR+0xfa)
#define reg_gpio_ph3_fs             REG_ADDR8(GPIO_BASE_ADDR+0xfb)
#define reg_gpio_ph_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0xfc)
#define reg_gpio_ph4_fs             REG_ADDR8(GPIO_BASE_ADDR+0xfc)
#define reg_gpio_ph5_fs             REG_ADDR8(GPIO_BASE_ADDR+0xfd)
#define reg_gpio_ph6_fs             REG_ADDR8(GPIO_BASE_ADDR+0xfe)
...
#define reg_gpio_pi_setting4        REG_ADDR32(GPIO_BASE_ADDR+0x8c)
...
#define reg_gpio_pj_setting1        REG_ADDR32(GPIO_BASE_ADDR+0x90)
#define reg_gpio_pj_in              REG_ADDR8(GPIO_BASE_ADDR+0x90)
#define reg_gpio_pj_ie              REG_ADDR8(GPIO_BASE_ADDR+0x91)
#define reg_gpio_pj_oen             REG_ADDR8(GPIO_BASE_ADDR+0x92)
#define reg_gpio_pj_setting2        REG_ADDR32(GPIO_BASE_ADDR+0x94)
#define reg_gpio_pj_ds              REG_ADDR8(GPIO_BASE_ADDR+0x95)
#define reg_gpio_pj_gpio            REG_ADDR8(GPIO_BASE_ADDR+0x96)
#define reg_gpio_pj_setting3        REG_ADDR32(GPIO_BASE_ADDR+0x98)
#define reg_gpio_pj_pd              REG_ADDR8(GPIO_BASE_ADDR+0x9a)
#define reg_gpio_pj_pu              REG_ADDR8(GPIO_BASE_ADDR+0x9b)
#define reg_gpio_pj_setting4        REG_ADDR32(GPIO_BASE_ADDR+0x9c)
#define reg_gpio_pj_out_set         REG_ADDR8(GPIO_BASE_ADDR+0x9c)
#define reg_gpio_pj_out_clear       REG_ADDR8(GPIO_BASE_ADDR+0x9d)
#define reg_gpio_pj_out_toggle      REG_ADDR8(GPIO_BASE_ADDR+0x9e)
#define reg_gpio_pj_fs_l            REG_ADDR32(GPIO_BASE_ADDR+0xfe)
#define reg_gpio_pj2_fs             REG_ADDR8(GPIO_BASE_ADDR+0x100)
#define reg_gpio_pj3_fs             REG_ADDR8(GPIO_BASE_ADDR+0x101)
#define reg_gpio_pj_fs_h            REG_ADDR32(GPIO_BASE_ADDR+0x102)
#define reg_gpio_pj4_fs             REG_ADDR8(GPIO_BASE_ADDR+0x102)
...
#define reg_gpio_func_mux(i)        REG_ADDR8(GPIO_BASE_ADDR+0xc0+((i>>8)<<3) + BIT_LOW_BIT(i))
#define reg_gpio_irq_ctrl           REG_ADDR8(GPIO_BASE_ADDR+0x112)
enum{
...
#define reg_gpio_irq_clr           REG_ADDR8(GPIO_BASE_ADDR+0x118)  // W1C
#define reg_gpio_irq_level         REG_ADDR8(GPIO_BASE_ADDR+0x114)
#define reg_gpio_irq_sel           REG_ADDR8(GPIO_BASE_ADDR+0x115)
#define reg_gpio_irq_src_mask      REG_ADDR8(GPIO_BASE_ADDR+0x116)
#define reg_gpio_irq_src           REG_ADDR8(GPIO_BASE_ADDR+0x119)  // W1C
