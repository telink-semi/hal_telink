...
enum
{
    ...
    FLD_EP_DAT_BUSY                 = BIT(0), /* read only */
...
enum
{
    ...
    FLD_USB_CTRL_TEST_MODE          = BIT(3),
    FLD_USB_CTRL_CLK_SEL            = BIT_RNG(4,7),
};

#define reg_usb_cycl_cali           REG_ADDR8(REG_USB_BASE + 0x06)
#define reg_usb_cych_cali           REG_ADDR8(REG_USB_BASE + 0x07)

#define reg_usb_ctrl_udc_cnt        REG_ADDR8(REG_USB_BASE + 0x08)
...
enum
{
    ...
    FLD_USB_MDEV_MODE_SEL           = BIT_RNG(5, 6),
};
...
#define reg_usb_edps_map(i)         REG_ADDR8(REG_USB_BASE + 0x4a + (((i)&0x07) >> 1))
...
#define reg_usb_edp_eptr            REG_ADDR16(REG_USB_BASE + 0x54)
