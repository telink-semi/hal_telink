 ...
 * @param[in]   digest --------------------- output, sha512_256 digest, 32 bytes
 ...
 * @param[in]   msg_words   - byte length of the input message, must be a multiple of sha512_256
 ...
 * @param[in]   node              - input, message node pointer
 * @param[in]   node_num          - input, number of hash nodes, i.e. number of message segments.
 * @param[out]   digest            - output, sha512_256 digest, 32 bytes
 * @param[in]   callback          - callback function pointer
 * @return      0:success     other:error
 * @note
  @verbatim
