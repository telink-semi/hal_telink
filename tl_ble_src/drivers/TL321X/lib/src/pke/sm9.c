...
unsigned int sm9p256v1_p_n0[1] = {0x2F2EE42Bu,};
#endif
...
#if (defined(PKE_LP) || defined(PKE_SECURE))
unsigned int sm9p256v1_n_n0[1] = {0x51974B53u,};
#endif
...
static unsigned int sm9_h1_h2(unsigned char tag, unsigned char *z1, unsigned int z1ByteLen, unsigned char *z2, unsigned int z2ByteLen,
        unsigned int h[8])
{
    unsigned int ret;
...
static unsigned int line2(mpc_t Tx, mpc_t Ty, mpc_t Tz, mpc_t Q1x, mpc_t Q1y, mpc_t P1x, mpc_t P1y,
        mpc_t Gz, mpc12_t ret)
{
    mpc_t A,B,C,D,G;
    (void)Tx;
...
static unsigned int to_p(mpc12_t f, mpc12_t g)
{
    ...
    unsigned int k1_re[8] = {0x377b698bu,0xa91d8354u,0x0ddd04edu,0x47c5c86eu,0x9c086749u,0x843c6cfau,0xe5720bdbu,0x3f23ea58u,};
    unsigned int k2_re[8] = {0x7be65334u,0xd5fc1196u,0x4f8b78f4u,0x78027235u,0x02a3a6f2u,0xf3000000u,0x00000000u,0x00000000u,};
    unsigned int k3_re[8] = {0xda24d011u,0xf5b21fd3u,0x06dc5177u,0x9f9d4118u,0xee0baf15u,0xf55acc93u,0xdc0a3f2cu,0x6c648de5u,};
    unsigned int k4_re[8] = {0x7be65333u,0xd5fc1196u,0x4f8b78f4u,0x78027235u,0x02a3a6f2u,0xf3000000u,0x00000000u,0x00000000u,};
    unsigned int k5_re[8] = {0xa2a96686u,0x4c949c7fu,0xf8ff4c8au,0x57d778a9u,0x520347ccu,0x711e5f99u,0xf6983351u,0x2d40a38cu,};
...
static unsigned int to_p2(mpc12_t f, mpc12_t g)
{
    ...
    unsigned int g1_re[8] = {0x7be65334u,0xd5fc1196u,0x4f8b78f4u,0x78027235u,0x02a3a6f2u,0xf3000000u,0x00000000u,0x00000000u,};
    unsigned int g2_re[8] = {0x7be65333u,0xd5fc1196u,0x4f8b78f4u,0x78027235u,0x02a3a6f2u,0xf3000000u,0x00000000u,0x00000000u,};
    unsigned int g3_re[8] = {0xe351457cu,0xe56f9b27u,0x1a7aeedbu,0x21f2934bu,0xf58ec745u,0xd603ab4fu,0x02a3a6f1u,0xb6400000u,};
    unsigned int g4_re[8] = {0x676af249u,0x0f738991u,0xcaef75e7u,0xa9f02115u,0xf2eb2052u,0xe303ab4fu,0x02a3a6f0u,0xb6400000u,};
    unsigned int g5_re[8] = {0x676af24au,0x0f738991u,0xcaef75e7u,0xa9f02115u,0xf2eb2052u,0xe303ab4fu,0x02a3a6f0u,0xb6400000u,};
...
static unsigned int to_p3(mpc12_t f, mpc12_t g)
{
    ...
    unsigned int e1_re[8] = {0xda24d011u,0xf5b21fd3u,0x06dc5177u,0x9f9d4118u,0xee0baf15u,0xf55acc93u,0xdc0a3f2cu,0x6c648de5u,};
    unsigned int e2_re[8] = {0xe351457cu,0xe56f9b27u,0x1a7aeedbu,0x21f2934bu,0xf58ec745u,0xd603ab4fu,0x02a3a6f1u,0xb6400000u,};
    unsigned int e3_re[8] = {0x092c756cu,0xefbd7b54u,0x139e9d63u,0x82555233u,0x0783182fu,0xe0a8debcu,0x269967c4u,0x49db721au,};
//    unsigned int e4_re[8] = {0x00000001u,0x00000000u,0x00000000u,0x00000000u,0x00000000u,0x00000000u,0x00000000u,0x00000000u,};
    unsigned int e5_re[8] = {0xda24d011u,0xf5b21fd3u,0x06dc5177u,0x9f9d4118u,0xee0baf15u,0xf55acc93u,0xdc0a3f2cu,0x6c648de5u,};
...
static unsigned int FrobeniusTwist(mpc_t Qx, mpc_t Qy, mpc_t Fx, mpc_t Fy)
{
    ...
    unsigned int scal1_re[8] = {0x676af24au,0x0f738991u,0xcaef75e7u,0xa9f02115u,0xf2eb2052u,0xe303ab4fu,0x02a3a6f0u,0xb6400000u,};
    unsigned int scal2_re[8] = {0x092c756cu,0xefbd7b54u,0x139e9d63u,0x82555233u,0x0783182fu,0xe0a8debcu,0x269967c4u,0x49db721au,};
...
unsigned int G2_pointMul_P2(unsigned int *k, unsigned int kWordLen, fp2_pt_t Q)
{
    ...
    (void)kWordLen;
    mpc_t P2_128_0_x = {{
        {0x86A0CE83u,0x4097DCBEu,0x60E1905Au,0xB378A947u,0xADF23461u,0xB7575B5Eu,0x334B6E71u,0x88A171A9u,},
        {0x3E962271u,0xD57FB53Fu,0xB12DB59Eu,0xA74ECCA2u,0xBEB3576Bu,0xBDC7B660u,0x3A6718D2u,0x7F4C4508u,},
    }};
    mpc_t P2_128_0_y = {{
        {0xB9DF876Au,0x9CC9FA50u,0xEADCF3CBu,0x484CBEA3u,0x306037B3u,0x66A8C5B9u,0x9DCB6CC8u,0x6D608E8Cu,},
        {0xB5FD529Eu,0xCE057F21u,0x200BFB50u,0xF255C11Du,0xB223D50Du,0x438A7EC5u,0x8578A96Cu,0x05DA221Fu,},
    }};
    mpc_t P2_128_1_x = {{
        {0x3215316Fu,0xC9BED5B9u,0x788D026Eu,0xF3F032C0u,0x4B9940C5u,0x8822B60Cu,0x7B0047ABu,0x4CC71ABBu,},
        {0xC14B65ADu,0xA43D5932u,0xABB1AEA9u,0xF5205B30u,0x8584A5FBu,0xD377F24Eu,0x6ACEAD8Au,0xA383210Cu,},
    }};
    mpc_t P2_128_1_y = {{
        {0xA59303BFu,0xC6DE9F05u,0xF6A85E3Au,0x745EC2CCu,0x057BB605u,0x0065ED3Eu,0x063A10D2u,0x3BCA62E6u,},
        {0xB0E4C4A0u,0xB9C7CDD8u,0x96AF7A35u,0x0C18C5EFu,0xB931F333u,0xA32FBFB6u,0xC33E5F4Du,0x78060342u,},
    }};
...
static unsigned int sm9_sign_with_r(unsigned char *fp12g, __mpc12_struct *g, unsigned int *r, unsigned char *msg,
        unsigned int msg_bytes, unsigned int tmp[8], unsigned char h[32])
{
...
unsigned int sm9_wrap_key_with_r(unsigned char *IDB, unsigned int IDB_bytes, unsigned int *QBx, unsigned int *QBy,
        unsigned char *fp12g, __mpc12_struct *g, unsigned int *r, unsigned char C[64], unsigned int k_bytes,
        unsigned char *k)
{
...
unsigned int sm9_enc_with_r(HASH_NODE *hash_node, unsigned char *IDB, unsigned int IDB_bytes, unsigned int *r,
        unsigned int *QBx, unsigned int *QBy, unsigned char *fp12g, __mpc12_struct *g, unsigned char *C1,
...
/*#if (defined(SUPPORT_HASH_SHA3_224) || defined(SUPPORT_HASH_SHA3_256) || defined(SUPPORT_HASH_SHA3_384) || \
    ...
    if(NULL == r)
    {
        do {
            ...
            ret = sm9_enc_with_r(hash_node, IDB, IDB_bytes, tmp_r, Ax, Ay, fp12g, g,
    ...
    *C_bytes = M_bytes;
    ...
    {
#if defined(SKE_HP)
        ret = ske_hp_crypto(SKE_ALG_SM4, SKE_MODE_ECB, SKE_CRYPTO_ENCRYPT, C2, 0, NULL,
                padding_type, M, C2, M_bytes, C_bytes);
#elif defined(SKE_LP)
        ret = ske_lp_crypto(SKE_ALG_SM4, SKE_MODE_ECB, SKE_CRYPTO_ENCRYPT, C2, 0, NULL,
                padding_type, (unsigned char *)M, C2, M_bytes, C_bytes);
...
#if defined(SKE_HP)
        ret = ske_hp_crypto(SKE_ALG_SM4, SKE_MODE_ECB, SKE_CRYPTO_DECRYPT, K1, 0, NULL,
                padding_type, C2, M, C2_bytes, M_bytes);
#elif defined(SKE_LP)
        ret = ske_lp_crypto(SKE_ALG_SM4, SKE_MODE_ECB, SKE_CRYPTO_DECRYPT, K1, 0, NULL,
                padding_type, C2, M, C2_bytes, M_bytes);
#elif defined(SKE_SECURE)
        ret = ske_sec_crypto(SKE_ALG_SM4, SKE_MODE_ECB, SKE_CRYPTO_DECRYPT, K1, 0, NULL,
                padding_type, C2, M, C2_bytes, M_bytes);
#else
        ret = SM9_INPUT_INVALID;
#endif
