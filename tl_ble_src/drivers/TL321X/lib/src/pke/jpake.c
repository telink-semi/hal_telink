 ...
 * @return      0:success     other:error
 */
extern unsigned int jpake_get_rand_xa_less_than_q(unsigned int *q, unsigned int *xa, unsigned int wordLen, unsigned int remainder_bits,
 ...
 * @note
  ...
  @endverbatim
 */
unsigned int jpake_get_zkp_c(JPAKE_PARA *jpake_para, unsigned int *g, unsigned int *V, unsigned int *A,
        unsigned char *ID, unsigned int ID_bytes, unsigned char *other_info, unsigned int other_info_bytes, unsigned int *c)
{
...
unsigned int jpake_get_xa_xb_gxa_gxb(JPAKE_PARA *jpake_para, unsigned int *xa, unsigned int *xb, unsigned int *gxa, unsigned int *gxb)
{
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)xa, ( unsigned int *)jpake_para->g, gxa,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)xb, ( unsigned int *)jpake_para->g, gxb,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
 ...
 * @note
  ...
  @endverbatim
 */
unsigned int jpake_generate_zkp_internal(JPAKE_PARA *jpake_para, JPAKE_USER_INFO *zkp_owner_info, unsigned int *c, unsigned int *a,
        unsigned int *v, unsigned int *g, JPAKE_ZKP *zkp)
{
    ...
    if((NULL != zkp_owner_info) && (NULL == c))
    {
        ...
        c = c_buf;
        ret = jpake_get_zkp_c(jpake_para, g, zkp->gv, zkp->ga, zkp_owner_info->ID, zkp_owner_info->ID_bytes,
                zkp_owner_info->other_info, zkp_owner_info->other_info_bytes, c);
 ...
 * @note
  ...
  @endverbatim
 */
unsigned int jpake_generate_zkp(JPAKE_PARA *jpake_para, JPAKE_USER_INFO *zkp_owner_info, unsigned int *a, unsigned int *g,
        JPAKE_ZKP *zkp)
{
 ...
 * @note
  ...
  @endverbatim
 */
unsigned int jpake_verify_zkp_internal(JPAKE_PARA *jpake_para, JPAKE_USER_INFO *zkp_owner_info, unsigned int *c, unsigned int *g,
        JPAKE_ZKP *zkp)
{
    unsigned int t[JPAKE_MAX_WORD_LEN];
    unsigned int c_buf[JPAKE_MAX_WORD_LEN];
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)jpake_para->q, ( unsigned int *)zkp->ga, t,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
    ...
    {
        //t = ga^c mod p
        ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)c, ( unsigned int *)zkp->ga, t,
                pWordLen, qWordLen);
        if(PKE_SUCCESS != ret)
        {
            goto END;
    ...
    {
        //t = g^r mod p
        ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)zkp->r, ( unsigned int *)g, t,
                pWordLen, qWordLen);
        if(PKE_SUCCESS != ret)
        {
            goto END;
    ...
    else
    {
        ...
        //c = ga^c mod p
        ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)c, ( unsigned int *)zkp->ga, c,
                pWordLen, qWordLen);
        if(PKE_SUCCESS != ret)
        {
            goto END;
        ...
        unsigned int *xb, unsigned int *gxa, unsigned int *gxc, unsigned int *gxd, unsigned int *s, unsigned int sWordLen, JPAKE_ZKP *local_zkp_xb_s)
{
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)round2_ctx->xb_s, ( unsigned int *)g, local_zkp_xb_s->ga,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
        ...
        JPAKE_ROUND2_CTX *round2_ctx, unsigned int *xb, unsigned int *gxb, unsigned int *gxd, JPAKE_ZKP *peer_zkp_xb_s, unsigned int *key)
{
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)t, ( unsigned int *)gxd, t,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
    ...
    ret = pke_modexp(( unsigned int *)jpake_para->p, ( unsigned int *)xb, ( unsigned int *)t, key,
            pWordLen, qWordLen);
    if(PKE_SUCCESS != ret)
    {
        goto END;
