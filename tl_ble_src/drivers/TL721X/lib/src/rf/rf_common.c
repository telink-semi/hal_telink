 ...
 */
_attribute_data_retention_ volatile     //BLE SDK use: to put into RAM
 rf_power_level_e rf_power_Level_list[70] =
{
#if RF_TX_POWER_A2
    /*VBAT*/
 ...
 *  @return     none
*/
_attribute_ram_code_com_sec_noinline_ static void rf_set_hpmc_cal_val(unsigned short hpmc_gain)
{
...
*/
_attribute_ram_code_com_sec_noinline_ static unsigned short rf_get_hpmc_cal_val(void)
{
    unsigned short cali;
...
*/
_attribute_ram_code_com_sec_noinline_ static unsigned char rf_get_fcal_cal_val(void)
{
 ...
 */
_attribute_ram_code_com_sec_noinline_ void rf_clr_dig_logic_state(void) //BLE SDK use, require RAM code
{
 ...
 */
_attribute_ram_code_com_sec_noinline_ void rf_reset_register_value(void)
{
