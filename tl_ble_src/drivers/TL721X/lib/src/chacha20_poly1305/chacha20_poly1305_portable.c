/********************************************************************************************************
 * @file    chacha20_poly1305_portable.c
 *
...
static dma_chn_e chacha20_poly1305_tx_dma_channel;
static dma_chn_e chacha20_poly1305_rx_dma_channel;
...
{
    return chacha20_poly1305_tx_dma_channel;
}
...
{
    return chacha20_poly1305_rx_dma_channel;
}
...
{
    chacha20_poly1305_tx_dma_channel = chn;
}
...
{
    chacha20_poly1305_rx_dma_channel = chn;
}

/* Initialization configuration of chacha20_poly1305 tx dma channel */
static dma_config_t chacha20_poly1305_tx_dma_config = {
    .dst_req_sel    = DMA_REQ_CHACHA_TX,
    .src_req_sel    = 0,
...
/* Initialization configuration of chacha20_poly1305 rx dma channel */
static dma_config_t chacha20_poly1305_rx_dma_config = {
    .dst_req_sel    = 0,
    .src_req_sel    = DMA_REQ_CHACHA_RX, // rx req
...
/**
 * @brief Sets the burst size for chacha20_poly1305 tx DMA transfers.
 ...
 * @return      none
 */
static void chacha20_poly1305_set_tx_burst_size(void)
{
    /*(1-1 word,2-2 word,4-4 word,8-8 word)*/
    reg_chacha20_thres = (reg_chacha20_thres & (~BIT_RNG(0, 3))) | (1 << DMA_BURST_1_WORD);
}

/**
 * @brief Sets the burst size for chacha20_poly1305 rx DMA transfers.
 * @param[in]   burst_size - The burst size to be set.
 * @return      none
 */
static void chacha20_poly1305_set_rx_burst_size(dma_burst_size_e burst_size)
{
    /*(1-1 word,2-2 word,4-4 word,8-8 word)*/
    reg_chacha20_thres = (reg_chacha20_thres & (~BIT_RNG(4, 7))) | ((1 << burst_size) << 4);
}
...
void chacha20_poly1305_tx_dma(dma_chn_e chn, unsigned int buf_addr, unsigned int len)
{
    ...
    reg_dma_dst_addr(chn) = reg_chacha20_fifo;
...
{
    reg_dma_src_addr(chn) = reg_chacha20_fifo;
...
{
    dma_config(tx_chn, &chacha20_poly1305_tx_dma_config);
    chacha20_poly1305_set_tx_burst_size();
    chacha20_poly1305_set_tx_dma_channel(tx_chn);
    reg_chacha20_dma_en |= 0x01;
}
...
{
    chacha20_poly1305_tx_dma_config.src_burst_size = burst_size;
    dma_config(rx_chn, &chacha20_poly1305_rx_dma_config);
    reg_dma_src_addr(rx_chn) = reg_chacha20_fifo;
    chacha20_poly1305_set_rx_burst_size(burst_size);
    chacha20_poly1305_set_rx_dma_channel(rx_chn);
    reg_chacha20_dma_en |= 0x02;
}
#endif
