 ...
 *                   g_xxx_error_timeout_code, and the interface xxx_get_error_timeout_code(refer to aes);
 */
_attribute_ram_code_com_sec_noinline_ unsigned int wait_condition_fails_or_timeout_with_param(condition_fp_with_param condition,unsigned int cdt_param,unsigned int timeout_us,timeout_handler_fp func,unsigned int  err_code){
         unsigned long long start = rdmcycle();
