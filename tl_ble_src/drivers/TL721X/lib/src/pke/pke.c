 ...
 * @note
  ...
  @endverbatim
 */
void pke_set_operand_uint32_value(unsigned int *a, unsigned int aWordLen, unsigned int b)
{
 ...
 * @return     none
 */
static void pke_read_operand(volatile unsigned int *baseaddr, volatile unsigned int *data, unsigned int wordLen)
{
    unsigned int i;
