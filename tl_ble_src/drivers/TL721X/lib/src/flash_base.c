 ...
 * @note        _always_inline:the function is inlined to ensure security.
 */
_attribute_ram_code_com_sec_ _always_inline void flash_reg_access_protect(void)
{
 ...
 * @note        _always_inline:the function is inlined to ensure security.
 */
_attribute_ram_code_com_sec_ _always_inline void flash_reg_access_restore(void)
{
    CLOCK_DLY_5_CYC;
    mspi_set_xip_en();
 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_optimize_o2_noinline_ void flash_send_cmd(unsigned long addr, unsigned int cmd)
{
 ...
 */
_attribute_ram_code_com_sec_ static _always_inline unsigned char flash_is_busy(unsigned long addr,unsigned int cmd)
{
 ...
 * @return    none.
 */
_attribute_ram_code_com_sec_noinline_ static void flash_wait_done(unsigned long addr,unsigned int cmd)
{
    int i;
 ...
 */
_attribute_ram_code_com_sec_ _always_inline void flash_mspi_wr_ram(unsigned int cmd,unsigned long addr, unsigned char *data,unsigned long data_len,unsigned char is_encrypt,mspi_func_e mspi_wr,unsigned int w_en_cmd,unsigned int busy_cmd)
{
 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_noinline_ void flash_mspi_read_ram(unsigned int cmd, unsigned long addr, unsigned char *data, unsigned long data_len)
{
 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_noinline_ void flash_mspi_write_ram(unsigned int cmd,unsigned long addr, unsigned char *data, unsigned long data_len,unsigned int w_en_cmd,unsigned int busy_cmd)
{
    flash_reg_access_protect();
 ...
 * @return      none.
 */
_attribute_ram_code_com_sec_noinline_ void flash_mspi_write_encrypt_ram(unsigned int cmd,unsigned long addr, unsigned char *data, unsigned long data_len,unsigned int w_en_cmd,unsigned int busy_cmd)
{
    flash_reg_access_protect();
 ...
 */
_attribute_ram_code_com_sec_noinline_ unsigned char flash_mspi_read_decrypt_check_ram(unsigned int cmd,unsigned long addr, unsigned char *data,unsigned long data_len )
{
 ...
 * @return none
 */
_attribute_ram_code_com_sec_noinline_ void flash_set_rd_xip_config_sram(mspi_slave_device_num_e device_num, unsigned int config)
{
    flash_reg_access_protect();
 ...
 * @return none
 */
_attribute_ram_code_com_sec_noinline_ void flash_set_wr_xip_config_sram(mspi_slave_device_num_e device_num, flash_wr_xip_config_t config)
{
    flash_reg_access_protect();
