 ...
 */
_attribute_ram_code_com_sec_ void flash_reg_access_protect(void);
 ...
 * @note        _always_inline:the function is inlined to ensure security.
 */
_attribute_ram_code_com_sec_ void flash_reg_access_restore(void);
 ...
 */
_attribute_ram_code_com_sec_ void flash_mspi_wr_ram(unsigned int cmd,unsigned long addr, unsigned char *data,unsigned long data_len,unsigned char is_encrypt,mspi_func_e mspi_wr,unsigned int w_en_cmd,unsigned int busy_cmd);
