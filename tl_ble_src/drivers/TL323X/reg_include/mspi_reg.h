...
#define reg_mspi_xip_rd_config REG_ADDR32(MSPI_BASE_ADDR + 0x90 )
...
#define reg_mspi_xip_rd_ctrl0 REG_ADDR8(MSPI_BASE_ADDR + 0x92)
...
#define reg_mspi_xip_rd_cmd    REG_ADDR8(MSPI_BASE_ADDR + 0x93)

#define reg_mspi_xip_wr_config REG_ADDR32(MSPI_BASE_ADDR + 0x94)
#define reg_mspi_xip_wr_fmt    REG_ADDR8(MSPI_BASE_ADDR + 0x94)
...
#define reg_mspi_xip_wr_transmode REG_ADDR8(MSPI_BASE_ADDR + 0x95)
...
#define reg_mspi_xip_wr_ctrl0 REG_ADDR8(MSPI_BASE_ADDR + 0x96)
...
#define reg_mspi_xip_wr_cmd REG_ADDR8(MSPI_BASE_ADDR + 0x97)
...
#define reg_mspi_xip_rd_cmd1  REG_ADDR8(MSPI_BASE_ADDR + 0xb4)

#define reg_mspi_xip_wr_cmd1 REG_ADDR8(MSPI_BASE_ADDR + 0xb5)
