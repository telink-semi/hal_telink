...
typedef enum
{
    FLD_SYSTEM_IRQ_32K_CAL_MASK  = BIT(0), /**<
                                          ...
                                          */
    FLD_SYSTEM_CAPT_IRQ_MASK     = BIT(1), /**<
                                            ...
                                            If you do not trigger an interrupt and only polling can detect the state, this mask also needs to be turned on.
                                          */
    FLD_SYSTEM_OVERFLOW_IRQ_MASK = BIT(2), /**<
...
#define reg_system_timer_ctrl1 REG_ADDR8(STIMER_BASE_ADDR + 0x19)
...
#define reg_system_timer_ctrl2 REG_ADDR8(STIMER_BASE_ADDR + 0x1a)

enum
{
    FLD_SYSTEM_IRQ_WAIT          = BIT(0),
    FLD_SYSTEM_TRIG_PAST_EN      = BIT(4),
};
