...
_attribute_aligned_(4) _attribute_data_retention_sec_ pm_status_info_s g_pm_status_info;
#else
...
_attribute_data_retention_sec_  unsigned char                     g_pm_pad_filter_en=0x00;//FLD_PAD_FILTER_EN //ble use in ext_pm_32k_rc.c ,needn't add static
...
extern _attribute_ram_code_sec_optimize_o2_noinline_ void flash_send_cmd(unsigned int cmd);
 ...
 * @return      none.
 */
_attribute_ram_code_sec_optimize_o2_noinline_ void pm_sleep_start(pm_sleep_mode_e sleep_mode) //BLE not use static
{
#if (PM_DEBUG)
    /******************************************debug_pm_info**********************************************/
    debug_pm_info = 0x20;
    ...
    //only tl721x need, not a public config, jira:TER-43
...
_attribute_ram_code_sec_optimize_o2_noinline_ void pm_set_dig_module_power_switch(pm_pd_module_e module, pm_power_sel_e power_sel)
{
    ...
    */
    ...
    /*
     * Wait for power stable, for this chip(tl721x), it will cost 5 * 1/24M times.
...
#define CORE_SRAM_BB_MAX_CONFIG_NUM 3
...
const dvdd_config_t dvdd_config[CORE_SRAM_BB_MAX_CONFIG_NUM] __attribute__((section(".flash_data"))) =
    {
        ...
        {
         .vol                           = {0x0e, ((ALG0X0E_DEFAULT_CONFIG & 0x88) | (CORE_0P8V_SRAM_0P8V_BB_0P8V_CONFIG & 0xff) | SPD_LDO_TRIM_0P75V), 0x0f, (ALG0X0F_DEFAULT_CONFIG & 0x08) | ((CORE_0P8V_SRAM_0P8V_BB_0P8V_CONFIG & 0xff00) >> 4) | RET_LDO_TRIM_0P75V},
        ...
        {
         .vol                           = {0x0e, ((ALG0X0E_DEFAULT_CONFIG & 0x88) | (CORE_0P9V_SRAM_0P9V_BB_0P9V_CONFIG & 0xff) | SPD_LDO_TRIM_0P75V), 0x0f, (ALG0X0F_DEFAULT_CONFIG & 0x08) | ((CORE_0P9V_SRAM_0P9V_BB_0P9V_CONFIG & 0xff00) >> 4) | RET_LDO_TRIM_0P75V},
...
_attribute_data_retention_sec_ pm_power_cfg_e g_dvdd_vol = CORE_0P8V_SRAM_0P8V_BB_0P8V;
...
drv_api_status_e pm_set_dvdd(pm_power_cfg_e vol, dma_chn_e chn, unsigned int dma_timeout_us)
{
    ...
    */
    ...
    //readout spd ldo and ret ldo configuration
    unsigned char spd_ldo = pm_get_spd_ldo_voltage();
    unsigned char ret_ldo = pm_get_ret_ldo_voltage();
    ...
    //recovery spd ldo and ret ldo configuration
    pm_set_spd_ldo_voltage(spd_ldo);
    pm_set_ret_ldo_voltage(ret_ldo);
    ...
    */
    ...
    /*
     * analog_0x35<1>:
     * 0 : CORE_0P9V_SRAM_0P9V_BB_0P9V
     * 1 : CORE_0P8V_SRAM_0P8V_BB_0P8V
     */
    analog_write_reg8(PM_ANA_REG_WD_CLR_BUF0, (analog_read_reg8(PM_ANA_REG_WD_CLR_BUF0) & ~BIT(1)) | ((g_dvdd_vol & 0x01) << 1));
