...
{
    return hmac(HASH_SHA512_256, key, sp_key_idx, key_bytes, msg, msg_len, mac);
}
...
{
    return hmac_dma(HASH_SHA512_256, key, sp_key_idx, key_bytes, msg, msg_len, mac, callback);
}
