...
{
    flash_reg_access_protect();
    reg_mspi_xip_rd_config = (*(unsigned int *)(&config));
    reg_mspi_xip_rd_cmd1   = (*(unsigned int *)(&config)) >> 24;
    flash_reg_access_restore();
}
...
{
    flash_reg_access_protect();
    reg_mspi_xip_wr_config = (*(unsigned int *)(&config));
    reg_mspi_xip_wr_cmd1   = (*(unsigned int *)(&config)) >> 24;
    flash_reg_access_restore();
}
