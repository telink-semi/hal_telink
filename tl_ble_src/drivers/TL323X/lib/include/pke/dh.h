...
#define DH_INTEGER_TOO_BIG (PKE_SUCCESS + 0xA4U)
     ...
     */
    unsigned int dh_check_public_key(const dh_para_t *dh_para, const unsigned int *p_minus_2, const unsigned int *pubkey);
