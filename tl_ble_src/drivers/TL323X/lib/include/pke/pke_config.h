 ...
 *caution:
 */
// #define PKE_BASE_ADDR (0x81C00000U) // PKE register base address
...
#define ECCP_MAX_BIT_LEN (256u) // 1024 if need curve BN638
...
#define SUPPORT_RSAES_PKCS1_V1_5
     ...
     *     3. depending on the compiler, there may be cases that software calc
