...
extern "C"
{
    ...
    typedef hmac_ctx_t hmac_sha224_ctx_t;
    typedef hmac_ctx_t HMAC_SHA224_CTX;
#ifdef HASH_DMA_FUNCTION
    typedef hmac_dma_ctx_t hmac_sha224_dma_ctx_t;
     ...
     */
    unsigned int hmac_sha224_node_steps(const unsigned char *key, unsigned short sp_key_idx, unsigned int key_bytes, const hash_node_t *node, unsigned int node_num,
                                        unsigned char *mac);
#endif
