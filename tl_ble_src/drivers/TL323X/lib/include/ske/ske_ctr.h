...
* @return          SKE_SUCCESS if successful, otherwise error code
*/
   unsigned int ske_lp_ctr_crypto(ske_alg_e alg, ske_crypto_e crypto, const unsigned char *key, unsigned short sp_key_idx, unsigned char *iv, unsigned char *in,
...
* @return          SKE_SUCCESS if successful, otherwise error code
*/
   unsigned int ske_lp_dma_ctr_crypto(ske_alg_e alg, ske_crypto_e crypto, const unsigned char *key, unsigned short sp_key_idx, unsigned char *iv, unsigned int *in,
