...
static void app_audio_initExtAdv(void)
{
    ...
    blc_ll_setExtAdvParam(ADV_HANDLE0, ADV_EVT_PROP_EXTENDED_NON_CONNECTABLE_NON_SCANNABLE_UNDIRECTED, audio_mode.extAdvIntervalMin, audio_mode.extAdvIntervalMax, BLT_ENABLE_ADV_ALL, OWN_ADDRESS_PUBLIC, BLE_ADDR_PUBLIC, NULL, ADV_FP_NONE, TX_POWER_3dBm, BLE_PHY_1M, 0, BLE_PHY_2M, audio_mode.advSid, 0);
}
