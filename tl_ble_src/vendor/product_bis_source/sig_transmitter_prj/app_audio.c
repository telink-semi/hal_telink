...
static void app_audio_initExtAdv(void)
{
    ...
    blc_ll_setExtAdvParam( AURACAST_SOURCE_ADV_HANDLE,  ADV_EVT_PROP_EXTENDED_NON_CONNECTABLE_NON_SCANNABLE_UNDIRECTED,
                            audio_mode.extAdvIntervalMin,   audio_mode.extAdvIntervalMax,
