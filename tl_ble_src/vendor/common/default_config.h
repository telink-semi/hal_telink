...
/* If PM_DEEPSLEEP_RETENTION_ENABLE is set to 1, then BLC_PM_RETENTION_DRIVERS_ONLY will be useless */
#ifndef BLC_PM_RETENTION_DRIVERS_ONLY
#define BLC_PM_RETENTION_DRIVERS_ONLY               0
#endif
