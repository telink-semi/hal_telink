...
///////////////////  Board configuration   /////////////////////////////////
        ...
        #define BOARD_SELECT BOARD_323X_FPGA_KU115_SOLO
    #else
...
#elif (BOARD_SELECT == BOARD_953X_EVK_C1T318A20)
    #include "boards/TL751X_C1T318A20.h"
#elif (BOARD_SELECT == BOARD_721X_EVK_C1T315A20)
    #include "boards/TL721X_C1T315A20.h"
#elif (BOARD_SELECT == BOARD_721X_EVK_C1T315A16)
    #include "boards/TL721X_C1T315A16.h"
#elif (BOARD_SELECT == BOARD_721X_EVK_C1T315A102)
    #include "boards/TL721X_C1T315A102.h"
#elif (BOARD_SELECT == BOARD_721X_EVK_CIT314A102)
    #include "boards/TL721X_C1T314A102.h"
...
#elif (BOARD_SELECT == BOARD_321X_EVK_C1T335A3)
    #include "boards/TL321X_C1T335A3.h"
#elif (BOARD_SELECT == BOARD_322X_FPGA_KU115_SOLO)
    #include "boards/TL322X_C1T311155.h"
#elif (BOARD_SELECT == BOARD_323X_FPGA_KU115_SOLO)
    #include "boards/TL323X_C1T315115.h"
