...
{
    u8 flag;
    for (user_bond_peripheral_flash_cfg_idx = 0; user_bond_peripheral_flash_cfg_idx < 4096; user_bond_peripheral_flash_cfg_idx += 8) { //traversing 8 bytes area in sector 0x11000 to find all the valid ACL Peripheral MAC address
