...
#define LE_AUDIO_PACS_SOURCE_PAC                    0
#define LE_AUDIO_PACS_SOURCE_AUDIO_LOCATIONS        0
#define APP_AUDIO_MICS_INCLUDE_AICS_INSTANCE_NUM    0
#define APP_AUDIO_VCS_INCLUDE_AICS_INSTANCE_NUM     0
#define APP_AUDIO_VCS_INCLUDE_VOCS_INSTANCE_NUM     2   //Left+Right

#define DEFAULT_TMAP_ROLE                           BLC_TMAP_ROLE_BROADCAST_MEDIA_RECEIVER
#define DEFAULT_DEV_NAME                            "Telink-BIS-SINK"
 ...
 */
        ...
        #define SW4_K3_9518EVK                  0x01
        #define SW5_K4_9518EVK                  0x02

        #define SW3_K2_9518EVK                  0xf0  ////
        #define SW2_K1_9518EVK                  0xf1


        /**
         *  @brief  Normal keyboard map
         */
        #define KB_MAP_NORMAL                   {   {SW2_K1_9518EVK,    SW4_K3_9518EVK},     \
                                                    {SW3_K2_9518EVK,    SW5_K4_9518EVK}, }
 ...
 */
    ...
    #define GPIO_LED_BLUE_9517C                 GPIO_PD3
    #define GPIO_LED_GREEN_9517C                GPIO_PD2
    #define GPIO_LED_WHITE_9517C                GPIO_PD1
    #define GPIO_LED_RED_9517C                  GPIO_PD0
    ...
    #define SW8_KEY_9517C                       GPIO_PB2
    #define SW9_KEY_9517C                       GPIO_PB1
    #define SW10_KEY_9517C                      GPIO_PB0
