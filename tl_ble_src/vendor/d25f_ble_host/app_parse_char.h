...
#define PARSE_CHAR_UART_TX_PIN GPIO_FC_PC1
#endif

#ifndef PARSE_CHAR_UART_RX_PIN
#define PARSE_CHAR_UART_RX_PIN GPIO_FC_PC0
#endif
...
extern volatile u8 is_app_parse_dma_busy;
/**
