...
//  blc_ll_setExtAdvData( ADV_HANDLE0,  1024, testAdvData);
    ...
    #if (1)
        ble_sts_t status = blc_ll_setPeriodicAdvParam_v2( ADV_HANDLE0, my_per_adv_itvl_min, my_per_adv_itvl_max, PERD_ADV_PROP_MASK_TX_POWER_INCLUDE,
                                                          10,  PERADV_INTERVAL_100MS,  8, 10, 25);
    #else
        ble_sts_t status = blc_ll_setPeriodicAdvParam_v2( ADV_HANDLE0, my_per_adv_itvl_min, my_per_adv_itvl_max, PERD_ADV_PROP_MASK_TX_POWER_INCLUDE,
                                                          0,  PERADV_INTERVAL_10MS,  1, 5, 4);
        blc_ll_setPeriodicAdvData( ADV_HANDLE0, 100, testAdvData);
    #endif
