 ...
 */
#define ACL_CONN_MAX_RX_OCTETS          80  //user set value
 ...
 */
#define ACL_CENTRAL_MAX_TX_OCTETS       80  //user set value
#define ACL_PERIPHR_MAX_TX_OCTETS       80  //user set value
 ...
 */
#define CENTRAL_ATT_RX_MTU              76  //user set value
 ...
 */
#define     CS_RX_FIFO_SIZE             2976
#define     CS_RX_FIFO_NUM              32
