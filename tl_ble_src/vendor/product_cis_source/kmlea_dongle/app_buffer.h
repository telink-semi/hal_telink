 ...
 */
    #define ACL_CENTRAL_MAX_TX_OCTETS 36 //user set value
...
extern u8 app_per_l2cap_tx_buf[];                                           //ACL Peripheral L2cap TX data buffer
    ...
    #define APP_CIS_CENTRAL_NUMBER 1 //user set value

    /* Number of Supported CIS Peripheral number */
    #define APP_CIS_PERIPHR_NUMBER 0 //user set value
 ...
 * 2. at least 4; recommended value: 4, 8, 16
 */
    #define CIS_SDU_IN_OCTETS_MAX 220                                              //user set value
 ...
 * 2. at least 4; recommended value: 4, 8, 16
 */
    #define CIS_SDU_OUT_OCTETS_MAX 220                                               //user set value
