...
//USED static const struct fal_partition partition_table_def[] SECTION("FalPartTable") = FAL_PART_TABLE;
 ...
 _attribute_data_retention_sec_ static  struct fal_partition *partition_table = NULL;
/* partition and flash object information cache table */
_attribute_data_retention_sec_ static struct part_flash_info part_flash_cache[sizeof(partition_table_def) / sizeof(partition_table_def[0])] = { 0 };
...
_attribute_data_retention_sec_ static uint8_t init_ok = 0;
_attribute_data_retention_sec_ static size_t partition_table_len = 0;
