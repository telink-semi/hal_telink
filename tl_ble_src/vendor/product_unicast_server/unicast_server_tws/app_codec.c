...
_attribute_ram_code_ void app_timer_irq_proc(void)
{
    ...
    static u8 wptr_reset = 1;
    if (wptr_reset || offset < 8 || offset > 24) {
        wptr_reset = 0;
        ...
        //        alg_spk_rptr = ((readOffset + 16)/2 + APP_AUDIO_OUTPUT_BUFFER_SIZE - 140)%APP_AUDIO_OUTPUT_BUFFER_SIZE;//ALG_AEC_DELAY
