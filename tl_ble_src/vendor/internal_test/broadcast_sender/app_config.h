...
#define HARDWARE_BOARD_SELECT                       HW_C1T213A20_V1_0_80_EVB//HW_C1T213A20_V1_0_80_EVB
...
#define APP_AUDIO_INPUT_DMIC                        3
#define APP_AUDIO_INPUT_USB_MIC                     4
#define APP_AUDIO_INPUT_IISIN                       5
#define APP_AUDIO_INPUT_TYPE                        APP_AUDIO_INPUT_USB_MIC



#if(APP_AUDIO_INPUT_TYPE == APP_AUDIO_INPUT_USB_MIC)
    #define DEFAULT_BROADCAST_NAME              "Telink-Source-USB"   //Length:Min 4, Max 32.
    #define BIS_COMMON_CODEC_CONFIG             BLC_AUDIO_STD_FREQ_48K_DURATION_10MS_FRAME_100BYTES     //USB mode only support LC 48KHz
    ...
    #elif(APP_AUDIO_INPUT_TYPE == APP_AUDIO_INPUT_IISIN)
        #define DEFAULT_BROADCAST_NAME          "Telink-Source-IISIN" //Length:Min 4, Max 32.
    #endif

    #if (APP_AUDIO_INPUT_TYPE == APP_AUDIO_INPUT_IISIN)
        #define BIS_COMMON_CODEC_CONFIG             BLC_AUDIO_STD_FREQ_48K_DURATION_10MS_FRAME_100BYTES
    #else
        #define BIS_COMMON_CODEC_CONFIG             BLC_AUDIO_STD_FREQ_16K_DURATION_10MS_FRAME_40BYTES
    #endif
    ...
    #define ID_VENDOR                       0x248c          // for report
    ...
    #define KB_MAP_NORMAL                   {   {SW2_K1,        SW4_K3},     \
                                                {SW3_K2,        SW5_K4}, }
