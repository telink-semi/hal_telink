...
static const u8 my_devNameCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_DEVICE_NAME),
    U16_HI(CHARACTERISTIC_UUID_DEVICE_NAME)};
static const u8 my_appearanceCharVal[5] = {
    CHAR_PROP_READ,
    U16_LO(GenericAccess_Appearance_DP_H),
    U16_HI(GenericAccess_Appearance_DP_H),
    U16_LO(CHARACTERISTIC_UUID_APPEARANCE),
    U16_HI(CHARACTERISTIC_UUID_APPEARANCE)};
static const u8 my_periConnParamCharVal[5] = {
    CHAR_PROP_READ,
    U16_LO(CONN_PARAM_DP_H),
    U16_HI(CONN_PARAM_DP_H),
    U16_LO(CHARACTERISTIC_UUID_PERIPHERAL_PREFERRED_CONN_PARAM),
    U16_HI(CHARACTERISTIC_UUID_PERIPHERAL_PREFERRED_CONN_PARAM)};
...
static const u8 my_serviceChangeCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_SERVICE_CHANGED),
    U16_HI(CHARACTERISTIC_UUID_SERVICE_CHANGED)};
...
static const u8 my_hidProtocolModeCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_PROTOCOL_MODE),
    U16_HI(CHARACTERISTIC_UUID_PROTOCOL_MODE)};
static const u8 my_hidBootKeyInReportCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_BOOT_KEYBOARD_INPUT_REPORT),
    U16_HI(CHARACTERISTIC_UUID_BOOT_KEYBOARD_INPUT_REPORT)};
static const u8 my_hidBootKeyOutReportCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_BOOT_KEYBOARD_OUTPUT_REPORT),
    U16_HI(CHARACTERISTIC_UUID_BOOT_KEYBOARD_OUTPUT_REPORT)};
static const u8 my_hidReportCCinCharVal[5] = {
    CHAR_PROP_READ | CHAR_PROP_NOTIFY,
    U16_LO(HID_CONSUME_REPORT_INPUT_DP_H),
    U16_HI(HID_CONSUME_REPORT_INPUT_DP_H),
    U16_LO(CHARACTERISTIC_UUID_REPORT),
    U16_HI(CHARACTERISTIC_UUID_REPORT)};
...
static const u8 my_hidReportMapCharVal[5] = {
    ...
    U16_LO(CHARACTERISTIC_UUID_REPORT_MAP),
    U16_HI(CHARACTERISTIC_UUID_REPORT_MAP)};
