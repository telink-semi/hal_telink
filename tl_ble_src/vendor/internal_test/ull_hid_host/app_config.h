...
#define VCD_EN                                      1
#define VCD_DEFINE_SELECT                           VCD_DEFINE_CIS_CEN
        ...
        #define SET_CIG_PARAM                   0x03
        #define CREATE_CIS                      0x04


        /**
         *  @brief  Normal keyboard map
         */
        #define KB_MAP_NORMAL                   {   {SET_CIG_PARAM,     BTN_PAIR},   \
                                                    {CREATE_CIS,        BTN_UNPAIR}, }
...
/**
 *  @brief  Definition gpio for dongle USB
 */
#if(APPLICATION_DONGLE)
    #define ID_VENDOR               0x248a          // for report
    #define ID_PRODUCT_BASE         0x880c          //AUDIO_HOGP
    #define STRING_VENDOR           L"Telink"
    #define STRING_PRODUCT          L"BLE ULL-HID Dongle"
    ...
    #define USB_MOUSE_POLL_INTERVAL 1   // in 1ms, dft:4ms, ULL-HID demo report interval 1ms currently TODO:
#endif
