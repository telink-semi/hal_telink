...
struct __attribute__((packed)) list_node_t pStart;                                                //header node
...
void app_codec_init(void)
{
    ...
    #elif (APP_AUDIO_SCENE == APP_SCENE_HEADSET)
    tlk_codec_init();
    tlk_codec_config(TLK_CODEC_INPUT, TLK_CODEC_FREQ_48000, TLK_CODEC_2_CHANNEL, TLK_CODEC_LINE, (u8 *)app_audio_input_buffer, 2 * APP_AUDIO_INPUT_BUFFER_SIZE);
