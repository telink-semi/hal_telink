...
////////////////////////////////////////////////////////////////////////////////////////////////
    //LC3 init
    #if ENCODE_EN
        //encode chn0
        int lc3Ret = lc3enc_encode_init_test(0,BLC_AUDIO_FREQ_CFG_48000,\
                BLC_AUDIO_DURATION_CFG_10,  100);
        if(lc3Ret != LC3ENC_OK)
        {
            BLT_APP_LOG("lc3 encode chn0 init fail:0x%x", lc3Ret);
        }
        //encode chn1
        lc3Ret = lc3enc_encode_init_test(1,BLC_AUDIO_FREQ_CFG_48000,\
                    BLC_AUDIO_DURATION_CFG_10,  100);
        if(lc3Ret != LC3ENC_OK)
        {
        ...
        //decode chn0
        lc3Ret = lc3enc_decode_init_test(0,BLC_AUDIO_FREQ_CFG_48000,\
                BLC_AUDIO_DURATION_CFG_10,  100);
        if(lc3Ret != LC3DEC_OK)
        {
        ...
        //decode chn1
        lc3Ret = lc3enc_decode_init_test(1,BLC_AUDIO_FREQ_CFG_48000,\
                BLC_AUDIO_DURATION_CFG_10,  100);
        if(lc3Ret != LC3DEC_OK)
        {
