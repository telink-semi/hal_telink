...
void ble_extend_adv_ind_test(adv_handle_t handle)
{
    ...
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_LEGACY_CONNECTABLE_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_30MS,           ADV_INTERVAL_35MS,
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_LEGACY_CONNECTABLE_DIRECTED_LOW_DUTY,  ADV_INTERVAL_30MS,          ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_LEGACY_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_30MS,           ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_LEGACY_NON_CONNECTABLE_NON_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_30MS,           ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_EXTENDED_NON_CONNECTABLE_NON_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_30MS,             ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_EXTENDED_CONNECTABLE_UNDIRECTED,  ADV_INTERVAL_30MS,           ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_EXTENDED_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_30MS,             ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
...
{
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( handle,      ADV_EVT_PROP_EXTENDED_NON_CONNECTABLE_NON_SCANNABLE_DIRECTED,  ADV_INTERVAL_30MS,           ADV_INTERVAL_35MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
    blc_ll_setExtAdvData(handle,      advLen,   (u8*)&advData[0]);
