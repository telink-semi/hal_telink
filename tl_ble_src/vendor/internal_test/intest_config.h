...
#define TEST_RAS_CLIENT                406
#define TEST_RAS_SERVER                407
...
#define TEST_HDT_SENDER                600
#define TEST_HDT_RECIPIENT             601

#define INTER_TEST_MODE                TEST_HDT_SENDER//TEST_ADV_SCAN_ONOFF//TEST_RAS_CLIENT
