...
void app_ext_adv_init(void)
{
    ...
    const u8 audioAnnouncementAdvData[] =
    {
             ...
             5,  DT_INCOMPLETE_LIST_16BIT_SERVICE_UUID,                             // incomplete list of service class UUIDs (0x184F, 0x1850)
             ...
             3,  DT_APPEARANCE, (DEFAULT_DEV_APPEARE & 0xFF), (DEFAULT_DEV_APPEARE & 0xFF00)>>8,
             7,  DT_CSIP_RSI,appCtrl.rsi[0],appCtrl.rsi[1],appCtrl.rsi[2],appCtrl.rsi[3],appCtrl.rsi[4],appCtrl.rsi[5],
             ...
             5,  DT_SERVICE_DATA,
             //------------ TMA Service UUID ------------
             U16_LO(SERVICE_UUID_TELEPHONY_AND_MEDIA_AUDIO),U16_HI(SERVICE_UUID_TELEPHONY_AND_MEDIA_AUDIO),
             //------------
             BLC_TMAP_ROLE_CALL_TERMINAL | BLC_TMAP_ROLE_UNICAST_MEDIA_RECEIVER, 0x00,
    };
