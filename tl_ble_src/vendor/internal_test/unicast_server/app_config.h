...
#include "../intest_config.h"
    ...
    #define APP_SCENE_HEADSET_EP2              2

    #define APP_SCENE                          APP_SCENE_TWS

    #if (APP_SCENE == APP_SCENE_HEADSET_EP2)
        #define APP_AUDIO_MAX_SINK_EP   2
        #define APP_AUDIO_MAX_SOURCE_EP 2
    #else
    ...
    #define LC3_DECODE_CHANNEL_COUNT     APP_AUDIO_MAX_SINK_EP   //spk use
    #define LC3_ENCODE_CHANNEL_COUNT     APP_AUDIO_MAX_SOURCE_EP //mic use
    ...
    #define APP_AUDIO_OUTPUT_TYPE  APP_AUDIO_LINE_OUT //APP_AUDIO_IIS_OUT

    ///////////////////////// UI Configuration ////////////////////////////////////////////////////
    #define UI_LED_ENABLE       1
    #define UI_KEYBOARD_ENABLE  1
    #define DEFAULT_DEV_NAME    "tlk_le_audio"
    ...
    #define PERIPHR_CONNECT_CENTRAL_MAC_FILTER_EN 0 //remove when release SDK
