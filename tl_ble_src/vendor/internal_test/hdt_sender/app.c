...
#endif
        hdt_app_ctrl.connhandle = pConnEvt->connHandle;
        app_parse_printf("connection complete\r\n");
...
/* It's recommended that user set some UI alarm to know the exact error, e.g. LED shine, print log */
    ...
    tlkapi_printf(APP_LOG_EN, "[APP][INI] Sendor demo init finished");
}
