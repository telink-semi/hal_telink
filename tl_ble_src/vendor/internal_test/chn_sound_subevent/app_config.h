...
#define LL_FEATURE_ENABLE_CHANNEL_SOUNDING                          1


#define GPIO_TRIGGER_TEST_ENABLE                    0
#if (GPIO_TRIGGER_TEST_ENABLE)
    #define GPIO_TRIGGER_PIN                        GPIO_PB3
#endif

#define ACL_CENTRAL_MAX_NUM                         4 // ACL central maximum number
#define ACL_PERIPHR_MAX_NUM                         4 // ACL peripheral maximum number

#if 0 /* Only for SDK Release. Remove in release SDK*/
...
#define DBG_CS_SUBEVENT_ENABLE                      1
#define DBG_CS_RX_FIFO_ENABLE                       1
#define DBG_CS_DATA_PRINT_EN                        1
#define DBG_CS_DATA_USB_PRINT_EN                    1
#define DBG_CS_MODE_STEP_NUM_EN                     1
#define DBG_ACL_PACKET_LOSS_RECORD_EN               0
...
#define CENTRAL_CONNECT_PERIPHR_MAC_FILTER_EN       1  //remove when release SDK
    ...
    #define DEBUG_INFO_TX_PIN                       GPIO_PF7
    #define PULL_WAKEUP_SRC_PF7                     PM_PIN_PULLUP_10K
    #define PF7_OUTPUT_ENABLE                       1
    #define PF7_DATA_OUT                            1 //must
#endif
