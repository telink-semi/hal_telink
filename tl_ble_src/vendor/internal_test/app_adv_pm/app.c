...
static u32 mcu_start_tick = 0;
static u32 mcu_run_state = 0;
/**
...
int main_idle_loop(void)
{
    ...
    switch(mcu_run_state)
    {
    case 0:
        if(clock_time_exceed(mcu_start_tick,100000)) //100ms
        {
            mcu_run_state++;
            blc_ll_setAdvEnable(BLC_ADV_DISABLE);  //ADV enable
            printf("BLC_ADV_DISABLE\r\n");
        }
        break;
    case 1:
    ...
    case 2:
        ...
        cpu_long_sleep_wakeup_32k_rc(DEEPSLEEP_MODE_RET_SRAM_LOW64K,PM_WAKEUP_PAD,clock_time() + 60 *SYSTEM_TIMER_TICK_1S);
        break;
    case 3:
        break;
    default:
