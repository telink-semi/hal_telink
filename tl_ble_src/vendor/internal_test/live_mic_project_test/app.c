...
const u8    tbl_advData_0[] = {
     11, DT_COMPLETE_LOCAL_NAME,                'e', 'x', 't', '_', 'd', 'e', 'm', 'o', '_','0',
...
const u8    tbl_advData_1[] = {
    11, DT_COMPLETE_LOCAL_NAME,                 'e', 'x', 't', '_', 'd', 'e', 'm', 'o', '_','1',
     2,  DT_FLAGS,                              0x05,                   // BLE limited discoverable mode and BR/EDR not supported
     3,  DT_APPEARANCE,                         0x80, 0x01,             // 384, Generic Remote Control, Generic category
     5,  DT_INCOMPLETE_LIST_16BIT_SERVICE_UUID, 0x12, 0x18, 0x0F, 0x18, // incomplete list of service class UUIDs (0x1812, 0x180F)
};
...
////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    blc_ll_setExtAdvParam( ADV_HANDLE0,         ADV_EVT_PROP_LEGACY_CONNECTABLE_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_90MS,           ADV_INTERVAL_90MS,
    ...
    //Legacy, Connectable_Scannable, Undirected
    blc_ll_setExtAdvParam( ADV_HANDLE1,         ADV_EVT_PROP_LEGACY_CONNECTABLE_SCANNABLE_UNDIRECTED,  ADV_INTERVAL_90MS,           ADV_INTERVAL_90MS,
                            BLT_ENABLE_ADV_ALL, OWN_ADDRESS_PUBLIC,                                    BLE_ADDR_PUBLIC,                 NULL,
                           ADV_FP_NONE,         TX_POWER_3dBm,                                         BLE_PHY_1M,                      0,
                           BLE_PHY_1M,          ADV_SID_0,                                             0);
