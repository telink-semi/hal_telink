...
#include "app_config.h"
    ...
    #define PARSE_CHAR_UART_TX_PIN        GPIO_FC_PA4 //UART1_TX_PA4    // #define PARSE_CHAR_UART_TX_PIN GPIO_FC_PC7
    #define PARSE_CHAR_UART_RX_PIN        GPIO_FC_PA3 //UART1_RX_PA3    // #define PARSE_CHAR_UART_RX_PIN GPIO_FC_PC6
    #define PARSE_CHAR_B92_UART_TX_PIN    GPIO_FC_PA4
    #define PARSE_CHAR_B92_UART_RX_PIN    GPIO_FC_PA3
#elif (BOARD_SELECT == BOARD_952X_EVK_C1T266A102)
    #define PARSE_CHAR_UART_TX_PIN GPIO_FC_PC7 // #define PARSE_CHAR_UART_TX_PIN GPIO_FC_PB7
    #define PARSE_CHAR_UART_RX_PIN GPIO_FC_PC6 // #define PARSE_CHAR_UART_RX_PIN GPIO_FC_PB6
