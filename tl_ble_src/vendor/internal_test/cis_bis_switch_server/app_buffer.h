...
#define APP_EXT_ADV_DATA_LENGTH             512  //user set value
...
#define CENTRAL_ATT_RX_MTU      64  //user set value
...
#define CIS_RX_PDU_FIFO_NUM             16  //user set value
...
#define BIS_SDU_OUT_FIFO_NUM            (16)
