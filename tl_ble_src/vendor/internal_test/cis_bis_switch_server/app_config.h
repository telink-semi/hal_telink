...
#pragma once
    ...
    #define ACL_PERIPHR_MAX_NUM 2 // ACL peripheral maximum number
        ...
        #define HARDWARE_TYPE TLSR9528A

        #if (HARDWARE_TYPE == TLSR9528A)
    ...
    #define AUDIO_DEBUG_DATA_EN                0
        ...
        #define AUDIO_UNICAST_SERVER_MAX_TRANSPORT_LATENCY 0x28 //40ms
        #define HEAP_MEM_SIZE_CFG                          20000
    #endif
    ...
    #define JTAG_DEBUG_DISABLE   1
            ...
            #else
                #define KEY1_GPIO_IN  GPIO_PA1
                #define KEY1_GPIO_OUT GPIO_PA3

                #define KEY2_GPIO_IN  GPIO_PA2
                #define KEY2_GPIO_OUT GPIO_PA3

                #define KEY3_GPIO_IN  GPIO_PA2
                #define KEY3_GPIO_OUT GPIO_PA4

                #define KEY4_GPIO_IN  GPIO_PA1
                #define KEY4_GPIO_OUT GPIO_PA4
            #endif
        ...
        #define TLK_KEY_VALID_LEVEL 0 /** 1 is high level */
            ...
            #if (1)
                #define LED1_PIN GPIO_PD1
                #define LED2_PIN GPIO_PD2
            //#define LED1_PIN       GPIO_PD3
            //#define LED2_PIN       GPIO_PD4
            //#define LED3_PIN       GPIO_PD5
            //#define LED4_PIN       GPIO_PD6
            #else
                #define LED1_PIN GPIO_PE6
                #define LED2_PIN GPIO_PE7
                #define LED3_PIN GPIO_PF0
                #define LED4_PIN GPIO_PF1
            #endif
