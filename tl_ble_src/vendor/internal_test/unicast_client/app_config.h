...
#define LC3_DECODE_CHANNEL_COUNT                    ACL_CENTRAL_MAX_NUM
#define LC3_ENCODE_CHANNEL_COUNT                    ACL_CENTRAL_MAX_NUM
...
#define APP_AUDIO_MUSIC_IN                          APP_AUDIO_MUSIC_LINE_IN

#define CENTRAL_CONNECT_PERIPHR_MAC_FILTER_EN       0  //remove when release SDK
