        ...
        if (app_ctrl.acl_param[i].audioSink.streamStart) {
            ...
            if (pPkt != NULL) {
                ...
                if (ret_lc3 != LC3DEC_OK) {
                    ...
                    pRaw.renderPoint = pPkt->timestamp + app_ctrl.acl_param[i].audioSink.presentationDelay * SYSTEM_TIMER_TICK_1US + unicastQosSettings[APP_AUDIO_QOS_PARAMETER_PREFER][APP_AUDIO_CODEC_PARAMETER_PREFER].maxTransportLatency * SYSTEM_TIMER_TICK_1MS; //tick
