 ...
 */
    ...
    #define APP_EXT_ADV_DATA_LENGTH 1024 //user set value
 ...
 * 2. at least 4; recommended value: 4, 8, 16
 */
    #define CIS_SDU_IN_OCTETS_MAX 155                                              //310 //user set value

    #define CIS_SDU_IN_FIFO_SIZE  CAL_IAL_ISO_SDU_FIFO_SIZE(CIS_SDU_IN_OCTETS_MAX) //user can not change !!!

    #define CIS_SDU_IN_FIFO_NUM   4                                                //16 //user set value
 ...
 * 2. at least 4; recommended value: 4, 8, 16
 */
    #define CIS_SDU_OUT_OCTETS_MAX 155                                               //310    //user set value

    #define CIS_SDU_OUT_FIFO_SIZE  CAL_IAL_ISO_SDU_FIFO_SIZE(CIS_SDU_OUT_OCTETS_MAX) //user can not change !!!

    #define CIS_SDU_OUT_FIFO_NUM   4                                                 //16 //user set value
