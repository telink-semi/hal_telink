...
void app_ext_adv_init(void)
{
    ...
    sprintf(myDeviceName, MY_DEV_NAME_HEADER"-%02X%02X%02X%02X%02X%02X",
            bltMac.macAddress_public[5], bltMac.macAddress_public[4],
            bltMac.macAddress_public[3], bltMac.macAddress_public[2],
            bltMac.macAddress_public[1], bltMac.macAddress_public[0]);
