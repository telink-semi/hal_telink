...
void app_led_init(void)
{
    ...
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_1 init fail,ret - %d\n",ret);
    }
    else
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_1 init success\n");
    ...
    if(ret != TLK_LED_SUCCESS)
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_2 init fail,ret - %d\n",ret);
    }
    else
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_2 init success\n");
    ...
    if(ret != TLK_LED_SUCCESS)
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_3 init fail,ret - %d\n",ret);
    }
    else
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_3 init success\n");
    ...
    if(ret != TLK_LED_SUCCESS)
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_4 init fail,ret - %d\n",ret);
    }
    else
    {
        tlkapi_printf(APP_LED_LOG_EN, "led_4 init success\n");
