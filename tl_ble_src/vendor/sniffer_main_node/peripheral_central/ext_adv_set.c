...
const u8    tbl_advData_0 [] = {
    15, DT_COMPLETE_LOCAL_NAME,                 'P','e','r','i','p','h','e','r','a','l','D','e','m','o',
     2,     DT_FLAGS,                               0x05,
...
void app_multiple_adv_set(void)
{
    ...
    blc_ll_setExtAdvParam( ADV_HANDLE0,         ADV_EVT_PROP_EXTENDED_CONNECTABLE_UNDIRECTED,                   ADV_INTERVAL_100MS,             ADV_INTERVAL_100MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                             BLE_ADDR_PUBLIC,                NULL,
                           ADV_FP_NONE,         TX_POWER_10dBm,                                                 BLE_PHY_1M,                     0,
    ...
    blc_ll_setExtAdvParam( ADV_HANDLE1,         ADV_EVT_PROP_EXTENDED_CONNECTABLE_UNDIRECTED,                   ADV_INTERVAL_100MS,             ADV_INTERVAL_100MS,
                           BLT_ENABLE_ADV_ALL,  OWN_ADDRESS_PUBLIC,                                              BLE_ADDR_PUBLIC,               NULL,
                           ADV_FP_NONE,         TX_POWER_10dBm,                                                  BLE_PHY_CODED,                     0,
                           BLE_PHY_CODED,           ADV_SID_1,                                                       0);
