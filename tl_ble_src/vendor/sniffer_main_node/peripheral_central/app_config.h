...
#define APP_CENTRAL_CONNECT_PERIPHR_NAME_FILTER_EN  1
#define APP_SMP_LG_CAPABILITY_DISPLAY_ONLY_EN       1
#define APP_BLE_EXT_ADV_ENABLE                      1
#define APP_BLE_RESOLVING_LIST_ENABLE               1
...
#define BOARD_SELECT                                BOARD_9223A_EVK_C1T289A67_V1_0
...
#define CHECK_SNIFFER_INDEX_MAX                     (LOCAL_SNIFFER_INDEX_5 + 1)
